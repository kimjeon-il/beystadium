...
const partItems = [
  ...
  { id: "LAYER-DRAIGER-FANG", series: "burst", type: "layer", name: "클로타이거", jpName: "드래이거 팽", en: "Draiger Fang", battleType: "balance", tags: [], desc: "강력한 발톱을 감추고 있는 클로타이거가 모티브. 공격과 방어에 우수한 날이 겹쳐진 모양의 밸런스타입의 레이어.", jpDesc: "강력한 발톱을 감추고 있는 드래이거 팽이 모티브. 공격과 방어에 우수한 날이 겹쳐진 모양의 밸런스타입의 레이어." },
  ...
  { id: "LAYER-GAIA-DRAGOON-SPIKE", series: "burst", type: "layer", name: "나이프 리저드", jpName: "가이아드라군 스파이크", en: "Gaia Dragoon Spike", battleType: "attack", tags: [], desc: "거대한 자유 회전 윙이 확실하게 상대의 레이어를 잡아내는 어택타입의 레이어." },
  ...
  { id: "DUALLAYER-BALDUR", series: "burst", type: "duallayer", name: "발뒤르", en: "Baldur", battleType: "defense", tags: [], desc: "" },
  ...
  { id: "DUALLAYER-UNLOCK-UNICORN", series: "burst", type: "duallayer", name: "언락 유니콘", en: "Unlock Unicorn", battleType: "defense", tags: [], desc: "환상의 동물 유니콘이 모티브. 바깥 둘레에 배치된 갈기 모양의 9단 칼날이 상대의 공격을 분산시키고, 약해진 상대에게 상단 칼날의 뿔로 강력한 카운터를 가하는 디펜스계열 듀얼레이어." },
  ...
  { id: "GODLAYER-ORICHALCUM", series: "burst", type: "godlayer", name: "오리하르콘", en: "Orichalcum", battleType: "stamina", tags: [], desc: "" },
  { id: "GODLAYER-SHADOW-ORICHALCUM", series: "burst", type: "godlayer", name: "섀도우 오리하르콘", en: "Shadow Orichalcum", battleType: "defense", tags: [], desc: "" },
  { id: "GODLAYER-DUO-APOLLOS", series: "burst", type: "godlayer", name: "듀오 아폴로스", en: "Duo Apollos", battleType: "defense", tags: [], desc: "" },
  { id: "GODLAYER-DUO-ARTEMIS", series: "burst", type: "godlayer", name: "듀오 아르테미스", en: "Duo Artemis", battleType: "attack", tags: [], desc: "" },
  { id: "GODLAYER-DUO-ECLIPSE", series: "burst", type: "godlayer", name: "듀오 이클립스", en: "Duo Eclipse", battleType: "balance", tags: [], desc: "" },
  ...
  { id: "CHOZLAYER-SHADOW-AMATERIOS", series: "burst", type: "chozlayer", name: "섀도우 아마테리오스", en: "Shadow Amaterios", battleType: "attack", tags: [], desc: "" },
  { id: "CHOZLAYER-SHINING-AMATERIOS", series: "burst", type: "chozlayer", name: "샤이닝 아마테리오스", en: "Shining Amaterios", battleType: "attack", tags: [], desc: "" },
  ...
  { id: "CHOZLAYER-LEFT-ECLIPSE", series: "burst", type: "chozlayer", name: "레프트 이클립스", en: "Left Eclipse", battleType: "balance", tags: [], desc: "" },
  { id: "CHOZLAYER-RIGHT-ECLIPSE", series: "burst", type: "chozlayer", name: "라이트 이클립스", en: "Right Eclipse", battleType: "balance", tags: [], desc: "" },
  ...
  { id: "CHOZLAYER-DEAD-PHOENIX", series: "burst", type: "chozlayer", name: "데드 피닉스", en: "Dead Phoenix", battleType: "defense", tags: [], desc: "불사조 피닉스가 모티브. 메탈 파츠가 많이 포함된 데드 아머를 장비. 아머의 방어로 본체가 받는 데미지를 막아내고 초중량을 활용한 역공을 노리는 디펜스타입의 초Z레이어." },
  { id: "CHOZLAYER-BURNING-AMATERIOS", series: "burst", type: "chozlayer", name: "버닝 아마테리오스", en: "Burning Amaterios", battleType: "attack", tags: [], desc: "" },
  ...
  { id: "DBBLADE-ZEST", series: "burst", type: "dbblade", name: "제스트", en: "Zest", battleType: "balance", tags: [], desc: "큰 검과 방패로 이루어진 얇은 2개의 날로 공기를 가르며 기동력이 높다. 밸런스 타입의 좌우 양방향 회전 BU 블레이드." },
  ...
  { id: "DRIVER-REVOLVE", series: "burst", type: "driver", name: "R", en: "Revolve", sub: "리볼브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝부분 주위에 자유롭게 회전하는 방어 부품이 있어서 배틀 후반까지 회전력을 유지할 수 있는 스태미나타입 드라이버." },
  ...
  { id: "DRIVER-NOTHING", series: "burst", type: "driver", name: "Nt", en: "Nothing", sub: "너싱", battleType: "stamina", tags: [], desc: "축 끝의 스프링이 착지할 때 충격과 회전 시 상·하의 흔들림을 흡수하여 상대를 무력화시키는 스태미나타입의 드라이버." },
  { id: "DRIVER-ATOMIC", series: "burst", type: "driver", name: "At", en: "Atomic", sub: "아토믹", battleType: "defense", tags: [], desc: "360도 자유롭게 회전하는 대형 볼이 방어력을 높여주고, 바깥쪽 링의 회전력으로 인해 잘 쓰러지지 않는 디펜스타입의 드라이버." },
  ...
  { id: "DRIVER-XTEND", series: "burst", type: "driver", name: "Xt", en: "Xtend", sub: "익스텐드", battleType: "balance", tags: [], desc: "상대에 맞춰서 높이를 2단계로 바꿀 수 있으며, 공격과 지구력을 겸비한 축 끝을 가진 밸런스타입의 변형 드라이버." },
  ...
  { id: "DRIVER-WAVE-DASH", series: "burst", type: "driver", name: "Wv'", en: "Wave'", sub: "웨이브 대시", battleType: "balance", tags: [], desc: "지구·가속·버티기 효과를 자랑하는 키가 큰 드라이버. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 밸런스계열 드라이버." },
  ...
  { id: "DRIVER-QUATTRO-DASH", series: "burst", type: "driver", name: "Qt'", en: "Quattro'", sub: "콰트로 대시", battleType: "balance", tags: [], desc: "메탈 축 끝 2종과 러버 축 끝 2종 총 4가지 타입으로 변경이 가능한 드라이버. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 초 밸런스 타입의 드라이버." },
  ...
  { id: "DRIVER-METAL-ACCEL", series: "burst", type: "driver", name: "MA", en: "Metal Accel", sub: "메탈 액셀", battleType: "attack", tags: [], desc: "축 끝이 평평해 기동력이 있으며, 고속으로 움직이며 회전한다. 강화스프링과 메탈락 파츠 탑재로 성능이 향상된 어택타입 드라이버." },
  { id: "DRIVER-METAL-DEFENSE", series: "burst", type: "driver", name: "MD", en: "Metal Defense", sub: "메탈 디펜스", battleType: "defense", tags: [], desc: "" },
  { id: "DRIVER-METAL-SURVIVE", series: "burst", type: "driver", name: "MS", en: "Metal Survive", sub: "메탈 서바이브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝이 스타디움과의 마찰을 줄여준다. 탑재된 강화 스프링과 메탈 잠금 파츠가 성능을 한층 더 높이는 스태미나계열 드라이버." },
  { id: "DRIVER-METAL-XTREME", series: "burst", type: "driver", name: "MX", en: "Metal Xtreme", sub: "메탈 익스트림", battleType: "attack", tags: [], desc: "러버의 강력한 그립에 의한 격렬한 움직임. 탑재된 강화 스프링과 메탈 잠금 파츠가 성능을 한층 더 높이는 어택계열 드라이버." },
