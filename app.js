...
const partItems = [
  ...
  { id: "LAYER-RAGNARUK", series: "burst", type: "layer", name: "라그나로크", en: "Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 불꽃을 휘감은 악마가 모티브, 지름이 길고 원형에 가까운 형상이 지구력을 발휘하여 오랫동안 회전을 지속하는 스태미너계열 레이어" },
  ...
  { id: "LAYER-HORUSOOD", series: "burst", type: "layer", name: "호루스드", en: "Horusood", battleType: "stamina", tags: [], desc: "천공의 신 호루스가 모티브, 바깥 둘레에 넓게 퍼져있어 공기의 저항을 덜 받는 날개가 강력한 원심력을 만드는 스태미너계열 레이어" },
  ...
  { id: "LAYER-CHAOS", series: "burst", type: "layer", name: "카오스", en: "Chaos", battleType: "stamina", tags: [], desc: "혼돈의 신 카오스가 모티브. 두 개의 커다란 원형 칼날이 높은 원심력을 발생시키고 두꺼운 판 형태로 회전력을 보존하는 스태미너계열 레이어." },
  ...
  { id: "LAYER-WOLBORG", series: "burst", type: "layer", name: "하운드 도그", jpName: "울보그", en: "Wolborg", battleType: "stamina", tags: [], desc: "사냥개 하운드 도그가 모티브. 원심력을 만들어내는 4개의 날이 지구력을 높이고 상대의 공격을 받아넘기는 스태미너계열의 레이어.", jpDesc: "늑대 울보그가 모티브. 원심력을 만들어내는 4개의 날이 지구력을 높이고 상대의 공격을 받아넘기는 스태미너계열의 레이어." },
  ...
  { id: "DUALLAYER-RISING-RAGNARUK", series: "burst", type: "duallayer", name: "라이징 라그나로크", en: "Rising Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 불꽃을 휘감은 악마가 모티브. 하단 공격으로 상대의 공격을 가볍게 받아넘기면서, 불길과 같이 굽어지는 형태의 상단의 2개의 칼날이 커다란 원심력과 기류를 만들어내는 스태미너계열 듀얼레이어." },
  ...
  { id: "DUALLAYER-HOLY-HORUSOOD", series: "burst", type: "duallayer", name: "홀리 호루스드", en: "Holy Horusood", battleType: "stamina", tags: [], desc: "천공신 호루스가 모티브. 섬세한 날개형의 하단날로 상대방의 스태미너를 공격하고, 두꺼운 갑옷형의 상단날로 원심력을 발생시키는 스태미너계열의 듀얼레이어." },
  ...
  { id: "DUALLAYER-YAGER-YGGDRASIL", series: "burst", type: "duallayer", name: "예거 위그드라실", en: "Yager Yggdrasil", battleType: "stamina", tags: [], desc: "8곳의 높아진 부분이 무게추가 되어 원심력을 높이는 스태미너계열 레이어." },
  { id: "DUALLAYER-JAIL-JORMUNGAND", series: "burst", type: "duallayer", name: "제일 요르문간드", en: "Jail Jormungand", battleType: "stamina", tags: [], desc: "독사 요르문간드가 모티브. 위쪽 2장의 칼날로 상대의 공격을 되받아치고, 역공도 가능한 스태미너계열 듀얼레이어." },
  ...
  { id: "DUALLAYER-ZILLION-ZEUS", series: "burst", type: "duallayer", name: "질리언 제우스", en: "Zillion Zeus", battleType: "stamina", tags: [], desc: "전능의 신 제우스가 모티브. 내장된 메탈 볼이 고속 회전 시에는 바깥쪽으로, 저속 회전 시에는 안쪽으로 이동하면서 밸런스를 유지하는 스태미너계열 듀얼레이어." },
  ...
  { id: "DUALLAYER-PSYCHIC-PHANTOM", series: "burst", type: "duallayer", name: "사이킥 팬텀", en: "Psychic Phantom", battleType: "stamina", tags: [], desc: "사령 팬텀이 모티브. 스매쉬 형태의 상단 칼날과 어퍼 형태의 하단 칼날이 물결치듯이 어우러진 형상으로, 상대의 공격을 받아 넘기는 스태미너계열의 듀얼레이어." },
  ...
  { id: "GODLAYER-DRAIN-FAFNIR", series: "burst", type: "godlayer", name: "드레인 파브닐", en: "Drain Fafnir", battleType: "stamina", tags: [], desc: "황금의 용 파브닐이 모티브. 우회전 베이를 상대할 때 고무 재질의 칼날을 부딪혀, 상대의 공격을 흡수하여 자신의 회전력을 높이는 좌회전 스태미너계열의 갓레이어." },
  ...
  { id: "GODLAYER-ALTER-CHRONOS", series: "burst", type: "godlayer", name: "알타 크로노스", en: "Alter Chronos", battleType: "balance", tags: [], desc: "시간의 신 크로노스가 모티브. 중심축의 위치를 변경하여, 밸런스가 좋은 스태미너모드와 중심이 한쪽에 치우친 어택모드, 두 가지 모드로 전환이 가능한 갓레이어." },
  ...
  { id: "GODLAYER-GALAXY-ZEUS", series: "burst", type: "godlayer", name: "갤럭시 제우스", en: "Galaxy Zeus", battleType: "stamina", tags: [], desc: "그리스 신화의 제우스가 모티브. 베이의 회전속도에 따라 레이어에 있는 4개의 메탈 볼이 위치를 바꿔서 최적의 원심력을 유지하는 스태미너계열의 갓레이어." },
  ...
  { id: "GODLAYER-MAXIMUM-GARUDA", series: "burst", type: "godlayer", name: "맥시멈 가루다", en: "Maximum Garuda", battleType: "stamina", tags: [], desc: "신성한 새 가루다가 모티브. 베이블레이드 버스트 사상 최대 크기의 레이어로 원심력을 높이면서, 공기의 힘을 가진 5장의 거대한 날이 어퍼포스를 만들어 내는 스태미너계열 갓레이어." },
  ...
  { id: "GODLAYER-DEEP-CHAOS", series: "burst", type: "godlayer", name: "딥 카오스", en: "Deep Chaos", battleType: "stamina", tags: [], desc: "혼돈의 신 카오스가 모티브. 스프링이 내장된 바깥쪽 칼날이 상대 베이의 밑으로 파고 들어가, 지구력을 깎아내는 스태미너계열의 갓레이어." },
  ...
  { id: "GODLAYER-SCREW-TRIDENT", series: "burst", type: "godlayer", name: "스크류 트라이던트", en: "Screw Trident", battleType: "stamina", tags: [], desc: "세 갈래의 창, 트라이던트가 모티브. 고무 재질의 바깥쪽 칼날이 비스듬히 연결된 구조로, 외부의 충격을 흡수하여 자신의 회전력으로 바꾸는 스태미너계열의 갓레이어." },
  ...
  { id: "CHOZLAYER-CRASH-RAGNARUK", series: "burst", type: "chozlayer", name: "크래시 라그나로크", en: "Crash Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 불꽃에 둘러싸인 악마가 모티브. 열고 닫히는 메탈 윙이, 공격력을 유지하면서 원심력을 강화하는 스태미너계열의 초Z레이어." },
  ...
  { id: "CHOZLAYER-ARCHER-HERCULES", series: "burst", type: "chozlayer", name: "아처 헤라클레스", en: "Archer Hercules", battleType: "stamina", tags: [], desc: "영웅 헤라클레스가 모티브. 바깥쪽에 배치된 커다란 메탈의 활과 화살이 고속 회전할 때는 바깥쪽으로, 저속 회전할 때는 안쪽으로 움직여서, 회전력이 쉽게 떨어지지 않는 스태미너계열의 초Z레이어." },
  ...
  { id: "CHOZLAYER-GEIST-FAFNIR", series: "burst", type: "chozlayer", name: "가이스트 파브닐", en: "Geist Fafnir", battleType: "stamina", tags: [], desc: "황금용 파브닐이 모티브. 고속 회전할 때는 고무 날이 들어가 회전력을 보존하고, 저속 회전할 때만 고무 날이 튀어나와 상대의 회전력을 흡수하는 스태미너계열의 초Z레이어." },
  ...
  { id: "CHOZLAYER-AIR-KNIGHT", series: "burst", type: "chozlayer", name: "에어 나이트", en: "Air Knight", battleType: "stamina", tags: [], desc: "바람의 기사 나이트가 모티브. 초Z레이어 중 최대 크기로 원심력을 높이고, 프로펠러 모양의 날로 어퍼포스를 만들어서 지면과의 마찰을 줄여주는 스태미너계열의 초Z레이어." },
  ...
  { id: "GACHIWEIGHT-SEN", series: "burst", type: "gachiweight", name: "섬", en: "Sen", tags: [], desc: "레이어에 내장하는 무게추. 무게를 6군데에 조금씩 분산한 스태미너타입 웨이트." },
  ...
  { id: "GACHIBASE-GRAND", series: "burst", type: "gachibase", name: "그랜드", en: "Grand", battleType: "stamina", tags: [], desc: "커다란 원에 가까운 2개의 날과 안쪽의 빈 공간이 강한 원심력을 만들어내는 스태미너타입의 베이스." },
  ...
  { id: "GACHIBASE-WIZARD", series: "burst", type: "gachibase", name: "위저드", en: "Wizard", battleType: "stamina", tags: [], desc: "레이어 바깥이 대부분 고무로 쌓여있어 회전 흡수에 특화된 스태미너타입의 베이스." },
  { id: "GACHIBASE-COSMO", series: "burst", type: "gachibase", name: "코스모", en: "Cosmo", battleType: "stamina", tags: [], desc: "2단으로 나뉜 상단 날로 원심력을 높이면서, 아주 매끄러운 하단 날로 모든 마찰을 최소화한 스태미너타입의 베이스." },
  ...
  { id: "GACHIBASE-FLARE", series: "burst", type: "gachibase", name: "플레어", en: "Flare", battleType: "stamina", tags: [], desc: "6개의 메탈 볼이 베이의 회전과 동시에 바깥쪽으로 이동해서 커다란 원심력을 만들어내는 스태미너타입의 베이스." },
  ...
  { id: "GACHIBASE-HEAVEN", series: "burst", type: "gachibase", name: "헤븐", en: "Heaven", battleType: "stamina", tags: [], desc: "원형으로 원심력 높은 날이 잠금이 풀리면 가운데 날이 튀어나와 잠금을 회복하는 스태미너타입의 베이스." },
  ...
  { id: "SUPERKINGRING-GLIDE", series: "burst", type: "superkingring", name: "글라이드", en: "Glide", battleType: "stamina", tags: [], desc: "매끄러운 형태의 칼날로 상대의 공격을 받아넘기고 개폐되는 3개의 스태미너 윙으로 원심력을 초강화한 스태미너타입의 우회전 링." },
  ...
  { id: "SUPERKINGRING-MIRAGE", series: "burst", type: "superkingring", name: "미라지", en: "Mirage", battleType: "stamina", tags: [], desc: "바깥 전체가 고무 날로 둘러싸여 있어 강력한 흡수 구조로 된 스태미너타입의 좌회전 링." },
  ...
  { id: "SUPERKINGCHASSIS-1S", series: "burst", type: "superkingchassis", name: "원 스테미나", en: "1 Stamina", battleType: "stamina", tags: ["싱글 섀시"], desc: "지름이 큰 원형 모양에 더불어 중심이 바깥에 위치한 형태로 커다란 원심력을 만들어 내는 스태미너타입의 좌우회전 섀시." },
  ...
  { id: "SUPERKINGCHASSIS-2S", series: "burst", type: "superkingchassis", name: "투 스테미나", en: "2 Stamina", battleType: "stamina", tags: ["더블 섀시"], desc: "가볍고 폭이 넓은 형태로 원심력이 강하여 지구력이 특화된 스태미너타입의 양방향 섀시." },
  ...
  { id: "DBLAYER-GREATEST-RAPHAEL", series: "burst", type: "dblayer", name: "그레이티스트 라파엘", en: "Greatest Raphael", battleType: "balance", tags: [], desc: "대천사 라파엘이 모티브. DB코어·아머·블레이드 일체형으로 강력한 슈팅을 하면 오버드라이브 시스템이 발동한다. 회전이 느려짐에 따라 아머가 점점 올라가며 변형하고, 내장된 메탈 파츠가 움직여 스태미너 성능이 상승한다. 외중심 8개 날의 어택모드에서 내중심 0개 날의 디펜스모드로 변형해 메탈 버스트락도 발동하는 밸런스타입의 우회전 레이어." },
  ...
  { id: "DBBLADE-CYCLONE", series: "burst", type: "dbblade", name: "사이클론", en: "Cyclone", battleType: "stamina", tags: [], desc: "두껍고 원형에 가까운 날과 최대급 스태미너 날 2개를 탑재하여 엄청난 원심력을 낳는 스태미너타입의 우회전 블레이드." },
  { id: "DBBLADE-VANISH", series: "burst", type: "dbblade", name: "배니시", en: "Vanish", battleType: "stamina", tags: [], desc: "전체가 고무 소재로 만들어졌으며 곳곳이 비어 있어 탄력있는 날로 상대의 회전을 흡수하는 스태미너타입의 좌회전 블레이드." },
  ...
  { id: "DISK-OUTER", series: "burst", type: "disk", name: "Ω", en: "Outer", sub: "아우터", tags: [], desc: "폭이 넓으며 중심을 최대한 바깥쪽으로 보내서 원심력을 최대치로 높인 스태미너계열의 디스크." },
  ...
  { id: "DISK-INFINITY", series: "burst", type: "disk", name: "I", en: "Infinity", sub: "인피니티", tags: [], desc: "앞면과 뒷면이 매끄럽게 이어져 있어 공기저항을 줄여주고 원심력을 발생시키는 스태미너계열 디스크." },
  ...
  { id: "DISK-AROUND", series: "burst", type: "disk", name: "Ar", en: "Around", sub: "어라운드", tags: [], desc: "4개의 메탈 볼이 지면과의 마찰을 줄이고 배틀 후반까지 끈기 있게 버티는 스태미너타입의 디스크." },
  ...
  { id: "DISK-WHEEL", series: "burst", type: "disk", name: "Wh", en: "Wheel", sub: "휠", tags: [], desc: "최중량급의 무게와 중심이 바깥에 있는 형태로 원심력을 극한까지 높인 스태미너타입 디스크." },
  ...
  { id: "COREDISK-4", series: "burst", type: "coredisk", name: "4", en: "4", sub: "포", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 폭넓은 4개의 칼날이 원심력을 높여주는 스태미너계열의 디스크." },
  { id: "COREDISK-5", series: "burst", type: "coredisk", name: "5", en: "5", sub: "파이브", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 5개의 날이 어퍼포스를 만들어내는 스태미너계열의 디스크." },
  ...
  { id: "COREDISK-8", series: "burst", type: "coredisk", name: "8", en: "8", sub: "에이트", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 안쪽을 가볍게 하고 바깥쪽에는 8개의 무게추를 배치하여, 무게중심이 바깥쪽에 있는 스태미너계열의 디스크." },
  { id: "COREDISK-8-DASH", series: "burst", type: "coredisk", name: "8'", en: "8'", sub: "에이트 대시", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 8 디스크보다 크고, 중심이 바깥쪽에 있어서 회전력이 특화된 스태미너계열의 디스크." },
  ...
  { id: "DBDISK-TAPERED", series: "burst", type: "dbdisk", name: "Tp", en: "Tapered", sub: "테이퍼드", tags: [], desc: "로우모드 대응 DB디스크. 아래로 점점 넓어지며 매끄럽게 꺾여가는 테두리 모양으로 부드럽게 자세를 지지해주는 스태미너타입 디스크." },
  ...
  { id: "DRIVER-CLAW", series: "burst", type: "driver", name: "C", en: "Claw", sub: "클로", battleType: "stamina", tags: [], desc: "회전에 맞추어 날이 자동으로 펼쳐져 원심력이 강화되는 스태미너계열 드라이버." },
  ...
  { id: "DRIVER-EDGE", series: "burst", type: "driver", name: "E", en: "Edge", sub: "엣지", battleType: "stamina", tags: [], desc: "2장의 판이 교차하는 형상으로 바닥에 닿는 면적이 좁고 경량화함으로써 원심력을 만들기 쉬운 스태미너계열 드라이버" },
  ...
  { id: "DRIVER-REVOLVE", series: "burst", type: "driver", name: "R", en: "Revolve", sub: "리볼브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝부분 주위에 자유롭게 회전하는 방어 부품이 있어서 배틀 후반까지 회전력을 유지할 수 있는 스태미너타입 드라이버." },
  ...
  { id: "DRIVER-OCTA", series: "burst", type: "driver", name: "Ω", en: "Octa", sub: "옥타", battleType: "stamina", tags: [], desc: "뾰족한 축 끝부분을 팔각형의 메탈 파츠가 둘러싸고 있으며, 높은 원심력을 만들어내는 스태미너타입의 드라이버." },
  ...
  { id: "DRIVER-YIELDING", series: "burst", type: "driver", name: "Y", en: "Yielding", sub: "일딩", battleType: "stamina", tags: [], desc: "드라이버 끝부분이 마찰저항을 줄여주는 특별한 소재인 POM으로 제작된 스태미너계열 드라이버." },
  { id: "DRIVER-TRANS", series: "burst", type: "driver", name: "T", en: "Trans", sub: "트랜스", battleType: "balance", tags: [], desc: "스태디움 안을 휘젓고 다니는 어택모드와 가운데서 오래 회전할 수 있는 스태미너모드로 전환할 수 있는 밸런스계열의 변형 드라이버." },
  { id: "DRIVER-WEIGHT", series: "burst", type: "driver", name: "W", en: "Weight", sub: "웨이트", battleType: "stamina", tags: [], desc: "메탈 소재의 축을 사용함으로써, 쉽게 흔들리지 않는 중량감을 갖추는 동시에 마찰 저항까지 줄어들어 회전력을 오랫동안 유지할 수 있는 스태미너계열 드라이버." },
  ...
  { id: "DRIVER-CYCLE", series: "burst", type: "driver", name: "Cy", en: "Cycle", sub: "사이클", battleType: "stamina", tags: [], desc: "자유회전하는 대형 날 2개가 달려있어서, 원심력을 강화하고 오랫동안 회전하는 스태미너계열 드라이버." },
  ...
  { id: "DRIVER-FLUGEL", series: "burst", type: "driver", name: "Fl", en: "Flugel", sub: "플뤼겔", battleType: "stamina", tags: [], desc: "우회전 시 어퍼포스를 만들어 내는 4개의 칼날이 지구력을 강화하는 스태미너계열 드라이버." },
  { id: "DRIVER-NOTHING", series: "burst", type: "driver", name: "Nt", en: "Nothing", sub: "너싱", battleType: "stamina", tags: [], desc: "축 끝의 스프링이 착지할 때 충격과 회전 시 상·하의 흔들림을 흡수하여 상대를 무력화시키는 스태미너타입의 드라이버." },
  ...
  { id: "DRIVER-PLANET", series: "burst", type: "driver", name: "Pl", en: "Planet", sub: "플래닛", battleType: "stamina", tags: [], desc: "바깥쪽의 메탈 볼이 원심력을 높여주고 축 끝부분의 메탈 볼이 자유롭게 회전하면서 지면과의 마찰을 줄이는 스태미너계열 드라이버." },
  ...
  { id: "DRIVER-ZETA", series: "burst", type: "driver", name: "Zt", en: "Zeta", sub: "제타", battleType: "balance", tags: [], desc: "축 끝부분을 변형해서, ｢격렬하게 날뛰는 공격모드｣, ｢쓰러뜨리기 어렵게 움직이는 방어모드｣, ｢중앙에서 버티는 스태미너모드｣. 모두 3가지의 움직임을 고를 수 있는 밸런스계열의 드라이버." },
  { id: "DRIVER-BEARING", series: "burst", type: "driver", name: "Br", en: "Bearing", sub: "베어링", battleType: "stamina", tags: [], desc: "매끄러운 회전을 만들어내는 정밀 부품 베어링이 들어있고, 축 끝은 마찰이 적은 특수소재 POM으로 만들어서 최장시간의 회전력 유지를 구현해낸 스태미너 특화형 드라이버." },
  ...
  { id: "DRIVER-WEDGE", series: "burst", type: "driver", name: "Wd", en: "Wedge", sub: "웻지", battleType: "stamina", tags: [], desc: "뾰족한 메탈 축으로 인해 중심축이 흔들리지 않는 안정적인 스태미너계열의 드라이버." },
  ...
  { id: "DRIVER-ETERNAL", series: "burst", type: "driver", name: "Et", en: "Eternal", sub: "이터널", battleType: "stamina", tags: [], desc: "축 끝이 뾰족해서 스태디움과의 마찰이 극한까지 줄어들고, 미끄러지기 쉬운 POM 소재의 방어 부품으로 배틀 후반에도 끈질기게 버티면서 회전하는 스태미너계열 드라이버." },
  ...
  { id: "DRIVER-ABSORB", series: "burst", type: "driver", name: "Ab", en: "Absorb", sub: "업소브", battleType: "stamina", tags: [], desc: "축 끝이 뾰족하고 자유회전하는 방어 부품이 있어서 스태미너를 보존하면서 상하의 흔들림을 스프링으로 흡수한다. 게다가 축 끝이 줄어들었을 때에만 고속 이동해서 공격을 피하는 스태미너계열의 드라이버." },
  ...
  { id: "DRIVER-RISE", series: "burst", type: "driver", name: "Rs", en: "Rise", sub: "라이즈", battleType: "stamina", tags: [], desc: "뾰족한 축 끝 주변에서 받쳐주는 매끄러운 부품으로 지구력을 유지하며 균형이 무너지지 않고 계속 회전하는 스태미너타입의 드라이버." },
  ...
  { id: "DRIVER-LOW", series: "burst", type: "driver", name: "Lw", en: "Low", sub: "로우", battleType: "stamina", tags: [], desc: "높이가 낮고 축 주위의 프리 회전 가드가 메탈 소재로 초저중심으로 안정된 스태미너타입의 드라이버." },
  ...
  { id: "DRIVER-NEVER", series: "burst", type: "driver", name: "Nv", en: "Never", sub: "네버", battleType: "stamina", tags: [], desc: "자유회전하는 뾰족한 축 끝과 특수소재 POM으로 된 주변부에 의해 매끄러운 움직임을 만들어 마찰을 낮춘 강력한 회전으로 끝까지 버텨내는 스태미너타입의 드라이버." },
  { id: "DRIVER-KICK", series: "burst", type: "driver", name: "Kc", en: "Kick", sub: "킥", battleType: "stamina", tags: [], desc: "스프링이 내장되어 있어 축 끝 주위의 파츠들이 상하로 움직이며 무너진 자세를 바로 잡아주는 스태미너타입의 드라이버." },
  ...
  { id: "DRIVER-QUATTRO", series: "burst", type: "driver", name: "Qt", en: "Quattro", sub: "콰트로", battleType: "balance", tags: [], desc: "메탈 소재의 축 끝 2종(스태미너타입, 디펜스타입)과 러버 소재의 축 끝 2종(어택타입, 밸런스타입), 총 4종을 전술에 맞춰 변경할 수 있는 초밸런스타입 드라이버." },
  ...
  { id: "DRIVER-ZETA-DASH", series: "burst", type: "driver", name: "Zt'", en: "Zeta'", sub: "제타 대시", battleType: "balance", tags: [], desc: "축 끝을 변형해서 어택모드, 디펜스모드, 스태미너모드 3가지를 고를 수 있다. 강화 스프링이 내장되어 있어서 공격력이 더욱 상승한 밸런스계열의 드라이버." },
  ...
  { id: "DRIVER-HIGH-XTEND-PLUS-DASH", series: "burst", type: "driver", name: "HXt+'", en: "High Xtend+'", sub: "하이 익스텐드 플러스 대시", battleType: "balance", tags: [], desc: "상대를 맞추어 축 끝을 어택·디펜스·스태미너의 3타입으로 변형 가능하다. 강화 스프링과 높은 키로 공격력이 더욱 강해진 밸런스타입 드라이버." },
  ...
  { id: "DRIVER-METAL-SURVIVE", series: "burst", type: "driver", name: "MS", en: "Metal Survive", sub: "메탈 서바이브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝이 스타디움과의 마찰을 줄여준다. 탑재된 강화 스프링과 메탈 잠금 파츠가 성능을 한층 더 높이는 스태미너계열 드라이버." },
