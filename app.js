...
const partItems = [
  ...
  { id: "LAYER-VALKYRIE", series: "burst", type: "layer", name: "발키리", en: "Valkyrie", battleType: "attack", tags: [], desc: "전쟁의 신, 발키리가 모티브, 커다란 칼날로 강한 공격을 하여 상대를 버스트하는 어택계열 레이어" },
  { id: "LAYER-SPRIGGAN", series: "burst", type: "layer", name: "스프리건", en: "Spriggan", battleType: "balance", tags: [], desc: "보물을 지키는 거인이 모티브, 공격적인 형상과 방어적인 곡면을 가지고 있는 밸런스계열 레이어" },
  { id: "LAYER-RAGNARUK", series: "burst", type: "layer", name: "라그나로크", en: "Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 불꽃을 휘감은 악마가 모티브, 지름이 길고 원형에 가까운 형상이 지구력을 발휘하여 오랫동안 회전을 지속하는 스태미나계열 레이어" },
  { id: "LAYER-KERBEUS", series: "burst", type: "layer", name: "케르베우스", en: "Kerbeus", battleType: "defense", tags: [], desc: "지옥을 지키는 개 케르베우스가 모티브, 바깥쪽에 배치된 사슬의 칼날이 공격을 막아내는 연타형상의 디펜스계열의 레이어" },
  { id: "LAYER-AMATERIOS", series: "burst", type: "layer", name: "아마테리오스", en: "Amaterios", battleType: "attack", tags: [], desc: "태양신 아마테라스가 모티브. 초강력 어퍼 공격을 만들어내는 5개의 날을 지녔으며, 상대를 버스트시키는 데 특화된 레이어." },
  { id: "LAYER-DEATHSCYTHER", series: "burst", type: "layer", name: "데스사이저", en: "Deathscyther", battleType: "attack", tags: [], desc: "죽음의 신이 모티브, 4장의 칼날로 연속 공격을 가해 회전 밸런스를 무너뜨려 상대를 버스트하는 어택계열 레이어" },
  { id: "LAYER-WYVERN", series: "burst", type: "layer", name: "와이번", en: "Wyvern", battleType: "defense", tags: [], desc: "비룡이 모티브, 7장의 연결된 칼날이 상대를 받아 쳐 공격을 가볍게 받아넘기는 디펜스계열의 레이어" },
  { id: "LAYER-TRIDENT", series: "burst", type: "layer", name: "트라이던트", en: "Trident", battleType: "stamina", tags: [], desc: "세 개의 창 트라이던트가 모티브. 세 개의 큰 날을 가진 대형 레이어가 원심력을 만들어내는 스태미나계열 레이어." },
  { id: "LAYER-ODIN", series: "burst", type: "layer", name: "오딘", en: "Odin", battleType: "attack", tags: [], desc: "군신 오딘이 모티브, 타원형에 붙어있는 톱 같은 칼날이 강력한 공격을 하는 어택계열 레이어" },
  { id: "LAYER-HORUSOOD", series: "burst", type: "layer", name: "호루스드", en: "Horusood", battleType: "stamina", tags: [], desc: "천공의 신 호루스가 모티브, 바깥 둘레에 넓게 퍼져있어 공기의 저항을 덜 받는 날개가 강력한 원심력을 만드는 스태미나계열 레이어" },
  { id: "LAYER-MINOBOROS", series: "burst", type: "layer", name: "미노보로스", en: "Minoboros", battleType: "attack", tags: [], desc: "소머리의 괴물 미노타우로스가 모티브, 거대한 송곳니와 뿔을 가지고 있고 무게중심에 중점을 두고 있는 어택계열 레이어" },
  { id: "LAYER-UNICORN", series: "burst", type: "layer", name: "유니콘", en: "Unicorn", battleType: "defense", tags: [], desc: "일각수 유니콘이 모티브, 바깥 둘레에 배치된 뿔과 갈기가 10장의 칼날 벽을 만들어 상대의 공격을 받아치는 디펜스계열 레이어" },
  { id: "LAYER-XCALIBUR", series: "burst", type: "layer", name: "엑스칼리버", en: "Xcalibur", battleType: "attack", tags: [], desc: "성검 엑스칼리버가 모티브, 큰 칼로 상대에게 강력한 일격을 가하는 어택계열 레이어." },
  { id: "LAYER-EVIL-EYE", series: "burst", type: "layer", name: "이블 아이", en: "Evil-eye", battleType: "defense", tags: [], desc: "악마의 눈을 연상시키는 둥글고 단단한 몸체로 카운터를 노리는 디펜스계열 레이어." },
  { id: "LAYER-CHAOS", series: "burst", type: "layer", name: "카오스", en: "Chaos", battleType: "stamina", tags: [], desc: "혼돈의 신 카오스가 모티브. 두 개의 커다란 원형 칼날이 높은 원심력을 발생시키고 두꺼운 판 형태로 회전력을 보존하는 스태미나계열 레이어." },
  { id: "LAYER-NEPTUNE", series: "burst", type: "layer", name: "넵튠", en: "Neptune", battleType: "balance", tags: [], desc: "해신 넵튠이 모티브, 대중소로 사이즈가 나눠진 칼날로 공격, 방어, 지구 성능을 함께 갖추고 있는 밸런스계열 레이어" },
  { id: "LAYER-YGGDRASIL", series: "burst", type: "layer", name: "위그드라실", en: "Yggdrasil", battleType: "stamina", tags: [], desc: "세계수가 모티브. 외곽에 배치된 네 개의 날이 원심력을 만들어내 오래 회전하는 스태미나계열 레이어." },
  { id: "LAYER-WOLBORG", series: "burst", type: "layer", name: "하운드 도그", jpName: "울보그", en: "Wolborg", battleType: "stamina", tags: [], desc: "사냥개 하운드 도그가 모티브. 원심력을 만들어내는 4개의 날이 지구력을 높이고 상대의 공격을 받아넘기는 스태미나계열의 레이어.", jpDesc: "늑대 울보그가 모티브. 원심력을 만들어내는 4개의 날이 지구력을 높이고 상대의 공격을 받아넘기는 스태미너계열의 레이어." },
  { id: "LAYER-DRAIGER-FANG", series: "burst", type: "layer", name: "클로타이거", jpName: "드래이거 팽", en: "Draiger Fang", battleType: "balance", tags: [], desc: "강력한 발톱을 감추고 있는 클로타이거가 모티브. 공격과 방어에 우수한 날이 겹쳐진 모양의 밸런스계열의 레이어.", jpDesc: "강력한 발톱을 감추고 있는 드래이거 팽이 모티브. 공격과 방어에 우수한 날이 겹쳐진 모양의 밸런스계열의 레이어." },
  { id: "LAYER-STORM-PEGASIS", series: "burst", type: "layer", name: "플래시 슬레이프닐", jpName: "스톰 페가시스", en: "Storm Pegasis", battleType: "attack", tags: [], desc: "위쪽에서 오는 공격을 어퍼 공격으로 튕겨내고, 3개의 날로 상대를 베어가르며 공격을 가하는 레이어." },
  { id: "LAYER-GAIA-DRAGOON-SPIKE", series: "burst", type: "layer", name: "나이프 리저드", jpName: "가이아드라군 스파이크", en: "Gaia Dragoon Spike", battleType: "attack", tags: [], desc: "거대한 자유 회전 윙이 확실하게 상대의 레이어를 잡아내는 어택계열의 레이어." },
  { id: "LAYER-LIGHTNING-L-DRAGO", series: "burst", type: "layer", name: "아쿠아 레비아탄", jpName: "라이트닝 엘드라고", en: "Lightning L-Drago", battleType: "attack", tags: [], desc: "3마리 용의 강한 어택! 연타로 공격할 수 있는 날이 3곳에 있어 공격에 특화된 좌회전 레이어." },
  { id: "DUALLAYER-VICTORY-VALKYRIE", series: "burst", type: "duallayer", name: "빅토리 발키리", en: "Victory Valkyrie", battleType: "attack", tags: [], desc: "전쟁의 신 발키리가 모티브. 날개의 하단 공격으로 상대의 균형을 무너뜨리고 커다란 검의 강력한 상단 공격으로 버스트를 노리는 어택계열 듀얼레이어." },
  { id: "DUALLAYER-STORM-SPRIGGAN", series: "burst", type: "duallayer", name: "스톰 스프리건", en: "Storm Spriggan", battleType: "balance", tags: [], desc: "보물을 지키는 거인 스프리건이 모티브. 상단 공격용 칼날 2장과 하단 방어용 칼날 2장이 짝을 이룬 공격, 방어 일체형 밸런스계열 듀얼레이어." },
  { id: "DUALLAYER-RISING-RAGNARUK", series: "burst", type: "duallayer", name: "라이징 라그나로크", en: "Rising Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 불꽃을 휘감은 악마가 모티브. 하단 공격으로 상대의 공격을 가볍게 받아넘기면서, 불길과 같이 굽어지는 형태의 상단의 2개의 칼날이 커다란 원심력과 기류를 만들어내는 스태미나계열 듀얼레이어." },
  { id: "DUALLAYER-KAISER-KERBEUS", series: "burst", type: "duallayer", name: "카이저 케르베우스", en: "Kaiser Kerbeus", battleType: "defense", tags: [], desc: "지옥을 지키는 개 켈베로스가 모티브. 6개의 상단 칼날의 연타와 12개의 사슬 모양 하단 칼날의 방어력으로 철저한 방어가 가능한 디펜스계열 듀얼레이어." },
  { id: "DUALLAYER-WILD-WYVERN", series: "burst", type: "duallayer", name: "와일드 와이번", en: "Wild Wyvern", battleType: "defense", tags: [], desc: "비룡이 모티브. 상단의 소형칼날 4장으로 연타함과 동시에 하단의 대형칼날 4장으로 공격하여 상대가 다가올 수 없게 하는 디펜스계열의 듀얼레이어." },
  { id: "DUALLAYER-DARK-DEATHSCYTHER", series: "burst", type: "duallayer", name: "다크 데스사이저", en: "Dark Deathscyther", battleType: "attack", tags: [], desc: "죽음의 신의 낫이 모티브. 좌우로 크게 반으로 갈린 상단의 칼날과 하단의 칼날이 상대를 공격하는 어택계열 듀얼레이어." },
  { id: "DUALLAYER-HOLY-HORUSOOD", series: "burst", type: "duallayer", name: "홀리 호루스드", en: "Holy Horusood", battleType: "stamina", tags: [], desc: "천공신 호루스가 모티브. 섬세한 날개형의 하단날로 상대방의 스태미나를 공격하고, 두꺼운 갑옷형의 상단날로 원심력을 발생시키는 스태미나계열의 듀얼레이어." },
  { id: "DUALLAYER-OBELISK-ODIN", series: "burst", type: "duallayer", name: "오벨리스크 오딘", en: "Obelisk Odin", battleType: "attack", tags: [], desc: "군신 오딘이 모티브. 엄폐 형태의 하단 칼날과 마치 두꺼운 벽과 같은 상단 칼날로 인하여 상대에게 강력한 충격을 입히는 어택계열의 듀얼레이어." },
  { id: "DUALLAYER-BALDUR", series: "burst", type: "duallayer", name: "발뒤르", en: "Baldur", battleType: "defense", tags: [], desc: "빛의 신 발뒤르가 모티브. 상단의 견고한 5개 날과 하단의 볼트 5개로 카운터를 노리는 디펜스계열 듀얼레이어." },
  { id: "DUALLAYER-XENO-XCALIBUR", series: "burst", type: "duallayer", name: "제노 엑스칼리버", en: "Xeno Xcalibur", battleType: "attack", tags: [], desc: "성검 엑스칼리버가 모티브. 바깥쪽의 화염의 하단 날로 상대의 공격을 일단 받아 낸 후, 불사조 형태의 중단 날로 되치기 하며, 끝으로 상단 날의 커다란 검으로 상대를 베어내는 초강력 어택계열의 3층 구성의 레이어." },
  { id: "DUALLAYER-YAGER-YGGDRASIL", series: "burst", type: "duallayer", name: "예거 위그드라실", en: "Yager Yggdrasil", battleType: "stamina", tags: [], desc: "8곳의 높아진 부분이 무게추가 되어 원심력을 높이는 스태미나계열 레이어." },
  { id: "DUALLAYER-JAIL-JORMUNGAND", series: "burst", type: "duallayer", name: "제일 요르문간드", en: "Jail Jormungand", battleType: "stamina", tags: [], desc: "독사 요르문간드가 모티브. 위쪽 2장의 칼날로 상대의 공격을 되받아치고, 역공도 가능한 스태미나계열 듀얼레이어." },
  { id: "DUALLAYER-UNLOCK-UNICORN", series: "burst", type: "duallayer", name: "언락 유니콘", en: "Unlock Unicorn", battleType: "defense", tags: [], desc: "환상의 동물 유니콘이 모티브로, 바깥 둘레에 배치된 갈기 모양의 9단 칼날이 상대의 공격을 분산시키고, 약해진 상대에게 상단 칼날의 뿔로 강력한 카운터를 가하는 디펜스계열의 듀얼레이어." },
  { id: "DUALLAYER-NOVA-NEPTUNE", series: "burst", type: "duallayer", name: "노바 넵튠", en: "Nova Neptune", battleType: "balance", tags: [], desc: "해신 넵튠이 모티브. 물보라 형태의 하단 칼날이 상대의 공격을 받아치고 어퍼 형태의 큰 상단 칼날로 버스트를 노리는 밸런스계열 듀얼레이어." },
  { id: "DUALLAYER-ZILLION-ZEUS", series: "burst", type: "duallayer", name: "질리언 제우스", en: "Zillion Zeus", battleType: "stamina", tags: [], desc: "전능의 신 제우스가 모티브. 내장된 메탈 볼이 고속 회전 시에는 바깥쪽으로, 저속 회전 시에는 안쪽으로 이동하면서 밸런스를 유지하는 스태미나계열 듀얼레이어." },
  { id: "DUALLAYER-QUAD-QUETZALCOATL", series: "burst", type: "duallayer", name: "쿼드 케찰콰틀", en: "Quad Quetzalcoatl", battleType: "defense", tags: [], desc: "상단 날의 바깥둘레를 덮는 날개 같은 형태로 상대를 막고, 하단 날로 카운터공격을 가하는 디펜스계열 듀얼레이어." },
  { id: "DUALLAYER-FANG-FENRIR", series: "burst", type: "duallayer", name: "팽 펜리르", en: "Fang Fenrir", battleType: "attack", tags: [], desc: "늑대신 펜리르가 모티브. 크고 두꺼운 갑옷같은 2개의 칼날 사이에 어퍼 공격에 특화된 예리한 칼날을 배치한 어택계열 듀얼레이어." },
  ...
  { id: "DUALLAYER-BEAST-BEHEMOTH", series: "burst", type: "duallayer", name: "비스트 베히모스", en: "Beast Behemoth", battleType: "attack", tags: [], desc: "야수 베히모스가 모티브. 다양한 방향에서 연속 공격을 가할 수 있는 하단날과 5개의 큰 뿔로 강력한 어퍼 공격을 하는 상단 날을 탑재한 어택계열 듀얼레이어." },
  { id: "DUALLAYER-INFERNO-IFRIT", series: "burst", type: "duallayer", name: "인페르노 이프리트", en: "Inferno Ifrit", battleType: "balance", tags: [], desc: "불의 정령 이프리트가 모티브. 엄폐 형태의 상단 날과 스매쉬 형태의 하단 날에 의한 6연타를 가하며 어택과 디펜스 능력을 겸비한 밸런스계열 듀얼레이어." },
  { id: "DUALLAYER-PSYCHIC-PHANTOM", series: "burst", type: "duallayer", name: "사이킥 팬텀", en: "Psychic Phantom", battleType: "stamina", tags: [], desc: "사령 팬텀이 모티브. 스매쉬 형태의 상단 칼날과 어퍼 형태의 하단 칼날이 물결치듯이 어우러진 형상으로, 상대의 공격을 받아 넘기는 스태미나계열의 듀얼레이어." },
  { id: "DUALLAYER-LOST-LONGINUS", series: "burst", type: "duallayer", name: "로스트 롱기누스", en: "Lost Longinus", battleType: "attack", tags: [], desc: "파멸의 창 롱기누스가 모티브. 창의 하단날로 상대를 찌르고 날개 부분의 중단날로 연속 공격을 가한다. 또한 상단부의 메탈 재질 드래곤 블레이드가 공격의 파괴력을 더해주는 극한의 어택계열 3층 구조 레이어." },
  { id: "DUALLAYER-GIGANT-GAIA", series: "burst", type: "duallayer", name: "기간트 가이아", en: "Gigant Gaia", battleType: "balance", tags: [], desc: "울퉁불퉁한 연타형 날과 두껍고 원심력이 높은 형태의 날을 갖추어 방어력과 지구력을 함께 지닌다." },
  { id: "DUALLAYER-MAD-MINOBOROS", series: "burst", type: "duallayer", name: "매드 미노보로스", en: "Mad Minoboros", battleType: "attack", tags: [], desc: "소머리의 괴수 미노타우로스가 모티브. 난폭하게 움직이며 중량감 있는 어금니 모양의 하단 칼날로 상대를 날려 버리고, 날카로운 뿔 모양의 상단 칼날로 최후의 일격을 가해서 버스트를 노리는 어택계열의 듀얼레이어." },
  { id: "DUALLAYER-ACID-ANUBIS", series: "burst", type: "duallayer", name: "애시드 아누비스", en: "Acid Anubis", battleType: "defense", tags: [], desc: "지옥의 수호신 아누비스가 모티브. 작고 둥근 형태가 축이 흔들리는 것을 막고, 작은 돌기가 붙은 하단의 칼날이 상대의 공격을 분산시키는 디펜스계열의 듀얼레이어." },
  { id: "GODLAYER-GOD-VALKYRIE", series: "burst", type: "godlayer", name: "갓 발키리", en: "God Valkyrie", battleType: "attack", tags: [], desc: "전투의 신 발키리가 모티브. 가동성 높은 바운드 칼날(=상단 칼날)이 상대와 접촉하면, 내장된 스프링이 수축했다 밀어내는 힘을 발휘함으로써 상대에게 강력한 공격을 가하는 갓레이어." },
  { id: "GODLAYER-KREIS-SATAN", series: "burst", type: "godlayer", name: "크라이스 사탄", en: "Kreis Satan", battleType: "defense", tags: [], desc: "악마왕 사탄이 모티브. 3개의 롤러로 상대의 공격을 받아 넘겨 약화시키면서, 악마의 날개로 카운터를 노리는 갓레이어." },
  { id: "GODLAYER-BLAZE-RAGNARUK", series: "burst", type: "godlayer", name: "블레이즈 라그나로크", en: "Blaze Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 화염에 둘러싸인 악마가 모티브. 회전하면 링이 열려 원심력이 강화되며, 상대에게 부딪히면 링의 탄력 공격이 유지되는 갓레이어." },
  { id: "GODLAYER-DRAIN-FAFNIR", series: "burst", type: "godlayer", name: "드레인 파브닐", en: "Drain Fafnir", battleType: "stamina", tags: [], desc: "황금의 용 파브닐이 모티브. 우회전 베이를 상대할 때 고무 재질의 칼날을 부딪혀, 상대의 공격을 흡수하여 자신의 회전력을 높이는 좌회전 스태미나계열의 갓레이어." },
  { id: "GODLAYER-GUARDIAN-KERBEUS", series: "burst", type: "godlayer", name: "가디언 케르베우스", en: "Guardian Kerbeus", battleType: "defense", tags: [], desc: "지옥을 지키는 개 켈베로스가 모티브. 탄력있는 소재로 만들어진 작은 중단 칼날이 상대의 공격을 흡수해서 어떤 충격에도 버텨내는 디펜스계열의 갓레이어." },
  { id: "GODLAYER-TORNADO-WYVERN", series: "burst", type: "godlayer", name: "토네이도 와이번", en: "Tornado Wyvern", battleType: "defense", tags: [], desc: "비룡 와이번이 모티브. 레이어 바깥쪽의 칼날이 자유롭게 회전하면서 상대의 공격을 흘려보내고, 본체에 충격이 전달되는 것을 막아주는 디펜스계열의 갓레이어." },
  { id: "GODLAYER-ALTER-CHRONOS", series: "burst", type: "godlayer", name: "알타 크로노스", en: "Alter Chronos", battleType: "balance", tags: [], desc: "시간의 신 크로노스가 모티브. 중심축의 위치를 변경하여, 밸런스가 좋은 스태미나모드와 중심이 한쪽에 치우친 어택모드, 두 가지 모드로 전환이 가능한 갓레이어." },
  { id: "GODLAYER-KILLER-DEATHSCYTHER", series: "burst", type: "godlayer", name: "킬러 데스사이저", en: "Killer Deathscyther", battleType: "attack", tags: [], desc: "사신의 낫이 모티브. 우측의 커다란 칼날에 내장된 가동식 칼날이 반응하여 강력한 2단 공격을, 좌측의 3장의 칼날로는 연타 공격을 가할 수 있는 좌우 비대칭 구성의 갓레이어." },
  { id: "GODLAYER-GALAXY-ZEUS", series: "burst", type: "godlayer", name: "갤럭시 제우스", en: "Galaxy Zeus", battleType: "stamina", tags: [], desc: "그리스 신화의 제우스가 모티브. 베이의 회전속도에 따라 레이어에 있는 4개의 메탈 볼이 위치를 바꿔서 최적의 원심력을 유지하는 스태미나계열의 갓레이어." },
  { id: "GODLAYER-LEGEND-SPRIGGAN", series: "burst", type: "godlayer", name: "레전드 스프리건", en: "Legend Spriggan", battleType: "balance", tags: [], desc: "보물을 지키는 거인, 스프리건이 모티브. 레이어 중앙에 메탈 칩을 포함하고 있고, 우회전 시 어퍼 공격, 좌회전 시 스매시 공격을 펼치는 것이 가능한 갓레이어." },
  { id: "GODLAYER-MAXIMUM-GARUDA", series: "burst", type: "godlayer", name: "맥시멈 가루다", en: "Maximum Garuda", battleType: "stamina", tags: [], desc: "신성한 새 가루다가 모티브. 베이블레이드 버스트 사상 최대 크기의 레이어로 원심력을 높이면서, 공기의 힘을 가진 5장의 거대한 날이 어퍼포스를 만들어 내는 스태미나계열 갓레이어." },
  { id: "GODLAYER-BLAST-JINNIUS", series: "burst", type: "godlayer", name: "블라스트 지니어스", en: "Blast Jinnius", battleType: "defense", tags: [], desc: "바람의 정령 지니가 모티브. 원심력의 영향을 받거나 상대에게 충격을 받으면, 물결 모양의 슬라이드 칼날이 상승해서 적의 공격을 피하는 디펜스계열의 갓레이어." },
  { id: "GODLAYER-SIEG-XCALIBUR", series: "burst", type: "godlayer", name: "지크 엑스칼리버", en: "Sieg Xcalibur", battleType: "attack", tags: [], desc: "성스러운 검 엑스칼리버가 모티브. 메탈 소드의 무게를 검 끝에 집중해서 상대에게 강력한 일격을 가하는 갓레이어." },
  { id: "GODLAYER-SHELTER-REGULUS", series: "burst", type: "godlayer", name: "쉘터 레굴루스", en: "Shelter Regulus", battleType: "balance", tags: [], desc: "사자왕 레굴루스가 모티브. 빠르게 회전할 때는 발톱 모양의 칼날이 나와서 공격 모드로, 느리게 회전할 때는 칼날을 숨겨서 방어 모드로 자동 변환하는 밸런스계열의 갓레이어." },
  { id: "GODLAYER-STRIKE-GOD-VALKYRIE", series: "burst", type: "godlayer", name: "스트라이크 갓 발키리", en: "Strike God Valkyrie", battleType: "attack", tags: [], desc: "전투의 신 발키리가 모티브. 스트라이크 갓 칩과 조합해서 상단, 중단, 하단 칼날이 커다란 하나의 칼날로 합쳐지고, 상대에게 강력한 일격을 가할 수 있는 갓레이어." },
  { id: "GODLAYER-NIGHTMARE-LONGINUS", series: "burst", type: "godlayer", name: "나이트메어 롱기누스", en: "Nightmare Longinus", battleType: "attack", tags: [], desc: "파멸의 창 롱기누스가 모티브. 레이어에 드라이버와의 전용 디스크가 합쳐진 구조로, 묵직하고 파괴적인 공격을 상대에게 가할 수 있는 갓레이어계의 이단아. ※나이트메어 롱기누스 레이어의 갓 칩은 분리·교체할 수 없습니다." },
  { id: "GODLAYER-DEEP-CHAOS", series: "burst", type: "godlayer", name: "딥 카오스", en: "Deep Chaos", battleType: "stamina", tags: [], desc: "혼돈의 신 카오스가 모티브. 스프링이 내장된 바깥쪽 칼날이 상대 베이의 밑으로 파고 들어가, 지구력을 깎아내는 스태미나계열의 갓레이어." },
  { id: "GODLAYER-ARC-BAHAMUT", series: "burst", type: "godlayer", name: "아크 바하무트", en: "Arc Bahamut", battleType: "defense", tags: [], desc: "피해를 받으면 상대의 공격을 받기 어려운 형태로 변형되어 버스트를 방지하는 좌회전 디펜스계열의 갓레이어." },
  { id: "GODLAYER-SPRIGGAN-REQUIEM", series: "burst", type: "godlayer", name: "스프리건 레퀴엠", en: "Spriggan Requiem", battleType: "balance", tags: [], desc: "보물을 지키는 거인, 스프리건이 모티브. 좌·우회전 모두 대응하며 메탈갓칩을 포함한 레이어에 고무 파츠까지 더해서 회전 흡수능력까지 겸비한, 신을 능가하는 갓레이어." },
  { id: "GODLAYER-BEAT-KUKULCAN", series: "burst", type: "godlayer", name: "비트 쿠쿨칸", en: "Beat Kukulcan", battleType: "attack", tags: [], desc: "폭풍우를 부르는 새의 신, 쿠쿨칸이 모티브. 배틀 후반에 접어들면, 부리와 꼬리 모양의 칼날이 빠져나오면서, 공격력이 급격하게 상승하는 어택계열의 갓레이어." },
  { id: "GODLAYER-TWIN-NEMESIS", series: "burst", type: "godlayer", name: "트윈 네메시스", en: "Twin Nemesis", battleType: "attack", tags: [], desc: "분노의 신, 네메시스가 모티브. 커다란 망치 모양의 칼날 2개를 변형시켜, 아래에서 올라치는 어퍼모드와 위에서 내려치는 스매시모드로 바꿀 수 있는 어택계열의 갓레이어." },
  { id: "GODLAYER-SCREW-TRIDENT", series: "burst", type: "godlayer", name: "스크류 트라이던트", en: "Screw Trident", battleType: "stamina", tags: [], desc: "세 갈래의 창, 트라이던트가 모티브. 고무 재질의 바깥쪽 칼날이 비스듬히 연결된 구조로, 외부의 충격을 흡수하여 자신의 회전력으로 바꾸는 스태미나계열의 갓레이어." },
  { id: "GODLAYER-ORICHALCUM", series: "burst", type: "godlayer", name: "오리하르콘", en: "Orichalcum", battleType: "stamina", tags: [], desc: "환상의 금속 오리하르콘이 모티브. 원심력으로 레이어가 드라이버를 눌러 버스트율을 낮추는 버스트캔슬을 발동하는 스태미나계열 갓레이어." },
  ...
  { id: "CHOZLAYER-WINNING-VALKYRIE", series: "burst", type: "chozlayer", name: "위닝 발키리", en: "Winning Valkyrie", battleType: "attack", tags: [], desc: "전투의 신 발키리가 모티브. 금속으로 된 어퍼 날 3개가 상대를 베는 어택계열의 초Z레이어." },
  { id: "CHOZLAYER-Z-ACHILLES", series: "burst", type: "chozlayer", name: "제트 아킬레스", en: "Z Achilles", battleType: "balance", tags: [], desc: "영웅 아킬레스가 모티브. 공격력과 방어력을 겸비한 커다란 검 모양의 날 2개를 가진 밸런스계열의 초Z레이어." },
  { id: "CHOZLAYER-EMPEROR-FORNEUS", series: "burst", type: "chozlayer", name: "엠퍼러 포르네우스", en: "Emperor Forneus", battleType: "defense", tags: [], desc: "상어의 모습을 한 악마 포르네우스가 모티브. 금속의 무게가 실린 12개의 날의 파상 공격으로 상대가 다가오지 못하게 하는 디펜스계열의 초Z레이어." },
  { id: "CHOZLAYER-BLOODY-LONGINUS", series: "burst", type: "chozlayer", name: "블러디 롱기누스", en: "Bloody Longinus", battleType: "attack", tags: [], desc: "파멸의 창 롱기누스가 모티브. 창 모양의 4개의 날에 메탈 드래곤이 융합되어, 무게가 있는 강력한 어퍼 공격을 가할 수 있는 좌회전 어택계열의 초Z레이어." },
  { id: "CHOZLAYER-CRASH-RAGNARUK", series: "burst", type: "chozlayer", name: "크래시 라그나로크", en: "Crash Ragnaruk", battleType: "stamina", tags: [], desc: "종말의 불꽃에 둘러싸인 악마가 모티브. 열고 닫히는 메탈 윙이, 공격력을 유지하면서 원심력을 강화하는 스태미나계열의 초Z레이어." },
  { id: "CHOZLAYER-HELL-SALAMANDER", series: "burst", type: "chozlayer", name: "헬 살라맨더", en: "Hell Salamander", battleType: "balance", tags: [], desc: "화룡 살라맨더가 모티브. 10개의 날로 연타를 가하는 디펜스모드에서 날을 겹쳐서 어택모드로 체인지할 수 있는 초Z레이어." },
  { id: "CHOZLAYER-ARCHER-HERCULES", series: "burst", type: "chozlayer", name: "아처 헤라클레스", en: "Archer Hercules", battleType: "stamina", tags: [], desc: "영웅 헤라클레스가 모티브. 바깥쪽에 배치된 커다란 메탈의 활과 화살이 고속 회전할 때는 바깥쪽으로, 저속 회전할 때는 안쪽으로 움직여서, 회전력이 쉽게 떨어지지 않는 스태미나계열의 초Z레이어." },
  { id: "CHOZLAYER-REVIVE-PHOENIX", series: "burst", type: "chozlayer", name: "리바이브 피닉스", en: "Revive Phoenix", battleType: "defense", tags: [], desc: "불사조 피닉스가 모티브. 상대로부터 공격을 받으면 레이어 바깥쪽의 리바이브 아머가 먼저 버스트해서 본체의 데미지를 막는 디펜스계열의 초Z레이어." },
  { id: "CHOZLAYER-VICE-LEOPARD", series: "burst", type: "chozlayer", name: "바이스 레오파드", en: "Vice Leopard", battleType: "attack", tags: [], desc: "야수의 왕, 레오파드가 모티브. 상단 날이 위아래로 크게 움직여서 공격할 때 마치 무는 것처럼 상대를 끼워넣고 강력한 충격을 가하는 어택계열의 초Z레이어." },
  { id: "CHOZLAYER-BUSTER-XCALIBUR", series: "burst", type: "chozlayer", name: "버스터 엑스칼리버", en: "Buster Xcalibur", battleType: "attack", tags: [], desc: "성스러운 검 엑스칼리버가 모티브. 메탈 검이 고정된 노멀모드와, 메탈 검이 움직이면서 무게를 실은 강력한 공격을 할 수 있는 버스터모드를 가진 어택계열의 초Z레이어." },
  { id: "CHOZLAYER-HAZARD-KERBEUS", series: "burst", type: "chozlayer", name: "해저드 케르베우스", en: "Hazard Kerbeus", battleType: "defense", tags: [], desc: "지옥을 지키는 개, 켈베로스가 모티브. 레이어 바깥의 움직이는 체인 부품이 상대의 공격을 받아넘기는 철벽 디펜스계열의 초Z레이어." },
  { id: "CHOZLAYER-GEIST-FAFNIR", series: "burst", type: "chozlayer", name: "가이스트 파브닐", en: "Geist Fafnir", battleType: "stamina", tags: [], desc: "황금용 파브닐이 모티브. 고속 회전할 때는 고무 날이 들어가 회전력을 보존하고, 저속 회전할 때만 고무 날이 튀어나와 상대의 회전력을 흡수하는 스태미나계열의 초Z레이어." },
  ...
  { id: "CHOZLAYER-SHINING-AMATERIOS", series: "burst", type: "chozlayer", name: "샤이닝 아마테리오스", en: "Shining Amaterios", battleType: "attack", tags: [], desc: "태양신 아마테라스가 모티브. 커다란 5개의 메탈 날에 내장된 가동 날이 연타와 강타의 2단계 공격을 가하는 초공격 특화 어택계열 초제트레이어." },
  { id: "CHOZLAYER-LEFT-APOLLOS", series: "burst", type: "chozlayer", name: "레프트 아폴로스", en: "Left Apollos", battleType: "defense", tags: [], desc: "태양신 아폴로스가 모티브. 톱니 모양의 날 12개로 상대의 공격을 분산하고, 상하의 큰 검으로 역공을 노리는 좌회전 디펜스계열의 초Z레이어." },
  { id: "CHOZLAYER-RIGHT-ARTEMIS", series: "burst", type: "chozlayer", name: "라이트 아르테미스", en: "Right Artemis", battleType: "attack", tags: [], desc: "달의 신 아르테미스가 모티브. 커다란 낫의 어퍼 공격으로 상대의 태세를 무너뜨리고, 무게가 있는 연타 날로 최후의 일격을 가하는 어택계열의 초Z레이어." },
  { id: "CHOZLAYER-LEFT-ECLIPSE", series: "burst", type: "chozlayer", name: "레프트 이클립스", en: "Left Eclipse", battleType: "balance", tags: [], desc: "방어와 공격을 모두 해내는 좌회전 밸런스계열 초제트레이어. 상대의 공격을 받아넘기면서 스매시공격을 가한다." },
  { id: "CHOZLAYER-RIGHT-ECLIPSE", series: "burst", type: "chozlayer", name: "라이트 이클립스", en: "Right Eclipse", battleType: "balance", tags: [], desc: "방어와 공격을 모두 해내는 우회전 밸런스계열 초제트레이어. 강력한 어퍼공격을 가한다." },
  { id: "CHOZLAYER-DEAD-HADES", series: "burst", type: "chozlayer", name: "데드 하데스", en: "Dead Hades", battleType: "balance", tags: [], desc: "어둠의 왕 하데스가 모티브. 가운데에 1개, 바깥쪽에 6개의 금속 무게추로 원심력과 공격력을 강화하는 밸런스계열의 초Z레이어." },
  { id: "CHOZLAYER-ORB-EGIS", series: "burst", type: "chozlayer", name: "오브 이지스", en: "Orb Egis", battleType: "defense", tags: [], desc: "전설의 방패, 이지스가 모티브. 튼튼한 사다리꼴 형태로 높은 방어력을 갖고 있으며, 소재가 다른 볼이 4곳에 들어있어서 상대의 공격을 받아넘길 수 있는 디펜스계열의 초Z레이어." },
  { id: "CHOZLAYER-CHO-Z-VALKYRIE", series: "burst", type: "chozlayer", name: "초Z 발키리", en: "Cho-Z Valkyrie", battleType: "attack", tags: [], desc: "전쟁의 신 발키리가 모티브. 강력한 슈팅으로 버스트되지 않는 무적모드를 탑재. 노 데미지 상태에서 상대를 공격할 수 있는 어택계열의 초Z레이어." },
  { id: "CHOZLAYER-CHO-Z-SPRIGGAN", series: "burst", type: "chozlayer", name: "초Z 스프리건", en: "Cho-Z Spriggan", battleType: "balance", tags: [], desc: "보물을 지키는 거인 스프리건이 모티브. 강력하게 슈팅하면 버스트되지 않는 무적모드를 탑재. 게다가 회전방향을 좌·우로 교체할 수 있는 밸런스계열의 초Z레이어." },
  { id: "CHOZLAYER-CHO-Z-ACHILLES", series: "burst", type: "chozlayer", name: "초Z 아킬레스", en: "Cho-Z Achilles", battleType: "balance", tags: [], desc: "영웅 아킬레스가 모티브. 강력한 슈팅으로 버스트되지 않는 무적모드를 탑재. 각성하면 공격력·방어력·지구력 모두 강화되는 밸런스계열의 초제트레이어." },
  { id: "CHOZLAYER-AIR-KNIGHT", series: "burst", type: "chozlayer", name: "에어 나이트", en: "Air Knight", battleType: "stamina", tags: [], desc: "바람의 기사 나이트가 모티브. 초Z레이어 중 최대 크기로 원심력을 높이고, 프로펠러 모양의 날로 어퍼포스를 만들어서 지면과의 마찰을 줄여주는 스태미나계열의 초Z레이어." },
  { id: "CHOZLAYER-DEAD-PHOENIX", series: "burst", type: "chozlayer", name: "데드 피닉스", en: "Dead Phoenix", battleType: "defense", tags: [], desc: "불사조 피닉스가 모티브. 메탈 파츠가 많이 포함된 데드 아머를 장비. 아머의 방어로 본체가 받는 데미지를 막아내고 초중량을 활용한 역공을 노리는 디펜스계열의 초Z레이어." },
  { id: "CHOZLAYER-BURNING-AMATERIOS", series: "burst", type: "chozlayer", name: "버닝 아마테리오스", en: "Burning Amaterios", battleType: "attack", tags: [], desc: "태양신 아마테라스가 모티브. 커다란 5개의 메탈 날에 내장된 가동 날이 연타와 강타의 2단계 공격을 가하는 버닝 컬러의 어택계열 초제트레이어." },
  { id: "GACHICHIP-DRAGON", series: "burst", type: "gachichip", name: "드래곤", en: "Dragon", tags: [], desc: "전설의 드래곤이 모티브. 표준적으로 4개의 잠금을 가진 우회전 진검칩." },
  { id: "GACHICHIP-VALKYRIE", series: "burst", type: "gachichip", name: "발키리", en: "Valkyrie", tags: [], desc: "전투의 신 발키리가 모티브. 크고 단단한 2개의 각을 가진 우회전 진검칩." },
  { id: "GACHICHIP-ASHURA", series: "burst", type: "gachichip", name: "아수라", en: "Ashura", tags: [], desc: "3개의 얼굴을 가진 귀신, 아수라가 모티브. 촘촘한 7개의 락을 가진 우회전 진검칩." },
  { id: "GACHICHIP-FAFNIR", series: "burst", type: "gachichip", name: "파브닐", en: "Fafnir", tags: [], desc: "황금용 파브닐이 모티브. 평균적인 4개의 락을 갖고 있는 좌회전 진검칩." },
  { id: "GACHICHIP-JOKER", series: "burst", type: "gachichip", name: "조커", en: "Joker", tags: [], desc: "승부의 신 조커가 모티브. 일반적인 잠금과 더 단단한 잠금 두 가지를 갖춘 우회전 진검칩." },
  { id: "GACHICHIP-BAHAMUT", series: "burst", type: "gachichip", name: "바하무트", en: "Bahamut", tags: [], desc: "신룡 바하무트가 모티브. 가느다란 7개의 잠금을 가진 좌회전 진검칩." },
  { id: "GACHICHIP-LONGINUS", series: "burst", type: "gachichip", name: "롱기누스", en: "Longinus", tags: [], desc: "파멸의 창 롱기누스가 모티브. 커다랗고 단단한 2개의 잠금을 가진 좌회전 진검칩." },
  { id: "GACHICHIP-DIABOLOS", series: "burst", type: "gachichip", name: "디아볼로스", en: "Diabolos", tags: [], desc: "악마 용 디아볼로스가 모티브. 웨이트와 일체형으로 무겁고 높은 공격력을 만든다. 좌·우 어느쪽 베이스도 장착 가능한 진검칩." },
  { id: "GACHICHIP-ACHILLES", series: "burst", type: "gachichip", name: "아킬레스", en: "Achilles", tags: [], desc: "영웅 아킬레스가 모티브. 단단한 잠금과 표준적인 잠금을 상호 4개를 가지고 있는 우회전 진검칩." },
  { id: "GACHICHIP-HYDRA", series: "burst", type: "gachichip", name: "히드라", en: "Hydra", tags: [], desc: "뱀신 히드라가 모티브. 3번째 잠금이 단단하여 후반부에 끈기 있게 견디는 우회전 진검칩." },
  { id: "GACHICHIP-PEGASUS", series: "burst", type: "gachichip", name: "페가수스", en: "Pegasus", tags: [], desc: "천마 페가수스가 모티브. 2번째 잠금이 길어서 잠금이 쉽게 풀리지 않는 우회전 진검칩." },
  { id: "GACHICHIP-SPRIGGAN", series: "burst", type: "gachichip", name: "스프리건", en: "Spriggan", tags: [], desc: "보물을 지키는 거인 스프리건이 모티브. 좌·우 양방향으로 회전할 수 있는 밸런스타입의 진검칩." },
  { id: "GACHICHIP-ODIN", series: "burst", type: "gachichip", name: "오딘", en: "Odin", tags: [], desc: "싸움의 신 오딘이 모티브. 5개의 잠금을 가지고 있으며 처음의 잠금이 단단한 우회전 진검칩." },
  { id: "GACHICHIP-DRAGON-II", series: "burst", type: "gachichip", name: "드래곤2", en: "Dragon II", tags: [], desc: "전설의 드래곤을 모티브. 단단한 3개의 잠금을 가지고 있으며 버스트 내성을 극한까지 높인 우회전 진검칩." },
  { id: "GACHICHIP-DIABOLOS-II", series: "burst", type: "gachichip", name: "디아볼로스2", en: "Diabolos II", tags: [], desc: "악마 용 디아볼로스가 모티브. 5개의 잠금을 가진 좌·우 베이스 장착이 가능한 좌·우회전 대응 진검칩." },
  { id: "GACHIWEIGHT-ZAN", series: "burst", type: "gachiweight", name: "참", en: "Zan", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 좌우 2곳에 중심을 두고 있는 밸런스가 좋은 웨이트." },
  { id: "GACHIWEIGHT-RETSU", series: "burst", type: "gachiweight", name: "렬", en: "Retsu", tags: [], desc: "레이어에 내장되어 있는 무게추. 3군데를 중심으로 치우친 공격을 만들어 내는 무거운 웨이트." },
  { id: "GACHIWEIGHT-TEN", series: "burst", type: "gachiweight", name: "천", en: "Ten", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 무게를 4곳에 최대한 집중해서 축이 쉽게 흔들리지 않게 하는 웨이트." },
  { id: "GACHIWEIGHT-SEN", series: "burst", type: "gachiweight", name: "섬", en: "Sen", tags: [], desc: "레이어에 내장하는 무게추. 무게를 6군데에 조금씩 분산한 스태미나타입 웨이트." },
  { id: "GACHIWEIGHT-METSU", series: "burst", type: "gachiweight", name: "멸", en: "Metsu", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 무게를 좌·우 2군데에 집중시켜 베이스의 공격 성능을 한층 더 높인 웨이트." },
  { id: "GACHIWEIGHT-GEN", series: "burst", type: "gachiweight", name: "환", en: "Gen", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 중앙의 돌기에 의해 잠금이 단단해지는 고무 재질의 웨이트." },
  { id: "GACHIWEIGHT-GOKU", series: "burst", type: "gachiweight", name: "극", en: "Goku", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 초중량급의 무게로 궁극의 회전을 만들어내는 웨이트." },
  { id: "GACHIWEIGHT-GOU", series: "burst", type: "gachiweight", name: "굉", en: "Gou", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 무게를 극단적으로 한쪽에 치우치게 하여 공격 성능을 높이는 편중심 웨이트." },
  { id: "GACHIWEIGHT-SOU", series: "burst", type: "gachiweight", name: "쌍", en: "Sou", tags: [], desc: "레이어 안쪽에 장착하는 무게추. 중앙에 집중시킨 무게로 베이스와 밸런스 성능을 높이며, 좌·우 2개로 분산된 무게로 공격 성능도 함께 높인 웨이트." },
  { id: "GACHIBASE-ACE", series: "burst", type: "gachibase", name: "에이스", en: "Ace", battleType: "attack", tags: [], desc: "날카로운 어퍼 날 2개와 두껍고 묵직한 타격 날 2개를 가진 정석적인 어택타입의 베이스." },
  { id: "GACHIBASE-GRAND", series: "burst", type: "gachibase", name: "그랜드", en: "Grand", battleType: "stamina", tags: [], desc: "커다란 원에 가까운 2개의 날과 안쪽의 빈 공간이 강한 원심력을 만들어내는 스태미나타입의 베이스." },
  { id: "GACHIBASE-ROCK", series: "burst", type: "gachibase", name: "록", en: "Rock", battleType: "defense", tags: [], desc: "매끄럽게 아래로 향한 6개의 날로 상대의 공격을 받아 넘겨서, 접근 및 공격을 막는 디펜스타입의 베이스." },
  { id: "GACHIBASE-SLASH", series: "burst", type: "gachibase", name: "슬래시", en: "Slash", battleType: "attack", tags: [], desc: "큰 3개의 어퍼날로 상대를 강력하게 튕겨내는 어택타입의 베이스." },
  { id: "GACHIBASE-BUSHIN", series: "burst", type: "gachibase", name: "무신", en: "Bushin", battleType: "defense", tags: [], desc: "6개의 경에 12개의 연타 날이 있어서, 상대의 공격을 분산해서 받아내는 디펜스타입의 베이스." },
  { id: "GACHIBASE-WIZARD", series: "burst", type: "gachibase", name: "위저드", en: "Wizard", battleType: "stamina", tags: [], desc: "레이어 바깥이 대부분 고무로 쌓여있어 회전 흡수에 특화된 스태미나타입의 베이스." },
  { id: "GACHIBASE-COSMO", series: "burst", type: "gachibase", name: "코스모", en: "Cosmo", battleType: "stamina", tags: [], desc: "2단으로 나뉜 상단 날로 원심력을 높이면서, 아주 매끄러운 하단 날로 모든 마찰을 최소화한 스태미나타입의 베이스." },
  { id: "GACHIBASE-JUDGMENT", series: "burst", type: "gachibase", name: "저지먼트", en: "Judgment", battleType: "balance", tags: [], desc: "초대형의 고무 날이 상대에게 갈리면서 자신도 함께 이동함으로써 승부의 향방을 알 수 없는 밸런스타입의 베이스." },
  { id: "GACHIBASE-DREAD", series: "burst", type: "gachibase", name: "드레드", en: "Dread", battleType: "defense", tags: [], desc: "데미지를 받을 때마다 원형의 형태가 되어 상대의 공격을 흘려보내 버스트를 방지하는 디펜스타입의 베이스." },
  { id: "GACHIBASE-ZWEI", series: "burst", type: "gachibase", name: "츠바이", en: "Zwei", battleType: "attack", tags: [], desc: "초중량급 메탈을 탑재한 대형 어퍼 날로 상대를 격하게 튕겨내는 초 어택타입의 베이스." },
  { id: "GACHIBASE-VENOM", series: "burst", type: "gachibase", name: "베놈", en: "Venom", battleType: "balance", tags: [], desc: "두꺼운 어퍼 공격날과 스매시 연타날을 갖추어 상대의 밸런스를 무너뜨리고 공격을 몰아 붙이는 밸런스타입의 베이스." },
  { id: "GACHIBASE-ERASE", series: "burst", type: "gachibase", name: "이레이즈", en: "Erase", battleType: "balance", tags: [], desc: "얇고 날카로운 5개의 초어퍼날로 상대를 밀어서 위로 공격함과 동시에 공기를 가르며 회전력을 올리는 밸런스타입의 베이스." },
  { id: "GACHIBASE-FLARE", series: "burst", type: "gachibase", name: "플레어", en: "Flare", battleType: "stamina", tags: [], desc: "6개의 메탈 볼이 베이의 회전과 동시에 바깥쪽으로 이동해서 커다란 원심력을 만들어내는 스태미나타입의 베이스." },
  { id: "GACHIBASE-POISON", series: "burst", type: "gachibase", name: "포이즌", en: "Poison", battleType: "defense", tags: [], desc: "레버로 연결된 바깥쪽 4장의 날이 독립적으로 휘어 상대방의 공격을 본체에 전달하지 않는 디펜스타입의 베이스." },
  { id: "GACHIBASE-HEAVEN", series: "burst", type: "gachibase", name: "헤븐", en: "Heaven", battleType: "stamina", tags: [], desc: "원형으로 원심력 높은 날이 잠금이 풀리면 가운데 날이 튀어나와 잠금을 회복하는 스태미나타입의 베이스." },
  { id: "GACHIBASE-LORD", series: "burst", type: "gachibase", name: "로드", en: "Lord", battleType: "balance", tags: [], desc: "좌·우 양방향으로 변경할 수 있으며, 대형 고무날로 공격력과 회전 흡수능력을 겸비한 밸런스타입의 베이스." },
  { id: "GACHIBASE-UNION", series: "burst", type: "gachibase", name: "유니온", en: "Union", battleType: "balance", tags: [], desc: "공격과 수비의 밸런스가 잡힌 스피드모드에서 전용 부품을 장착하면 공격에 특화된 파워모드로 변경할 수 있는 밸런스타입의 베이스." },
  { id: "GACHIBASE-TACT", series: "burst", type: "gachibase", name: "택트", en: "Tact", battleType: "balance", tags: [], desc: "장착하는 웨이트에 따라서 날의 개수가 변경되어 공격·방어 성능을 변화시킬 수 있는 밸런스타입의 베이스." },
  { id: "GACHIBASE-KNOCKOUT", series: "burst", type: "gachibase", name: "넉아웃", en: "Knockout", battleType: "attack", tags: [], desc: "초중량의 메탈을 장착하고 있어 두꺼운 벽과 같은 공격 날로 상대방에게 강한 충격을 가하는 어택타입의 베이스." },
  { id: "GACHIBASE-IMPERIAL", series: "burst", type: "gachibase", name: "임페리얼", en: "Imperial", battleType: "attack", tags: [], desc: "날카로운 연타 날과 웨이트 일체형의 두꺼운 타격 날을 가지고 있어 사용할수록 베이스 안에 숨겨져 있던 바운드 날과 고무 날의 능력이 각성하는 진화 성능을 탑재한 어택타입의 베이스." },
  { id: "GACHIBASE-MASTER", series: "burst", type: "gachibase", name: "마스터", en: "Master", battleType: "balance", tags: [], desc: "바깥쪽에 장착된 어퍼 공격 날의 우회전모드를 반대로 돌리면 메탈이 안쪽으로 위치하여 안정적인 스매시 날의 좌회전모드로 변경 가능한 밸런스타입의 베이스." },
  { id: "GACHIBASE-NAKED", series: "burst", type: "gachibase", name: "네이키드", en: "Naked", battleType: "defense", tags: [], desc: "5개의 날이 높은 벽에 둘러싸인 모양으로 온갖 높이의 공격을 되받아치는 디펜스타입의 베이스." },
  { id: "GACHILAYER-REGALIA-GENESIS", series: "burst", type: "gachilayer", name: "리겔리아 제네시스", en: "Regalia Genesis", battleType: "defense", tags: [], desc: "창세의 방패 제네시스가 모티브. 원형에 가까운 형태로 어떤 공격도 접근하지 못하게 하며 록이 풀려도 버스트하지 않는 무한 록 장치를 가지고 있는 디펜스타입의 레이어." },
  { id: "GACHILAYER-PRIME-APOCALYPSE", series: "burst", type: "gachilayer", name: "프라임 아포칼립스", en: "Prime Apocalypse", battleType: "attack", tags: [], desc: "종언의 검 아포칼립스가 모티브. 큰 한 장의 날의 검으로 강렬한 공격을 하며 록이 풀려도 버스트하지 않는 무한 록 장치를 가지고 있는 어택타입의 레이어." },
  { id: "GACHILAYER-BIGBANG-GENESIS", series: "burst", type: "gachilayer", name: "빅뱅 제네시스", en: "Bigbang Genesis", battleType: "defense", tags: [], desc: "고대 방패 제네시스가 모티브. 연타 칼날로 상대의 공격을 분산시키고 공격을 받아넘긴다. 록이 풀려도 버스트하지 않는 무한 록 장치를 가지고 있는 디펜스타입의 레이어." },
  ...
  { id: "SUPERKINGCHIP-HELIOS", series: "burst", type: "superkingchip", name: "헬리오스", en: "Helios", tags: [], desc: "태양신 헬리오스가 모티브. 베이블레이드 레이어 전체를 고정시키는 좌회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-HYPERION", series: "burst", type: "superkingchip", name: "하이페리온", en: "Hyperion", tags: [], desc: "태양신 하이페리온이 모티브. 베이블레이드 레이어 전체를 고정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-RAGNARUK", series: "burst", type: "superkingchip", name: "라그나로크", en: "Ragnaruk", tags: [], desc: "종말의 불꽃을 휘감은 악마가 모티브. 베이블레이드 전체를 고정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-VALKYRIE", series: "burst", type: "superkingchip", name: "발키리", en: "Valkyrie", tags: [], desc: "전쟁의 신 발키리가 모티브. 베이블레이드 레이어 전체를 고정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-SATAN", series: "burst", type: "superkingchip", name: "사탄", en: "Satan", tags: [], desc: "악마왕 사탄이 모티브. 베이블레이드 전체를 잠그는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-FAFNIR", series: "burst", type: "superkingchip", name: "파브닐", en: "Fafnir", tags: [], desc: "황금용 파브닐이 모티브. 베이블레이드 전체를 잠그는 좌회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-LONGINUS", series: "burst", type: "superkingchip", name: "롱기누스", en: "Longinus", tags: [], desc: "파멸의 창 롱기누스가 모티브. 베이블레이드 전체를 잠그는 좌회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-SOLOMON", series: "burst", type: "superkingchip", name: "솔로몬", en: "Solomon", tags: [], desc: "전설의 마술왕 솔로몬이 모티브. 메탈이 중앙에 배치되어 있어 중심을 안정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-URANUS", series: "burst", type: "superkingchip", name: "우라노스", en: "Uranus", tags: [], desc: "천공신 우라노스가 모티브. 베이블레이드 전체를 잠그는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-LUCIFER", series: "burst", type: "superkingchip", name: "루시퍼", en: "Lucifer", tags: [], desc: "타락천사 루시퍼가 모티브. 메탈 파츠를 탑재하여 무겁고 높은 공격력을 만든 칩코어 일체형의 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-DIABOLOS", series: "burst", type: "superkingchip", name: "디아볼로스", en: "Diabolos", tags: [], desc: "악마룡 디아볼로스가 모티브. 변형시켜 좌우 어느 쪽 링에도 장착할 수 있는 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-DRAGON", series: "burst", type: "superkingchip", name: "드래곤", en: "Dragon", tags: [], desc: "전설의 동물 드래곤이 모티브. 베이블레이드 전체를 잠그는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-SPRIGGAN", series: "burst", type: "superkingchip", name: "스프리건", en: "Spriggan", tags: [], desc: "보물을 지키는 거인 스프리건이 모티브. 장착 방향에 따라 좌우회전이 모두 가능한 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-ACHILLES", series: "burst", type: "superkingchip", name: "아킬레스", en: "Achilles", tags: [], desc: "영웅 아킬레스가 모티브. 베이블레이드 전체를 고정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-HELIOS-II", series: "burst", type: "superkingchip", name: "헬리오스2", en: "Helios II", tags: [], desc: "태양신 헬리오스가 모티브. 메탈 탑재로 중량이 증가한 좌회전 슈퍼킹칩. 메탈칩 코어가 장착되어 있다." },
  { id: "SUPERKINGCHIP-HYPERION-II", series: "burst", type: "superkingchip", name: "하이페리온2", en: "Hyperion II", tags: [], desc: "태양신 하이페리온이 모티브. 메탈 탑재로 중량이 증가한 우회전 슈퍼킹칩. 메탈칩 코어가 장착되어 있다." },
  { id: "SUPERKINGCHIP-LUCIFER-II", series: "burst", type: "superkingchip", name: "루시퍼2", en: "Lucifer II", tags: [], desc: "타락천사 루시퍼가 모티브. 중앙에 탑재된 고무 돌기로 잠금 상태가 단단해지는 우회전 메탈 탑재 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-DEATHSCYTHER", series: "burst", type: "superkingchip", name: "데스사이저", en: "Deathscyther", tags: [], desc: "사신의 낫 데스사이저가 모티브. 베이블레이드 전체를 고정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGCHIP-WYVERN", series: "burst", type: "superkingchip", name: "와이번", en: "Wyvern", tags: [], desc: "비룡 와이번이 모티브. 베이블레이드 전체를 고정시키는 우회전 슈퍼킹칩." },
  { id: "SUPERKINGRING-KING", series: "burst", type: "superkingring", name: "킹", en: "King", battleType: "balance", tags: [], desc: "어퍼 형태의 5개의 칼날로 연속 공격과 방어가 모두 가능한 밸런스타입의 좌회전 링." },
  { id: "SUPERKINGRING-SUPER", series: "burst", type: "superkingring", name: "슈퍼", en: "Super", battleType: "attack", tags: [], desc: "날카로운 대형 어퍼 칼날로 상대를 공중으로 날린 뒤 연타 칼날로 공격하는 어택타입의 우회전 링." },
  { id: "SUPERKINGRING-GLIDE", series: "burst", type: "superkingring", name: "글라이드", en: "Glide", battleType: "stamina", tags: [], desc: "매끄러운 형태의 칼날로 상대의 공격을 받아넘기고 개폐되는 3개의 스태미나 윙으로 원심력을 초강화한 스태미나타입의 우회전 링." },
  { id: "SUPERKINGRING-BRAVE", series: "burst", type: "superkingring", name: "브레이브", en: "Brave", battleType: "attack", tags: [], desc: "대형 고무 칼날의 마찰력으로 상대와 맞붙은 후 고무의 탄력으로 바운드 공격을 가하는 어택타입의 우회전 링." },
  { id: "SUPERKINGRING-CURSE", series: "burst", type: "superkingring", name: "커스", en: "Curse", battleType: "defense", tags: [], desc: "바깥쪽에 배치된 5개의 롤러로 공격을 받아내 데미지를 받지 않는 디펜스타입의 우회전 링." },
  { id: "SUPERKINGRING-MIRAGE", series: "burst", type: "superkingring", name: "미라지", en: "Mirage", battleType: "stamina", tags: [], desc: "바깥 전체가 고무 날로 둘러싸여 있어 강력한 흡수 구조로 된 스태미나타입의 좌회전 링." },
  { id: "SUPERKINGRING-RAGE", series: "burst", type: "superkingring", name: "레이지", en: "Rage", battleType: "attack", tags: [], desc: "초중량 메탈 드래곤으로 상대에게 연속 타격을 주고 날개모양의 어퍼 날로 상대를 강하게 날려 버리는 어택타입의 좌회전 링." },
  { id: "SUPERKINGRING-FIRST", series: "burst", type: "superkingring", name: "퍼스트", en: "First", battleType: "defense", tags: [], desc: "어퍼 날로 상대를 공중으로 튀어 올려 공격하는 어택타입의 우회전 링." },
  { id: "SUPERKINGRING-VARIANT", series: "burst", type: "superkingring", name: "베어리언트", en: "Variant", battleType: "defense", tags: [], desc: "날카로운 카운터 날과 두꺼운 타격 날이 번갈아 배치된 연타형을 갖추어 공격을 잘 되받아치는 디펜스타입의 우회전 링." },
  { id: "SUPERKINGRING-DEATH", series: "burst", type: "superkingring", name: "데스", en: "Death", battleType: "balance", tags: [], desc: "연타형상의 하단 날로 상대의 체력을 닳게 하고, 대형 어퍼 상단의 날로 최후의 일격을 날리는 밸런스타입의 우회전 링." },
  { id: "SUPERKINGRING-ABYSS", series: "burst", type: "superkingring", name: "어비스", en: "Abyss", battleType: "balance", tags: [], desc: "하단의 연타형 날과 상단의 스매시 날이 하나로 되어 있어, 상대의 자세를 무너뜨리면서 공격을 받아넘기는 방어도 가능한 밸런스타입의 좌회전 링." },
  { id: "SUPERKINGRING-TEMPEST", series: "burst", type: "superkingring", name: "템페스트", en: "Tempest", battleType: "attack", tags: [], desc: "크고 작은 4개의 바운드 날로 상대를 날려버린다. 또한 바운드 날이 끝까지 움직여 고정되면 각성모드가 되는 어택타입의 우회전 링." },
  { id: "SUPERKINGRING-WORLD", series: "burst", type: "superkingring", name: "월드", en: "World", battleType: "balance", tags: [], desc: "앞뒤로 원하는 회전 방향을 정할 수 있으며 강한 충격을 받았을 때 버스트되지 않는 버스트락을 탑재한 밸런스타입의 좌우회전 링." },
  { id: "SUPERKINGRING-INFINITE", series: "burst", type: "superkingring", name: "인피니트", en: "Infinite", battleType: "balance", tags: [], desc: "검과 방패를 장착하여 어택모드와 디펜스모드를 전환할 수 있는 밸런스타입의 우회전 링." },
  { id: "SUPERKINGRING-BURN", series: "burst", type: "superkingring", name: "번", en: "Burn", battleType: "attack", tags: [], desc: "4개의 대형 어택 날이 상대를 공격한다. 배틀 중 잠금 상태가 되거나 강한 충격을 받으면 초대형 4개의 날로 변해 강력한 일격을 가하는 어택타입의 우회전 링." },
  { id: "SUPERKINGRING-VOLCANO", series: "burst", type: "superkingring", name: "볼케이노", en: "Volcano", battleType: "balance", tags: [], desc: "5개의 날이 공격력과 방어력을 모두 갖추고 있다. 배틀 중 잠금 상태가 되거나 강한 충격을 받으면 10개의 날로 변해 상대의 공격을 분산하면서 바운드 날로 카운터를 날리는 밸런스타입의 좌회전 링." },
  { id: "SUPERKINGRING-THE-END", series: "burst", type: "superkingring", name: "디 엔드", en: "The End", battleType: "defense", tags: [], desc: "2단으로 나눠진 불규칙적인 카운터 날이 상대를 튕겨낸다. 배틀 중 잠금 상태가 되거나 강한 충격을 받으면 형태가 변하여 상하단의 날이 자유회전한다. 어떤 공격도 받아낼 수 있는 디펜스타입의 우회전 링." },
  { id: "SUPERKINGRING-HOLLOW", series: "burst", type: "superkingring", name: "할로우", en: "Hollow", battleType: "attack", tags: [], desc: "대형 메탈 날에 의한 강력한 타격 효과와 뒷면에 메탈을 내장한 3장의 날로 연타 공격이 가능. 좌우로 다른 형태의 날을 가진 비대칭 중심의 어택타입 우회전 링." },
  { id: "SUPERKINGRING-JET", series: "burst", type: "superkingring", name: "제트", en: "Jet", battleType: "defense", tags: [], desc: "고무가 탑재된 바깥쪽 날이 우회전 상대에게는 자유회전을 하고 좌회전 상대에게는 고정회전을 받아넘기기와 카운터 공격이 가능한 디펜스타입의 우회전 링." },
  { id: "SUPERKINGCHASSIS-1A", series: "burst", type: "superkingchassis", name: "원 어택", en: "1 Attack", battleType: "attack", tags: ["더블 섀시"], desc: "두껍게 밀려나와 있는 대형 타격 칼날로 상대에게 강렬한 일격을 날리는 어택타입의 우회전 더블 섀시." },
  { id: "SUPERKINGCHASSIS-1B", series: "burst", type: "superkingchassis", name: "원 밸런스", en: "1 Balance", battleType: "balance", tags: ["더블 섀시"], desc: "균형감 있게 배치된 5개의 칼날로 연속공격 능력과 지구력을 겸비한 밸런스타입의 좌우회전 더블 섀시." },
  { id: "SUPERKINGCHASSIS-1S", series: "burst", type: "superkingchassis", name: "원 스테미나", en: "1 Stamina", battleType: "stamina", tags: ["싱글 섀시"], desc: "지름이 큰 원형 모양에 더불어 중심이 바깥에 위치한 형태로 커다란 원심력을 만들어 내는 스태미나타입의 좌우회전 섀시." },
  { id: "SUPERKINGCHASSIS-1D", series: "burst", type: "superkingchassis", name: "원 디펜스", en: "1 Defense", battleType: "defense", tags: ["싱글 섀시"], desc: "내부 중심으로 축이 잘 흔들리지 않고 잠김이 단단한 디펜스타입의 섀시." },
  { id: "SUPERKINGCHASSIS-2A", series: "burst", type: "superkingchassis", name: "투 어택", en: "2 Attack", battleType: "attack", tags: ["더블 섀시"], desc: "3개의 대형 고무 칼날로 상대에게 강렬히 마찰 공격을 가하는 어택타입의 우회전 더블 섀시." },
  { id: "SUPERKINGCHASSIS-2B", series: "burst", type: "superkingchassis", name: "투 밸런스", en: "2 Balance", battleType: "balance", tags: ["더블 섀시"], desc: "링에 따라 고정 날 어택모드와 자유회전날 디펜스모드로 변경할 수 있는 밸런스타입의 좌우회전 더블 섀시." },
  { id: "SUPERKINGCHASSIS-2S", series: "burst", type: "superkingchassis", name: "투 스테미나", en: "2 Stamina", battleType: "stamina", tags: ["더블 섀시"], desc: "가볍고 폭이 넓은 형태로 원심력이 강하여 지구력이 특화된 스태미나타입의 양방향 섀시." },
  { id: "SUPERKINGCHASSIS-2D", series: "burst", type: "superkingchassis", name: "투 디펜스", en: "2 Defense", battleType: "defense", tags: ["더블 섀시"], desc: "고속 회전 시 6개의 배리어 날이 펼쳐져 어떤 공격도 무효화시키는 디펜스 특화형의 좌우회전 더블 섀시. 2D 섀시는 낮은 회전 시 배리어 날이 안으로 들어와 디펜스타입에서 어택타입으로 성능이 변하는 특징이 있습니다." },
  { id: "SUPERKINGCHASSIS-3A", series: "burst", type: "superkingchassis", name: "쓰리 어택", en: "3 Attack", battleType: "attack", tags: ["더블 섀시"], desc: "창모양의 거대 어퍼 날로 상대를 아래에서 위로 들어 올리는 어택타입의 좌회전 더블 섀시." },
  { id: "SUPERKINGCHASSIS-4A", series: "burst", type: "superkingchassis", name: "포 어택", en: "4 Attack", battleType: "attack", tags: ["싱글 섀시"], desc: "단단하게 잠길 뿐 아니라 좌·우 무게가 다른 비대칭 성능으로 공격력을 최대로 끌어올린 어택타입의 좌우회전 싱글 섀시." },
  ...
  { id: "SUPERKINGUPGRADE-INFINITE-SHIELD", series: "burst", type: "superkingupgrade", name: "인피니트 실드", en: "Infinite Shield", tags: [], desc: "인피니트 링 전용 강화파츠. 두껍고 거친 연타날로 어떤 공격도 받아내는 디펜스타입 강화파츠." },
  { id: "DBLAYER-GREATEST-RAPHAEL", series: "burst", type: "dblayer", name: "그레이티스트 라파엘", en: "Greatest Raphael", battleType: "balance", tags: [], desc: "대천사 라파엘이 모티브. DB코어·아머·블레이드 일체형으로 강력한 슈팅을 하면 오버드라이브 시스템이 발동한다. 회전이 느려짐에 따라 아머가 점점 올라가며 변형하고, 내장된 메탈 파츠가 움직여 스태미나 성능이 상승한다. 외중심 8개 날의 어택모드에서 내중심 0개 날의 디펜스모드로 변형해 메탈 버스트락도 발동하는 밸런스타입의 우회전 레이어." },
  { id: "DBCORE-BELIAL", series: "burst", type: "dbcore", name: "벨리알", en: "Belial", tags: [], desc: "마왕 벨리알이 모티브. 강력한 4개의 잠금을 가진 우회전 DB코어." },
  { id: "DBCORE-RAGNARUK", series: "burst", type: "dbcore", name: "라그나로크", en: "Ragnaruk", tags: [], desc: "종말의 화염 라그나로크가 모티브. 반동 없는 7개의 잠금을 가진 우회전 DB코어." },
  { id: "DBCORE-PERSEUS", series: "burst", type: "dbcore", name: "페르세우스", en: "Perseus", tags: [], desc: "별의 신 페르세우스가 모티브. 원형을 따라 배치된 메탈 파츠가 원심력과 공격력을 크게 높이는 우회전 DB코어." },
  { id: "DBCORE-VALKYRIE", series: "burst", type: "dbcore", name: "발키리", en: "Valkyrie", tags: [], desc: "전투의 신 발키리가 모티브. 내장된 스프링에 의해 장착한 블레이드가 바운드 공격을 할 수 있게 만드는 우회전 DB코어." },
  { id: "DBCORE-FAFNIR", series: "burst", type: "dbcore", name: "파브닐", en: "Fafnir", tags: [], desc: "황금의 용 파브닐이 모티브. 강력한 4개의 잠금을 가진 좌회전 DB코어." },
  { id: "DBCORE-SPRIGGAN", series: "burst", type: "dbcore", name: "스프리건", en: "Spriggan", tags: [], desc: "보물을 지키는 거인 스프리건이 모티브. 전용 툴을 사용하여 회전방향을 바꿀 수 있는 좌우 양방향 회전 DB코어." },
  { id: "DBCORE-BAHAMUT", series: "burst", type: "dbcore", name: "바하무트", en: "Bahamut", tags: [], desc: "신룡 바하무트가 모티브. 버스트를 막는 능력이 뛰어난 고무 재질의 잠금장치를 가진 좌회전 DB코어." },
  { id: "DBCORE-LONGINUS", series: "burst", type: "dbcore", name: "롱기누스", en: "Longinus", tags: [], desc: "파멸의 창 롱기누스가 모티브. 2마리의 메탈 드래곤을 탑재하여 엄청난 중량감을 자랑하는 좌회전 DB코어." },
  { id: "DBCORE-IFRIT", series: "burst", type: "dbcore", name: "이프리트", en: "Ifrit", tags: [], desc: "불의 정령 이프리트가 모티브. 이프리트의 옆얼굴을 형상화한 우회전 DB코어." },
  { id: "DBCORE-PHOENIX", series: "burst", type: "dbcore", name: "피닉스", en: "Phoenix", tags: [], desc: "불사조 피닉스가 모티브. 크고 작은 4개의 잠금을 가진 우회전 DB코어." },
  { id: "DBCORE-BELIAL-II", series: "burst", type: "dbcore", name: "벨리알2", en: "Belial II", tags: [], desc: "마왕 벨리알이 모티브. 강력한 슈팅 시 버스트락이 걸리는 우회전 DB코어." },
  { id: "DBCORE-VALKYRIE-II", series: "burst", type: "dbcore", name: "발키리2", en: "Valkyrie II", tags: [], desc: "전투의 신 발키리가 모티브. 역대 발키리를 총집합한 디자인이며 3개의 강력한 잠금을 가진 우회전 DB코어." },
  { id: "DBCORE-KERBEUS", series: "burst", type: "dbcore", name: "케르베우스", en: "Kerbeus", tags: [], desc: "명계의 파수견 케르베우스가 모티브. 버스트 내성이 높은 러버 재질 락을 가진 우회전 DB코어." },
  { id: "DBCORE-DRAGON", series: "burst", type: "dbcore", name: "드래곤", en: "Dragon", tags: [], desc: "전설의 드래곤을 모티브. 작은 스프링이 내장되어 있으며 3개의 잠금과 바운드 기능을 가진 우회전 DB코어." },
  { id: "DBCORE-HELLO-KITTY", series: "burst", type: "dbcore", name: "헬로키티", en: "Hello Kitty", tags: [], desc: "헬로키티가 모티브. 전용 툴을 사용해 회전 방향을 전환할 수 있는 좌우 양방향 회전 DB코어." },
  { id: "DBCORE-XCALIBUR", series: "burst", type: "dbcore", name: "엑스칼리버", en: "Xcalibur", tags: [], desc: "성검 엑스칼리버가 모티브. 배틀 중에 내장된 메탈 검이 나와 무게중심이 한쪽에 실려 강력한 공격이 가능한 우회전 DB코어." },
  { id: "DBCORE-ACHILLES", series: "burst", type: "dbcore", name: "아킬레스", en: "Achilles", tags: [], desc: "영웅 아킬레스가 모티브. 전용 툴로 회전 방향 변경이 가능하다. 2개의 BU락을 가진 좌우 양방향 회전 DB코어." },
  { id: "DBCORE-KNIGHT", series: "burst", type: "dbcore", name: "나이트", en: "Knight", tags: [], desc: "바람의 기사 나이트가 모티브. 락 부분이 위아래로 움직이며 충격을 받아넘기는 우회전 DB코어." },
  { id: "DBCORE-HELIOS", series: "burst", type: "dbcore", name: "헬리오스", en: "Helios", tags: [], desc: "태양신 헬리오스가 모티브. 강력한 4개의 잠금장치와 2개의 BU락을 가진 좌회전 DB코어." },
  { id: "DBCORE-HYPERION", series: "burst", type: "dbcore", name: "하이페리온", en: "Hyperion", tags: [], desc: "태양신 하이페리온이 모티브. 강력한 4개의 잠금장치와 2개의 BU락을 가진 우회전 DB코어." },
  { id: "DBCORE-BELIAL-III", series: "burst", type: "dbcore", name: "벨리알3", en: "Belial III", tags: [], desc: "마왕 벨리알이 모티브. 강력한 3개의 잠금장치와 1개의 BU락을 가지고 있어 강한 슈팅을 하면 버스트락이 걸리는 우회전 DB코어." },
  { id: "DBCORE-SPRIGGAN-II", series: "burst", type: "dbcore", name: "스프리건2", en: "Spriggan II", tags: [], desc: "보물을 지키는 거인 스프리건이 모티브. 역대 스프리건을 총집합한 디자인이며 회전 방향 변경이 가능한 좌우회전 DB코어." },
  { id: "DBCORE-LUCIFER", series: "burst", type: "dbcore", name: "루시퍼", en: "Lucifer", tags: [], desc: "타락천사 루시퍼가 모티브. 강력한 3개의 잠금과 3개의 BU락을 가진 우회전 DB코어." },
  { id: "DBBLADE-DYNAMITE", series: "burst", type: "dbblade", name: "다이너마이트", en: "Dynamite", battleType: "attack", tags: [], desc: "얇고 예리한 악마의 날개로 폭발적인 어퍼 공격을 날리는 우회전 블레이드." },
  { id: "DBBLADE-CYCLONE", series: "burst", type: "dbblade", name: "사이클론", en: "Cyclone", battleType: "stamina", tags: [], desc: "두껍고 원형에 가까운 날과 최대급 스태미나 날 2개를 탑재하여 엄청난 원심력을 낳는 스태미나타입의 우회전 블레이드." },
  { id: "DBBLADE-VANISH", series: "burst", type: "dbblade", name: "배니시", en: "Vanish", battleType: "stamina", tags: [], desc: "전체가 고무 소재로 만들어졌으며 곳곳이 비어 있어 탄력있는 날로 상대의 회전을 흡수하는 스태미나타입의 좌회전 블레이드." },
  { id: "DBBLADE-ROAR", series: "burst", type: "dbblade", name: "로어", en: "Roar", battleType: "defense", tags: [], desc: "4개 날의 카운터모드에서 잠금이 진행되면 디펜스 날이 나와 원형의 극강 방어모드가 되는 디펜스타입의 좌회전 블레이드." },
  { id: "DBBLADE-SAVIOR", series: "burst", type: "dbblade", name: "세이비어", en: "Savior", battleType: "attack", tags: [], desc: "상대를 튕겨내는 큰 러버 날이 배틀을 거듭할수록 마모되면서 새로운 공격날이 등장, 초강력 러버 성능으로 각성하는 어택타입의 우회전 블레이드." },
  { id: "DBBLADE-DEVIL", series: "burst", type: "dbblade", name: "데빌", en: "Devil", battleType: "attack", tags: [], desc: "날카로운 마왕의 발톱으로 폭발적인 공격을 가하고, 톱니 모양의 날개로 상대를 베어내듯 공격하는 어택타입 우회전 블레이드." },
  { id: "DBBLADE-ASTRAL", series: "burst", type: "dbblade", name: "아스트랄", en: "Astral", battleType: "balance", tags: [], desc: "좌회전시에는 러버 파츠로 회전을 흡수. 우회전시에는 메탈 파츠로 강력한 공격이 가능한 밸런스타입의 좌우 양방향 회전 블레이드." },
  { id: "DBBLADE-GUILTY", series: "burst", type: "dbblade", name: "길티", en: "Guilty", battleType: "attack", tags: [], desc: "앞면에 4마리, 뒷면에 2마리의 드래곤을 탑재하고 있으며, 메탈에 의한 초중량 공격과 어퍼 공격에 더해 위에서 내려찍는 공격까지 가능한 어택타입의 좌회전 블레이드." },
  ...
  { id: "DBBLADE-PROMINENCE", series: "burst", type: "dbblade", name: "프로미넌스", en: "Prominence", battleType: "defense", tags: [], desc: "강력한 공격을 받으면 프로미넌스 실드가 분리되며 충격을 피해 버스트를 막는다. 프로미넌스 실드의 장착 방향에 따라 분리 강도를 바꿀 수 있는 디펜스타입 우회전 블레이드." },
  { id: "DBBLADE-DANGEROUS", series: "burst", type: "dbblade", name: "데인저러스", en: "Dangerous", battleType: "attack", tags: [], desc: "3개의 대형 날로 다져진 강렬한 공격 성능과 함께 날이 안쪽에 숨겨진 단단한 러버에 의해 강성과 반발력을 높이는 어택타입 우회전 블레이드." },
  { id: "DBBLADE-ULTIMATE", series: "burst", type: "dbblade", name: "얼티밋", en: "Ultimate", battleType: "attack", tags: [], desc: "역대 발키리를 총집합한 디자인. 찌를 듯이 날카로운 V자형 러버 날과 대형 메탈 날이 상대를 더 강하게 튕겨내는 어택타입 우회전 블레이드." },
  { id: "DBBLADE-DIVINE", series: "burst", type: "dbblade", name: "디바인", en: "Divine", battleType: "attack", tags: [], desc: "3곳에 메탈을 탑재하여 얇은 공격날로 예리하면서도 무거운 공격을 상대에게 날리는 어택타입의 우회전 BU 블레이드." },
  { id: "DBBLADE-CHAIN", series: "burst", type: "dbblade", name: "체인", en: "Chain", battleType: "defense", tags: [], desc: "8개의 두꺼운 체인 날로 상대의 공격을 분산시켜 막아낸다. 장착하는 DB코어나 모드에 따라 6곳에 있는 가동 날의 움직임이 변하며 상대의 공격을 받아넘기거나 카운터 방어를 하는 등 성능이 변화하는 디펜스타입의 우회전 BU블레이드." },
  { id: "DBBLADE-GATLING", series: "burst", type: "dbblade", name: "개틀링", en: "Gatling", battleType: "attack", tags: [], desc: "커다란 4개의 날이 상대를 가르고 로우모드 시 날이 펼쳐지며 슬라이드 날이 나와 연속 공격이 가능해지는 어택타입의 우회전 BU 블레이드." },
  { id: "DBBLADE-XIPHOID", series: "burst", type: "dbblade", name: "지포이드", en: "Xiphoid", battleType: "attack", tags: [], desc: "커다란 1개의 날이 검 끝에 모든 공격력을 집중시키고 필살의 일격으로 큰 타격을 준다. DB코어 \"엑스칼리버\", 메탈 검의 공격력을 최대한 끌어내는 어택타입의 우회전 BU 블레이드." },
  { id: "DBBLADE-ZEST", series: "burst", type: "dbblade", name: "제스트", en: "Zest", battleType: "balance", tags: [], desc: "큰 검과 방패로 이루어진 얇은 2개의 날로 공기를 가르며 기동력이 높다. 밸런스타입의 좌우 양방향 회전 BU블레이드." },
  { id: "DBBLADE-WIND", series: "burst", type: "dbblade", name: "윈드", en: "Wind", battleType: "stamina", tags: [], desc: "대형 원형 프로펠러 날로 공기의 흐름을 만들고, 2층 구조의 날을 어긋나게 조합해 어퍼포스모드와 다운포스모드를 전환할 수 있는 스태미나타입 우회전 BU블레이드." },
  { id: "DBBLADE-KING-MR", series: "burst", type: "dbblade", name: "킹 MR", en: "King MR", battleType: "balance", tags: [], desc: "메탈 연타날로 상대의 공격을 분산시키는 \"킹 M\", 러버 연타날로 회전흡수나 카운터공격이 가능한 \"킹 R\"로 이루어진 얼티밋 합체 시스템을 탑재한 좌우회전 BU 블레이드." },
  { id: "DBBLADE-SUPER-MR", series: "burst", type: "dbblade", name: "슈퍼 MR", en: "Super MR", battleType: "attack", tags: [], desc: "대형 공격 날에 메탈의 무게감이 더해진 \"슈퍼 M\", 과감한 일격의 탄성을 가진 러버날 \"슈퍼 R\"로 이루어진 얼티밋 합체 시스템을 탑재한 좌우회전 BU 블레이드." },
  { id: "DBBLADE-BURST", series: "burst", type: "dbblade", name: "버스트", en: "Burst", battleType: "balance", tags: [], desc: "역대 스프리건을 총집합한 디자인. 러버 날의 공격과 흡수, 메탈 날의 방어와 지구력에 더해 버스트락까지 겸비하고 있다. 뒤집어 우회전 어퍼와 좌회전 스매시로 모드 변경이 가능한 좌우회전 BU 블레이드." },
  { id: "DBBLADE-BARRICADE", series: "burst", type: "dbblade", name: "바리케이드", en: "Barricade", battleType: "defense", tags: [], desc: "고속 회전 시 4개의 배리어 날이 펼쳐져 상대의 공격을 무효화한다. 배틀 후반에 배리어 날이 원형에 가까운 형태로 접혀 철저한 방어를 하는 우회전 BU 블레이드." },
  { id: "DBARMOR-2", series: "burst", type: "dbarmor", name: "2", en: "2", sub: "투", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 상하 2곳에 중심이 모여 있어 공격력을 강화한다." },
  { id: "DBARMOR-6", series: "burst", type: "dbarmor", name: "6", en: "6", sub: "식스", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 6곳으로 분산된 바깥을 향하는 중심이 원심력을 더욱 강화한다." },
  { id: "DBARMOR-3", series: "burst", type: "dbarmor", name: "3", en: "3", sub: "쓰리", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 3곳으로 치우친 중심이 흔들리는 공격을 만들어 낸다." },
  { id: "DBARMOR-10", series: "burst", type: "dbarmor", name: "10", en: "10", sub: "텐", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 10곳에 중심을 균등하게 배치하여 안정성을 더욱 강화한다." },
  { id: "DBARMOR-7", series: "burst", type: "dbarmor", name: "7", en: "7", sub: "세븐", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 기울어진 중심에 의해 향상되는 공격력과 공격 성능에 의한 기동력까지 겸비." },
  { id: "DBARMOR-0", series: "burst", type: "dbarmor", name: "0", en: "0", sub: "제로", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 안정감 있는 모양의 웨이트가 베이의 밸런스를 올려준다. 치우침 없는 안정적인 무게가 베이의 균형을 잡아준다." },
  { id: "DBARMOR-9", series: "burst", type: "dbarmor", name: "9", en: "9", sub: "나인", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 3장씩 3곳에 있는 날개 모양이 공기를 가르며 나아간다." },
  { id: "DBARMOR-1", series: "burst", type: "dbarmor", name: "1", en: "1", sub: "원", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 한 곳에 무게가 집중되어 있어 레이어의 무게중심을 한쪽에 실으며 공격력을 강화한다." },
  { id: "DBARMOR-4", series: "burst", type: "dbarmor", name: "4", en: "4", sub: "포", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 균일하게 배치된 4곳의 중심이 베이의 원심력을 향상시킨다." },
  { id: "DBARMOR-8", series: "burst", type: "dbarmor", name: "8", en: "8", sub: "에이트", tags: [], desc: "레이어를 고정하는 메탈 아머 파츠. 8곳에 무게중심을 분산시킨 도끼 모양의 디자인. 회전 밸런스가 좋다." },
  { id: "EVOLUTIONGEAR-F", series: "burst", type: "evolutiongear", name: "F", en: "F", tags: [], desc: "벨리알의 성능을 높여주는 진화기어. 하단에 고무 날이 추가되어 더욱 강력한 반격 기능을 발휘한다." },
  { id: "EVOLUTIONGEAR-S", series: "burst", type: "evolutiongear", name: "S", en: "S", tags: [], desc: "Nx 디스크에 날이 추가! 앞쪽으로 세팅하면 고정 어택 날로, 뒤쪽으로 세팅하면 자유회전 반격 날로 변화!" },
  { id: "EVOLUTIONGEAR-L", series: "burst", type: "evolutiongear", name: "L", en: "L", tags: [], desc: "벨리알의 성능을 올려주는 진화기어. 다이너마이트 블레이드와 데빌 블레이드의 하이모드에 장착 가능하며, 중량을 높여 3곳의 드래곤이 공격력을 강화한다." },
  { id: "EVOLUTIONGEAR-V", series: "burst", type: "evolutiongear", name: "V", en: "V", tags: [], desc: "벨리알의 성능을 높여주는 진화기어. Vn 드라이버에 장착하면 잠금 강화와 중량 증가로 성능이 극도로 향상된다." },
  { id: "EVOLUTIONGEAR-A", series: "burst", type: "evolutiongear", name: "A", en: "A", tags: [], desc: "벨리알의 성능을 올려주는 진화기어 \"A 기어\". 벨리알의 BU 블레이드 디바인 전용 진화기어. 블레이드 하단에 날을 추가! 장착하는 방향에 따라 공격적인 3개날모드와 방어력이 높은 6개날모드 중 선택 가능!" },
  { id: "EVOLUTIONGEAR-D", series: "burst", type: "evolutiongear", name: "D", en: "D", tags: [], desc: "벨리알의 성능을 높여주는 진화기어. 디스크에 슬라이드 공격날이 추가되어 연속 공격이 가능!" },
  { id: "EVOLUTIONGEAR-H", series: "burst", type: "evolutiongear", name: "H", en: "H", tags: [], desc: "벨리알을 진화시키는 진화기어. 플라스틱 아머와 메탈 아머 2가지로 구성된 아머. 로우모드 시에는 공기를 가르며 기동력이 상승하고 하이모드 시에는 스매시공격 & 버스트락이 발동한다." },
  { id: "EVOLUTIONGEAR-VS", series: "burst", type: "evolutiongear", name: "VS", en: "VS", tags: [], desc: "벨리알의 드라이버 ｢Ad｣, ｢Vn｣ 전용 진화기어! 드라이버 끝에 장착해 메탈 힘으로 무게감이 향상! 공기를 가르는 기동력과 공격력도 UP! 바깥 테두리에 배치된 자유회전 가드 파츠로 자세를 유지하며 방어력도 향상! ※ 디스크일체형 드라이버 ｢Al｣에는 장착할 수 없습니다." },
  { id: "DISK-WING", series: "burst", type: "disk", name: "W", en: "Wing", sub: "윙", tags: [], desc: "4개의 날개가 어퍼포스를 만들어 기동력이 높은 공격에 특화된 경량 디스크" },
  { id: "DISK-SPREAD", series: "burst", type: "disk", name: "S", en: "Spread", sub: "스프레드", tags: [], desc: "큰 지름으로 인해 원심력이 있고 유선형의 공기 저항이 적은 디스크" },
  { id: "DISK-HEAVY", series: "burst", type: "disk", name: "H", en: "Heavy", sub: "헤비", tags: [], desc: "4개의 무게추가 안정감을 만들어주며, 방어력이 높고 무게감이 있는 디스크." },
  { id: "DISK-CENTRAL", series: "burst", type: "disk", name: "C", en: "Central", sub: "센트럴", tags: [], desc: "중앙에 중심을 둠으로써 공격을 받아도 축이 쉽게 흔들리지 않는 안쪽 중심 디스크" },
  { id: "DISK-OUTER", series: "burst", type: "disk", name: "Ω", en: "Outer", sub: "아우터", tags: [], desc: "폭이 넓으며 중심을 최대한 바깥쪽으로 보내서 원심력을 최대치로 높인 스태미나계열의 디스크." },
  { id: "DISK-AERO", series: "burst", type: "disk", name: "α", en: "Aero", sub: "에어로", tags: [], desc: "가볍고 기동력이 높아 초고속 공격을 가능하게 하는 공격 특화 디스크." },
  { id: "DISK-AERO-DASH", series: "burst", type: "disk", name: "α'", en: "Aero'", sub: "에어로 대시", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 매우 얇은 모양으로 프레임을 높은 위치에 세팅할 수 있는 특수한 디스크." },
  { id: "DISK-OVAL", series: "burst", type: "disk", name: "O", en: "Oval", sub: "오벌", tags: [], desc: "밸런스에 중점을 둔 타원형의 디스크. 부풀어 있는 바깥 부분이 원심력을 만들어 강력한 일격을 가할 수 있다." },
  { id: "DISK-ARMED", series: "burst", type: "disk", name: "A", jpName: "암드", en: "Armed", sub: "아머", tags: [], desc: "바깥 면에 퍼져있는 높은 벽이 있어, 상대의 공격에 큰 영향을 받지 않는 방어력이 높은 디스크" },
  { id: "DISK-RING", series: "burst", type: "disk", name: "R", en: "Ring", sub: "링", tags: [], desc: "안쪽을 가볍게 만들고 바깥쪽에 두꺼운 링을 배치하여 외형중심의 큰 원심력을 가진 디스크" },
  { id: "DISK-FORCE", series: "burst", type: "disk", name: "F", en: "Force", sub: "포스", tags: [], desc: "사각 형태의 모서리 4곳에 중량을 집중함으로써 무게감 있는 공격이 가능한 어택계열 디스크." },
  { id: "DISK-BOOST", series: "burst", type: "disk", name: "B", en: "Boost", sub: "부스트", tags: [], desc: "6개의 날개가 강렬한 다운포스를 생성하여 스태디움에 단단하게 접지하여 드라이버의 성능을 증폭시키는 경량 디스크." },
  { id: "DISK-KNUCKLE", series: "burst", type: "disk", name: "K", en: "Knuckle", sub: "너클", tags: [], desc: "바깥쪽 6개의 팁이 균형을 잡아 공격력을 높일 수 있는 대형 디스크." },
  { id: "DISK-GRAVITY", series: "burst", type: "disk", name: "G", en: "Gravity", sub: "그래비티", tags: [], desc: "두껍고 무게가 있어 어마어마한 원심력을 만들어낼 수 있는 디스크." },
  { id: "DISK-LIMITED", series: "burst", type: "disk", name: "L", en: "Limited", sub: "리미티드", tags: [], desc: "폭이 좁고 중심이 중앙으로 모여 축이 쉽게 흔들리지 않게 한 방어에 특화된 안쪽 중심 디스크." },
  { id: "DISK-VERTICAL", series: "burst", type: "disk", name: "V", en: "Vertical", sub: "버티컬", tags: [], desc: "위아래로 긴 모양을 가지고 있어 상대의 공격을 막아내는 방어 특화 디스크." },
  { id: "DISK-UPPER", series: "burst", type: "disk", name: "U", en: "Upper", sub: "어퍼", tags: [], desc: "커다란 두 개의 뒤틀린 날개가 어퍼포스를 발생시켜 지면과의 마찰을 줄여주는 디스크." },
  { id: "DISK-TRIPLE", series: "burst", type: "disk", name: "T", en: "Triple", sub: "트리플", tags: [], desc: "세 군데의 돌출부에 무게를 편중시켜 공격력을 더욱 높여 주는 어택계열 디스크." },
  { id: "DISK-MAGNUM", series: "burst", type: "disk", name: "M", en: "Magnum", sub: "매그넘", tags: [], desc: "최대급의 크기를 가지며, 3개의 각으로 인한 공격 능력도 겸비한 이색소재의 융합형 디스크." },
  { id: "DISK-BUMPER", series: "burst", type: "disk", name: "β", en: "Bumper", sub: "범퍼", tags: [], desc: "바깥쪽에 빈 공간을 두어 중심을 안쪽으로 모으고 방어 성능을 높인 디스크." },
  { id: "DISK-DOWN", series: "burst", type: "disk", name: "D", en: "Down", sub: "다운", tags: [], desc: "무게 중심을 최대한 낮게 만들어주는 프레임 구조를 도입하여 베이의 안정성을 높인 디스크." },
  { id: "DISK-INFINITY", series: "burst", type: "disk", name: "I", en: "Infinity", sub: "인피니티", tags: [], desc: "앞면과 뒷면이 매끄럽게 이어져 있어 공기저항을 줄여주고 원심력을 발생시키는 스태미나계열 디스크." },
  { id: "DISK-JERK", series: "burst", type: "disk", name: "J", en: "Jerk", sub: "저크", tags: [], desc: "바깥쪽에 장착한 탄력 있는 플라스틱 파츠가 상대의 공격을 흡수하거나 튕겨낸다." },
  { id: "DISK-POLISH", series: "burst", type: "disk", name: "P", en: "Polish", sub: "폴리시", tags: [], desc: "쓰러졌을 때 바깥 둘레의 링 파츠가 접지하게 되어 레이어가 스태디움에 닿는 것을 막아주기 때문에 최후의 회전력을 끌어낼 수 있는 하이브리드형 디스크." },
  { id: "DISK-NINE", series: "burst", type: "disk", name: "N", en: "Nine", sub: "나인", tags: [], desc: "소용돌이와 같은 9장의 칼날이 좌회전 시에 강력한 다운포스를 발생시키는 디스크." },
  { id: "DISK-QUARTER", series: "burst", type: "disk", name: "Q", en: "Quarter", sub: "쿼터", tags: [], desc: "4개의 무게추를 가지고 있으며, 그 중 하나가 더욱 무거워서 무게중심이 한쪽에 치우친 디스크." },
  { id: "DISK-YELL", series: "burst", type: "disk", name: "Y", en: "Yell", sub: "옐", tags: [], desc: "전체의 지름이 크면서도, 테두리는 견고한 구조로 되어 있어서 원심력과 내중심성을 동시에 갖춘 방어형 디스크." },
  { id: "DISK-ZENITH", series: "burst", type: "disk", name: "Z", en: "Zenith", sub: "제니스", tags: [], desc: "디스크 주위의 고무 부품이 상대와 접촉할 때 높은 버스트력을 만들어내는 어택계열의 디스크." },
  { id: "DISK-STING", series: "burst", type: "disk", name: "St", en: "Sting", sub: "스팅", tags: [], desc: "스프링으로 움직이는 4개의 커다란 날이 튕기면서, 상대에게 강한 공격을 가하는 어택타입의 디스크." },
  { id: "DISK-BLITZ", series: "burst", type: "disk", name: "Bl", en: "Blitz", sub: "블릿츠", tags: [], desc: "높은 회전력을 낼 때, 3개의 날이 튀어나와 강력한 타격으로 상대를 공격하는 어택타입의 디스크." },
  { id: "DISK-HURRICANE", series: "burst", type: "disk", name: "Hr", en: "Hurricane", sub: "허리케인", tags: [], desc: "자유롭게 회전하는 16개의 연타 날이 모든 공격을 받아넘겨서 본체가 데미지를 받지 않는 디펜스타입의 디스크." },
  { id: "DISK-RATCHET", series: "burst", type: "disk", name: "Rt", en: "Ratchet", sub: "래칫", tags: [], desc: "바깥쪽 방어부품이 오른쪽 방향으로 자유회전하지만 왼쪽 방향으로는 고정되어 있어서, 상대의 공격을 흡수하는 디스크." },
  { id: "DISK-DRAKE", series: "burst", type: "disk", name: "Dr", en: "Drake", sub: "드레이크", tags: [], desc: "좌우 2군데로 중심이 치우친 드래곤 형태의 날로 상대에게 강력한 일격을 가하는 어택타입의 디스크." },
  { id: "DISK-VANGUARD", series: "burst", type: "disk", name: "Vn", en: "Vanguard", sub: "뱅가드", tags: [], desc: "밑으로 치우친 6개의 날로 중심을 내려 안정시키며 사선 공격을 노리는 상대를 튕겨내는 밸런스타입의 디스크." },
  { id: "DISK-AROUND", series: "burst", type: "disk", name: "Ar", en: "Around", sub: "어라운드", tags: [], desc: "4개의 메탈 볼이 지면과의 마찰을 줄이고 배틀 후반까지 끈기 있게 버티는 스태미나타입의 디스크." },
  { id: "DISK-CONVERT", series: "burst", type: "disk", name: "Cn", en: "Convert", sub: "컨버트", tags: [], desc: "주위의 가드 파츠에 의해서 중심이 잘 잡힌 노멀모드와 공격적으로 한쪽으로 치우친 편중심모드로 변경이 가능한 밸런스타입의 디스크." },
  { id: "DISK-PARADOX", series: "burst", type: "disk", name: "Pr", en: "Paradox", sub: "패러독스", tags: [], desc: "최대급 지름과 아래쪽으로 뻗은 날 덕분에 저중심이면서도 원심력이 높은 디스크. 네이키드 베이스와 조합했을 때만 뒤집어서 장착할 수 있으며, 레이어를 덮는 듯한 형태가 되어 강력한 디펜스와 카운터공격이 가능하다." },
  { id: "DISK-WHEEL", series: "burst", type: "disk", name: "Wh", en: "Wheel", sub: "휠", tags: [], desc: "최중량급의 무게와 중심이 바깥에 있는 형태로 원심력을 극한까지 높인 스태미나타입 디스크." },
  { id: "DISK-CHO", series: "burst", type: "disk", name: "超", en: "Cho", sub: "초", tags: [], desc: "초중량급이며 불균형한 무게중심이 특징인 공격적 성능의 리미트 브레이크 레이어 전용 디스크." },
  { id: "DISK-OU", series: "burst", type: "disk", name: "王", en: "Ou", sub: "왕", tags: [], desc: "무게 중심이 바깥에 있어 밸런스가 좋아 원심력이 강한 리미트 브레이크 레이어 전용 디스크." },
  { id: "DISK-KOU", series: "burst", type: "disk", name: "皇", en: "Kou", sub: "황", tags: [], desc: "중량을 극한까지 안쪽으로 끌어당겨 안정성을 높인 리미트 브레이크 레이어 전용 디스크." },
  { id: "COREDISK-0", series: "burst", type: "coredisk", name: "0", en: "0", sub: "제로", tags: [], desc: "프레임 부품 장착이 가능한 코어디스크. 초중량급의 단순한 형태로 공격력·방어력·지구력이 상승하는 초밸런스타입의 디스크." },
  { id: "COREDISK-1", series: "burst", type: "coredisk", name: "1", en: "1", sub: "원", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 무게중심이 한쪽에 치우쳐서 공격적인 움직임을 보여주는 어택계열의 디스크." },
  { id: "COREDISK-1-DASH", series: "burst", type: "coredisk", name: "1'", en: "1'", sub: "원 대시", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 1 디스크의 중량과 공격성능을 높인, 무게중심이 한쪽에 치우친 어택계열의 디스크." },
  { id: "COREDISK-2", series: "burst", type: "coredisk", name: "2", en: "2", sub: "투", tags: [], desc: "프레임 부품의 장착이 가능한 코어디스크로 내중심성을 가진 2개의 칼날이 흔들림을 잡아주는 디펜스계열 디스크." },
  { id: "COREDISK-3", series: "burst", type: "coredisk", name: "3", en: "3", sub: "쓰리", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 디스크는 크지만, 바깥쪽이 가볍기 때문에 흔들림이 적고 공격을 도와주는 디스크." },
  { id: "COREDISK-4", series: "burst", type: "coredisk", name: "4", en: "4", sub: "포", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 폭넓은 4개의 칼날이 원심력을 높여주는 스태미나계열의 디스크." },
  { id: "COREDISK-5", series: "burst", type: "coredisk", name: "5", en: "5", sub: "파이브", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 5개의 날이 어퍼포스를 만들어내는 스태미나계열의 디스크." },
  { id: "COREDISK-6", series: "burst", type: "coredisk", name: "6", en: "6", sub: "식스", tags: [], desc: "프레임 부품의 장착이 가능한 코어디스크로 6개의 칼날이 다운포스를 발생시키는 어택계열 디스크." },
  { id: "COREDISK-7", series: "burst", type: "coredisk", name: "7", en: "7", sub: "세븐", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 무게감 있는 7장의 칼날로 공격력·방어력·지구력을 모두 높이는 밸런스타입의 디스크." },
  { id: "COREDISK-8", series: "burst", type: "coredisk", name: "8", en: "8", sub: "에이트", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 안쪽을 가볍게 하고 바깥쪽에는 8개의 무게추를 배치하여, 무게중심이 바깥쪽에 있는 스태미나계열의 디스크." },
  { id: "COREDISK-8-DASH", series: "burst", type: "coredisk", name: "8'", en: "8'", sub: "에이트 대시", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 8 디스크보다 크고, 중심이 바깥쪽에 있어서 회전력이 특화된 스태미나계열의 디스크." },
  { id: "COREDISK-10", series: "burst", type: "coredisk", name: "10", en: "10", sub: "텐", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 무게중심이 안쪽에 있고 지름이 큰 10개의 날이 안정성을 만들어내는 디펜스타입의 디스크." },
  { id: "COREDISK-11", series: "burst", type: "coredisk", name: "11", en: "11", sub: "일레븐", tags: [], desc: "프레임을 장착할 수 있는 코어디스크. 폭이 넓고 중심에 밸런스가 잡힌 형태가 안정성을 높여주는 디스크." },
  { id: "COREDISK-12", series: "burst", type: "coredisk", name: "12", en: "12", sub: "트웰브", tags: [], desc: "프레임을 장착할 수 있는 코어디스크. 지름이 크고, 다운포스를 만들어내는 날을 가진 어택계열 디스크." },
  { id: "COREDISK-13", series: "burst", type: "coredisk", name: "13", en: "13", sub: "서틴", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 우회전할 때 어퍼포스를 만들어내서 스태디움과의 마찰을 줄이고, 좌회전할 때 다운포스를 만들어내서 스태디움에 강력하게 밀착하는 디스크." },
  { id: "COREDISK-00", series: "burst", type: "coredisk", name: "00", en: "00", sub: "더블오", tags: [], desc: "프레임 부품을 장착할 수 있는 코어디스크. 최고 중량으로 모든 능력을 끌어올리는 밸런스타입의 디스크." },
  { id: "FRAME-VORTEX", series: "burst", type: "frame", name: "V", en: "Vortex", sub: "볼텍스", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 우회전에 특화된 3개의 칼날이 지구력을 향상시킨다." },
  { id: "FRAME-GLAIVE", series: "burst", type: "frame", name: "G", en: "Glaive", sub: "글레이브", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 커다란 창 모양의 칼날 2개가 버스트력을 높여준다!" },
  { id: "FRAME-CROSS", series: "burst", type: "frame", name: "C", en: "Cross", sub: "크로스", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 우회전과 좌회전 모두 대응하는 4개의 날이 연타와 방어 성능을 높여준다!" },
  { id: "FRAME-STAR", series: "burst", type: "frame", name: "S", en: "Star", sub: "스타", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 좌우회전 모두 대응하는 5개의 연타형 칼날이 공격 및 방어 성능을 높여준다!" },
  { id: "FRAME-METEOR", series: "burst", type: "frame", name: "M", en: "Meteor", sub: "메테오", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 우회전에 특화된 5개의 연타형 칼날로 공격력 및 방어력을 높여준다!" },
  { id: "FRAME-FLOW", series: "burst", type: "frame", name: "F", en: "Flow", sub: "플로", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 어퍼포스를 만들어 내는 12개의 날이 공기의 힘을 사용하는 성능을 높여준다!" },
  { id: "FRAME-BUMP", series: "burst", type: "frame", name: "B", en: "Bump", sub: "범프", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 방어에 특화된 16개의 연타형 칼날이 방어 성능을 높여준다!" },
  { id: "FRAME-UNDER", series: "burst", type: "frame", name: "U", en: "Under", sub: "언더", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 바깥쪽 칼날이 아래로 늘어나서 구부러진 형태. 베이가 기울어졌을 때나 아래쪽에서 상대의 공격을 받았을 때, 강력한 공격을 줄 수 있다!" },
  { id: "FRAME-HIT", series: "burst", type: "frame", name: "H", en: "Hit", sub: "히트", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 프레임에 돌출부가 한 군데 있으며, 이 부분으로 강력한 공격을 가한다!" },
  { id: "FRAME-REACH", series: "burst", type: "frame", name: "R", en: "Reach", sub: "리치", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 좌우로 높이가 다른 날이 넓은 공격범위를 커버한다!" },
  { id: "FRAME-LIFT", series: "burst", type: "frame", name: "L", en: "Lift", sub: "리프트", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 위아래를 뒤집어 끼울 수 있는 프레임으로, 공격 방향을 바꿀 수 있다!!" },
  { id: "FRAME-DAGGER", series: "burst", type: "frame", name: "D", en: "Dagger", sub: "대거", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 커다란 2개의 검 끝으로 상대를 버스트하는 어택계열의 프레임." },
  { id: "FRAME-PROOF", series: "burst", type: "frame", name: "P", en: "Proof", sub: "프루프", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 매끈하고 둥근 형태가 레이어와 스태디움의 접촉을 막아준다." },
  { id: "FRAME-ANGLE", series: "burst", type: "frame", name: "α", en: "Angle", sub: "앵글", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 큰 날 3개가 위쪽으로 뻗어 있어, 기존에는 없던 각도에서 강력한 공격이 가능한 어택계열의 프레임." },
  { id: "FRAME-TURN", series: "burst", type: "frame", name: "T", en: "Turn", sub: "턴", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 위아래로 뒤집어서 날의 방향을 바꿀 수 있다." },
  { id: "FRAME-WALL", series: "burst", type: "frame", name: "W", en: "Wall", sub: "월", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 두껍고 무거운 형태로 전체적인 능력치를 끌어올리는 밸런스계열의 프레임." },
  { id: "FRAME-EXPAND", series: "burst", type: "frame", name: "E", en: "Expand", sub: "익스팬드", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 어퍼포스를 만들어내는 4개의 큰 날로 공격 성능을 높인다!!" },
  { id: "FRAME-X", series: "burst", type: "frame", name: "A", en: "X", sub: "엑스", tags: [], desc: "코어디스크에 장착할 수 있는 공격력 강화 부품. 3장의 초대형 타격날이 버스트력을 높인다!" },
  { id: "DBDISK-NEXUS", series: "burst", type: "dbdisk", name: "Nx", en: "Nexus", sub: "넥서스", tags: [], desc: "로우모드에 사용되는 DB디스크. 상하로 나뉘어진 8개의 날개로 공기를 가르는 듯 기동력을 높이는 디스크." },
  { id: "DBDISK-GIGA", series: "burst", type: "dbdisk", name: "Gg", en: "Giga", sub: "기가", tags: [], desc: "로우모드로 조합 가능한 DB디스크. 울퉁불퉁한 두꺼운 축 형태로 되어 있어 낮은 중심과 원심력을 모두 갖춘 디스크." },
  { id: "DBDISK-TAPERED", series: "burst", type: "dbdisk", name: "Tp", en: "Tapered", sub: "테이퍼드", tags: [], desc: "로우모드 대응 DB디스크. 아래로 점점 넓어지며 매끄럽게 꺾여가는 테두리 모양으로 부드럽게 자세를 지지해주는 스태미나타입 디스크." },
  { id: "DBDISK-OVER", series: "burst", type: "dbdisk", name: "Ov", en: "Over", sub: "오버", tags: [], desc: "로우모드로 조합 가능한 DB디스크. 중량급 및 심플한 원형 모양으로 공격·방어·지구력을 극대화한 디스크." },
  { id: "DBDISK-KARMA", series: "burst", type: "dbdisk", name: "Kr", en: "Karma", sub: "카르마", tags: [], desc: "로우모드 대응 DB디스크. 위쪽을 향하는 10개의 날이 좌회전시 다운포스를 만들어 내 기동력을 높이는 디스크." },
  { id: "DBDISK-LEGACY", series: "burst", type: "dbdisk", name: "Lg", en: "Legacy", sub: "레거시", tags: [], desc: "로우모드로 조합 가능한 DB디스크. 6장의 대형 날이 우회전 시 다운포스를 만들어내며 기동력을 높이는 디스크." },
  { id: "DBDISK-CIQUEX", series: "burst", type: "dbdisk", name: "Cq", en: "Ciquex", sub: "시퀙스", tags: [], desc: "6개의 날이 다운포스를 만들어내 기동력을 높이는 어택타입 디스크." },
  { id: "DBDISK-FORTRESS", series: "burst", type: "dbdisk", name: "Fr", en: "Fortress", sub: "포트리스", tags: [], desc: "로우모드 대응 DB디스크. 중심이 안쪽에 모이도록 외곽을 덜어내 축이 흔들리기 어렵고 방어력이 높은 디스크." },
  { id: "DBDISK-XANTHUS", series: "burst", type: "dbdisk", name: "Xn", en: "Xanthus", sub: "잔저스", tags: [], desc: "로우모드에 사용되는 DB디스크. 한쪽에만 검 끝이 나와 있어 상대에게 큰 타격을 주는 BU락 기능을 가진 디스크." },
  { id: "DBDISK-ILLEGAL", series: "burst", type: "dbdisk", name: "Il", en: "Illegal", sub: "일리걸", tags: [], desc: "로우모드 대응 DB디스크. 원형 및 바깥 중심으로 베이의 회전력 향상을 극대화하는 디스크." },
  { id: "DBDISK-MOON", series: "burst", type: "dbdisk", name: "Mn", en: "Moon", sub: "문", tags: [], desc: "로우모드 대응 DB디스크. 완전한 원형에 가까운 형상으로 공기 저항을 극한까지 줄인 BU락 기능을 가진 디스크." },
  { id: "DBDISK-SPREAD-DASH", series: "burst", type: "dbdisk", name: "S'", en: "Spread'", sub: "스프레드 대시", tags: [], desc: "로우모드에 사용되는 DB디스크. 원형에 의한 원심력이 있으며 유선형으로 공기 저항이 적은 디스크." },
  { id: "DBDISK-WING-DASH", series: "burst", type: "dbdisk", name: "W'", en: "Wing'", sub: "윙 대시", tags: [], desc: "로우모드에 사용되는 DB디스크. 4개의 날이 어퍼포스를 만들어내며 베이의 기동력을 높이는 디스크." },
  { id: "DRIVER-ACCEL", series: "burst", type: "driver", name: "A", en: "Accel", sub: "액셀", battleType: "attack", tags: [], desc: "평평한 끝부분으로 기동력이 있고 고속의 원형 회전으로 스태디움에서 활약하여 상대에게 강력한 공격을 하는 드라이버" },
  { id: "DRIVER-FUSION", series: "burst", type: "driver", name: "F", en: "Fusion", sub: "퓨전", battleType: "balance", tags: [], desc: "납작한 축 앞 끝에 돌기가 있는 형상으로 공격적인 움직임에서 지구력 있는 움직임으로 변화하는 밸런스계열 드라이버" },
  { id: "DRIVER-SURVIVE", series: "burst", type: "driver", name: "S", en: "Survive", sub: "서바이브", battleType: "stamina", tags: [], desc: "끝부분이 뾰족한 형상을 하고 있기 때문에 베이스타디움과의 마찰을 줄여 지구력이 높은 드라이버" },
  { id: "DRIVER-DEFENSE", series: "burst", type: "driver", name: "D", en: "Defense", sub: "디펜스", battleType: "defense", tags: [], desc: "끝부분이 원형으로 접촉면이 많고 중량감 있는 큰 링으로 방어력이 높은 드라이버" },
  ...
  { id: "DRIVER-MASSIVE", series: "burst", type: "driver", name: "M", en: "Massive", sub: "매시브", battleType: "defense", tags: [], desc: "큰 반구의 끝부분과 바깥쪽의 발톱으로 스태디움에 달라붙어 버티는 디펜스계열의 드라이버" },
  { id: "DRIVER-CLAW", series: "burst", type: "driver", name: "C", en: "Claw", sub: "클로", battleType: "stamina", tags: [], desc: "회전에 맞추어 날이 자동으로 펼쳐져 원심력이 강화되는 스태미나계열 드라이버." },
  { id: "DRIVER-BLOW", series: "burst", type: "driver", name: "B", en: "Blow", sub: "블로", battleType: "attack", tags: [], desc: "베이스타디움 안을 작은 원을 그리며 돌아다녀 중앙에 있는 상대에게 강력한 공격을 가하는 드라이버" },
  { id: "DRIVER-EDGE", series: "burst", type: "driver", name: "E", en: "Edge", sub: "엣지", battleType: "stamina", tags: [], desc: "2장의 판이 교차하는 형상으로 바닥에 닿는 면적이 좁고 경량화함으로써 원심력을 만들기 쉬운 스태미나계열 드라이버" },
  { id: "DRIVER-QUAKE", series: "burst", type: "driver", name: "Q", en: "Quake", sub: "퀘이크", battleType: "attack", tags: [], desc: "축의 위치가 중심에서 어긋나 있어서, 스태디움 안을 날뛰며 돌아다니는 움직임을 보여주는 어택계열 드라이버." },
  { id: "DRIVER-XTREME", series: "burst", type: "driver", name: "X", en: "Xtreme", sub: "익스트림", battleType: "attack", tags: [], desc: "끝 부분의 러버가 강력한 그립력을 발휘하여, 엄청난 기세로 스태디움을 활주하는 어택계열의 드라이버." },
  { id: "DRIVER-NEEDLE", series: "burst", type: "driver", name: "N", en: "Needle", sub: "니들", battleType: "defense", tags: [], desc: "슈팅하는 각도에 따라 움직임을 바꿀 수 있는 고무축을 장착하고 있기 때문에 스태디움에 강력하게 밀착하여 고속 공격을 펼치는 어택계열 드라이버." },
  { id: "DRIVER-ZEPHYR", series: "burst", type: "driver", name: "Z", en: "Zephyr", sub: "제퍼", battleType: "balance", tags: [], desc: "드라이버 축 끝부분에 구멍이 있어서 지면과 접촉할 때 마찰을 줄여준다. 기동력과 지구력을 모두 갖춘 밸런스계열의 드라이버." },
  { id: "DRIVER-GYRO", series: "burst", type: "driver", name: "G", en: "Gyro", sub: "자이로", battleType: "stamina", tags: [], desc: "축의 끝이 자유롭게 회전하여 지면과의 마찰을 덜어주어 오랫동안 회전할 수 있는 드라이버." },
  { id: "DRIVER-VARIABLE", series: "burst", type: "driver", name: "V", en: "Variable", sub: "배리어블", battleType: "attack", tags: [], desc: "슈팅하는 각도에 따라 움직임을 바꿀 수 있는 고무축을 장착하고 있기 때문에 스태디움에 강력하게 밀착하여 고속 공격을 펼치는 어택계열 드라이버." },
  { id: "DRIVER-UNITE", series: "burst", type: "driver", name: "U", en: "Unite", sub: "유나이트", battleType: "balance", tags: [], desc: "축 끝의 뾰족한 부분을 고무 재질로 감싼 형태를 하고 있어, 공격적이고 격렬한 움직임과 수비적으로 안정된 움직임을 자유자재로 구사할 수 있는 밸런스계열 드라이버." },
  { id: "DRIVER-REVOLVE", series: "burst", type: "driver", name: "R", en: "Revolve", sub: "리볼브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝부분 주위에 자유롭게 회전하는 방어 부품이 있어서 배틀 후반까지 회전력을 유지할 수 있는 스태미나계열 드라이버." },
  { id: "DRIVER-PRESS", series: "burst", type: "driver", name: "P", en: "Press", sub: "프레스", battleType: "defense", tags: [], desc: "본체 주변에 뻗어있는 돌기에 의한 중량이 상승되고, 반구형상의 축의 끝부분이 스태디움에 밀착되어 날려버리기 어려운 디펜스계열 드라이버." },
  { id: "DRIVER-ORBIT", series: "burst", type: "driver", name: "O", en: "Orbit", sub: "오르빗", battleType: "defense", tags: [], desc: "축 앞에 장착된 소형 볼이 회전하면서, 어떤 방향에서의 공격도 피할 수 있는 디펜스계열 드라이버." },
  { id: "DRIVER-JAGGY", series: "burst", type: "driver", name: "J", en: "Jaggy", sub: "재기", battleType: "attack", tags: [], desc: "톱니 모양의 스파이크가 장착된 축 끝이 지면을 치면서 높은 기동력을 발생시키는 어택계열 드라이버." },
  { id: "DRIVER-OCTA", series: "burst", type: "driver", name: "Ω", en: "Octa", sub: "옥타", battleType: "stamina", tags: [], desc: "뾰족한 축 끝부분을 팔각형의 메탈 파츠가 둘러싸고 있으며, 높은 원심력을 만들어내는 스태미나타입의 드라이버." },
  { id: "DRIVER-BITE", series: "burst", type: "driver", name: "β", en: "Bite", sub: "바이트", battleType: "defense", tags: [], desc: "반구형 러버 축으로 스태디움에 밀착해 공격을 받아도 날아가기 어려운 방어 특화 디펜스계열 드라이버." },
  { id: "DRIVER-IMPACT", series: "burst", type: "driver", name: "I", en: "Impact", sub: "임팩트", battleType: "attack", tags: [], desc: "2종류의 소재로 조합된 울퉁불퉁한 축으로 인해 장시간의 공격이 가능한 어택계열 드라이버." },
  { id: "DRIVER-YIELDING", series: "burst", type: "driver", name: "Y", en: "Yielding", sub: "일딩", battleType: "stamina", tags: [], desc: "드라이버 끝부분이 마찰저항을 줄여주는 특별한 소재인 POM으로 제작된 스태미나계열 드라이버." },
  { id: "DRIVER-TRANS", series: "burst", type: "driver", name: "T", en: "Trans", sub: "트랜스", battleType: "balance", tags: [], desc: "스태디움 안을 휘젓고 다니는 어택모드와 가운데서 오래 회전할 수 있는 스태미나모드로 전환할 수 있는 밸런스계열의 변형 드라이버." },
  { id: "DRIVER-WEIGHT", series: "burst", type: "driver", name: "W", en: "Weight", sub: "웨이트", battleType: "stamina", tags: [], desc: "메탈 소재의 축을 사용함으로써, 쉽게 흔들리지 않는 중량감을 갖추는 동시에 마찰 저항까지 줄어들어 회전력을 오랫동안 유지할 수 있는 스태미나계열 드라이버." },
  { id: "DRIVER-HOLD", series: "burst", type: "driver", name: "H", en: "Hold", sub: "홀드", battleType: "attack", tags: [], desc: "커다란 원반형의 축 끝부분이 자유롭게 회전하기 때문에 배틀 후반부에도 속도를 높여 스태디움 안에서 달릴 수 있도록 해주는 어택계열 드라이버." },
  { id: "DRIVER-LINER", series: "burst", type: "driver", name: "L", en: "Liner", sub: "라이너", battleType: "balance", tags: [], desc: "축 끝에 내장된 바퀴 모양의 파츠가 회전하여, 공격을 받았을 때의 각도에 따라 움직임을 변화시키는 밸런스계열 드라이버." },
  { id: "DRIVER-SPIRAL", series: "burst", type: "driver", name: "Sp", en: "Spiral", sub: "스파이럴", battleType: "attack", tags: [], desc: "드라이버 축 끝부분에 소용돌이 모양의 돌출부가 있으며, 좌회전 시 스태디움에 강하게 달라붙어서 굉음을 내며 날뛰는 어택계열의 드라이버." },
  { id: "DRIVER-CYCLE", series: "burst", type: "driver", name: "Cy", en: "Cycle", sub: "사이클", battleType: "stamina", tags: [], desc: "자유회전하는 대형 날 2개가 달려있어서, 원심력을 강화하고 오랫동안 회전하는 스태미나계열 드라이버." },
  { id: "DRIVER-REBOOT", series: "burst", type: "driver", name: "Rb", en: "Reboot", sub: "리부트", battleType: "attack", tags: [], desc: "원심력에 의해 축 끝의 형태가 변하면서 배틀 후반에 재가속하는 기믹을 장착한 어택계열 드라이버." },
  { id: "DRIVER-LOOP", series: "burst", type: "driver", name: "Lp", en: "Loop", sub: "루프", battleType: "defense", tags: [], desc: "상대 베이에게 부딪혀서 밀려날 때, 2개의 롤러가 스태디움에 닿아 오버 피니시를 막아주는 디펜스계열 드라이버." },
  { id: "DRIVER-FLUGEL", series: "burst", type: "driver", name: "Fl", en: "Flugel", sub: "플뤼겔", battleType: "stamina", tags: [], desc: "우회전 시 어퍼포스를 만들어 내는 4개의 칼날이 지구력을 강화하는 스태미나계열 드라이버." },
  { id: "DRIVER-NOTHING", series: "burst", type: "driver", name: "Nt", en: "Nothing", sub: "너싱", battleType: "stamina", tags: [], desc: "축 끝의 스프링이 착지할 때 충격과 회전 시 상·하의 흔들림을 흡수하여 상대를 무력화시키는 스태미나계열의 드라이버." },
  { id: "DRIVER-ATOMIC", series: "burst", type: "driver", name: "At", en: "Atomic", sub: "아토믹", battleType: "defense", tags: [], desc: "360도 자유롭게 회전하는 대형 볼이 방어력을 높여주고, 바깥쪽 링의 회전력으로 인해 잘 쓰러지지 않는 디펜스계열의 드라이버." },
  { id: "DRIVER-HUNTER", series: "burst", type: "driver", name: "Hn", en: "Hunter", sub: "헌터", battleType: "attack", tags: [], desc: "축 끝부분이 얇은 고무 재질이며, 지면에 안정적으로 밀착한 상태에서 중앙에 위치한 상대를 빠르게 공격할 수 있는 어택계열의 드라이버." },
  { id: "DRIVER-MERGE", series: "burst", type: "driver", name: "Mr", en: "Merge", sub: "머지", battleType: "balance", tags: [], desc: "톱니면의 고무로 뒤덮인 뾰족한 축 끝부분에 따라, 슈팅 위치 또는 각도에 맞춰서 공격적인 움직임 또는 안정적인 움직임을 구사할 수 있는 밸런스계열 드라이버." },
  { id: "DRIVER-GUARD", series: "burst", type: "driver", name: "Gr", en: "Guard", sub: "가드", battleType: "defense", tags: [], desc: "축 끝부분을 둘러싸고 있는 부품이, 기울기에 따라 위아래로 움직여서 받쳐주는 디펜스계열 드라이버." },
  { id: "DRIVER-PLANET", series: "burst", type: "driver", name: "Pl", en: "Planet", sub: "플래닛", battleType: "stamina", tags: [], desc: "바깥쪽의 메탈 볼이 원심력을 높여주고 축 끝부분의 메탈 볼이 자유롭게 회전하면서 지면과의 마찰을 줄이는 스태미나계열 드라이버." },
  { id: "DRIVER-IRON", series: "burst", type: "driver", name: "Ir", en: "Iron", sub: "아이언", battleType: "attack", tags: [], desc: "축 끝부분이 평평한 금속 재질이며, 묵직하지만 격렬한 움직임을 보여주는 어택계열 드라이버." },
  { id: "DRIVER-TOWER", series: "burst", type: "driver", name: "Tw", en: "Tower", sub: "타워", battleType: "balance", tags: [], desc: "원심력을 따라서 축 끝부분의 모양이 자동으로 바뀐다. 베이의 전체 높이가 처음에는 낮다가 배틀이 진행되면서 높아지는 밸런스계열의 드라이버." },
  { id: "DRIVER-DESTROY", series: "burst", type: "driver", name: "Ds", en: "Destroy", sub: "디스트로이", battleType: "attack", tags: [], desc: "톱니 모양의 축 끝부분이 스태디움에 달라붙은 채로 버텨서, 가드 부품이 달려있는 다른 드라이버 못지 않게 방어력이 높다. 게다가 공격 성능도 높기 때문에 계속해서 날뛸 수 있는 어택계열의 드라이버." },
  { id: "DRIVER-ZETA", series: "burst", type: "driver", name: "Zt", en: "Zeta", sub: "제타", battleType: "balance", tags: [], desc: "축 끝부분을 변형해서, ｢격렬하게 날뛰는 공격모드｣, ｢쓰러뜨리기 어렵게 움직이는 방어모드｣, ｢중앙에서 버티는 스태미나모드｣. 모두 3가지의 움직임을 고를 수 있는 밸런스계열의 드라이버." },
  { id: "DRIVER-BEARING", series: "burst", type: "driver", name: "Br", en: "Bearing", sub: "베어링", battleType: "stamina", tags: [], desc: "매끄러운 회전을 만들어내는 정밀 부품 베어링이 들어있고, 축 끝은 마찰이 적은 특수소재 POM으로 만들어서 최장시간의 회전력 유지를 구현해낸 스태미나 특화형 드라이버." },
  { id: "DRIVER-ULTIMATE-REBOOT", series: "burst", type: "driver", name: "Ul", en: "Ultimate Reboot", sub: "얼티메이트 리부트", battleType: "attack", tags: [], desc: "원심력에 의해서 축 끝부분이 변형하고, 배틀 후반에는 고무의 탄성을 이용해서 초고속으로 재가속하는 어택계열의 드라이버." },
  { id: "DRIVER-MUGEN", series: "burst", type: "driver", name: "∞", en: "Mugen", sub: "무한", tags: [], desc: "초Z 무적 베이스타디움 전용의 우회전 특수 드라이버. 디스크와 일체화된 구조이며 축 끝부분에 자석이 있어서 스태디움의 전동 파츠에서 멈추지 않고 고속 회전한다. 무한 드라이버는 우회전 레이어 전용 부품입니다." },
  { id: "DRIVER-MUGEN-L", series: "burst", type: "driver", name: "∞L", en: "Mugen L", sub: "무한 L", tags: [], desc: "초Z 무적 베이스타디움 전용의 좌회전 특수 드라이버. 디스크와 일체화된 구조이며 축 끝부분에 자석이 있어서 스태디움의 전동 파츠에서 멈추지 않고 고속 회전한다. 무한 L 드라이버는 좌회전 레이어 전용 부품입니다." },
  { id: "DRIVER-WEDGE", series: "burst", type: "driver", name: "Wd", en: "Wedge", sub: "웻지", battleType: "stamina", tags: [], desc: "뾰족한 메탈 축으로 인해 중심축이 흔들리지 않는 안정적인 스태미나계열의 드라이버." },
  { id: "DRIVER-XTEND", series: "burst", type: "driver", name: "Xt", en: "Xtend", sub: "익스텐드", battleType: "balance", tags: [], desc: "상대에 맞춰서 높이를 2단계로 바꿀 수 있으며, 공격과 지구력을 겸비한 축 끝을 가진 밸런스계열의 변형 드라이버." },
  { id: "DRIVER-VOLCANIC", series: "burst", type: "driver", name: "Vl", en: "Volcanic", sub: "볼카닉", battleType: "attack", tags: [], desc: "드라이버의 높이가 높아서 위쪽에서 공격을 할 수 있고, 평평한 축 끝이 회전하면서 격렬하고 불규칙적으로 날뛸 수 있는 어택계열의 드라이버." },
  { id: "DRIVER-YARD", series: "burst", type: "driver", name: "Yr", en: "Yard", sub: "야드", battleType: "defense", tags: [], desc: "원심력을 만들어내는 큰 링으로 감싼 반구 모양의 축 끝과, 낮은 높이가 안정성을 만들어서 방어를 확고하게 굳힌 디펜스계열의 드라이버." },
  { id: "DRIVER-JOLT", series: "burst", type: "driver", name: "Jl", en: "Jolt", sub: "졸트", battleType: "attack", tags: [], desc: "좌회전할 때 스태디움에 파고드는 방향으로 꼬인 모양의 고무 축과 전체 높이가 낮아서 상대를 집어 올리듯이 폭주하는 어택계열의 드라이버." },
  { id: "DRIVER-OPERATE", series: "burst", type: "driver", name: "Op", en: "Operate", sub: "오퍼레이트", battleType: "balance", tags: [], desc: "볼 형태의 축으로 인해 쉽게 쓰러지지 않는 디펜스모드와 축을 바깥쪽으로 밀어내면 불규칙한 궤도로 공격할 수 있는 어택모드로 변형할 수 있는 밸런스계열의 드라이버." },
  { id: "DRIVER-ETERNAL", series: "burst", type: "driver", name: "Et", en: "Eternal", sub: "이터널", battleType: "stamina", tags: [], desc: "축 끝이 뾰족해서 스태디움과의 마찰이 극한까지 줄어들고, 미끄러지기 쉬운 POM 소재의 방어 부품으로 배틀 후반에도 끈질기게 버티면서 회전하는 스태미나계열 드라이버." },
  { id: "DRIVER-FRICTION", series: "burst", type: "driver", name: "Fr", en: "Friction", sub: "프릭션", battleType: "defense", tags: [], desc: "특수소재 POM의 축 끝이 부드럽게 회전하고 축 끝 주위에 있는 커다란 고무 파츠가 마찰에 저항해서 오버 피니시를 막아내는 디펜스계열의 드라이버." },
  { id: "DRIVER-SWORD", series: "burst", type: "driver", name: "Sw", en: "Sword", sub: "소드", battleType: "attack", tags: [], desc: "옆부분의 메탈 파츠로 무게가 늘어서 지면에 밀착할 수 있으며, 높은 메탈 축으로 위쪽에서 공격할 수 있는 어택계열의 드라이버." },
  { id: "DRIVER-ABSORB", series: "burst", type: "driver", name: "Ab", en: "Absorb", sub: "업소브", battleType: "stamina", tags: [], desc: "축 끝이 뾰족하고 자유회전하는 방어 부품이 있어서 스태미나를 보존하면서 상하의 흔들림을 스프링으로 흡수한다. 게다가 축 끝이 줄어들었을 때에만 고속 이동해서 공격을 피하는 스태미나계열의 드라이버." },
  { id: "DRIVER-ANCHOR", series: "burst", type: "driver", name: "αn", en: "Anchor", sub: "앵커", battleType: "attack", tags: [], desc: "평평한 축 끝으로 스태디움을 달리다가 둘레의 톱니형 러버가 닿으면 초고속으로 폭주하는 2단계 공격이 가능한 어택타입 드라이버." },
  { id: "DRIVER-EVOLUTION", series: "burst", type: "driver", name: "Ev", en: "Evolution", sub: "에볼루션", battleType: "attack", tags: [], desc: "사용할수록 축 끝이 닳아서 움직임이 변화하는 특성을 가지고 있다. 높이가 높아서 축 끝이 닳아도 높이를 유지할 수 있는 어택계열의 드라이버." },
  { id: "DRIVER-QUEST", series: "burst", type: "driver", name: "Qs", en: "Quest", sub: "퀘스트", battleType: "defense", tags: [], desc: "축 끝의 빨판이 자유롭게 회전하여 스태디움에 밀착해서 날아가지 않고 끝까지 방어하는 디펜스계열의 드라이버. 사용할수록 빨판이 조금씩 닳을 수 있으며, 축 끝의 중심이 지면에 닿으면서 드라이버의 방어 성능이 바뀔 수 있습니다." },
  { id: "DRIVER-DIMENSION", series: "burst", type: "driver", name: "Dm", en: "Dimension", sub: "디멘션", battleType: "balance", tags: [], desc: "축 끝을 비틀어 모든 높이로 바꿀 수 있고, 축 끝의 고무가 나왔다 들어가며 공격적인 움직임과 방어적인 움직임으로 변하는 밸런스계열 드라이버." },
  { id: "DRIVER-CHARGE", series: "burst", type: "driver", name: "Ch", en: "Charge", sub: "차지", battleType: "attack", tags: [], desc: "평평한 축 끝으로 스태디움을 고속으로 움직이고, 금속의 무게로 상대에게 강한 충격을 가하는 어택타입의 드라이버." },
  { id: "DRIVER-KEEP", series: "burst", type: "driver", name: "Kp", en: "Keep", sub: "킵", battleType: "defense", tags: [], desc: "반구형의 고무 축 끝에 의해 쉽게 쓰러지거나 튕겨나가지 않으며, 게다가 축 끝이 자유회전해서 끝까지 공격을 막아내는 디펜스타입의 드라이버." },
  { id: "DRIVER-POWER", series: "burst", type: "driver", name: "Pw", en: "Power", sub: "파워", battleType: "attack", tags: [], desc: "톱니 모양의 평평한 축으로 스타디움에 밀착한 상태로 날뛰며 공격할 때나 축 끝이 줄어들었을 때 잠금이 단단해지는 어택타입의 드라이버." },
  { id: "DRIVER-RISE", series: "burst", type: "driver", name: "Rs", en: "Rise", sub: "라이즈", battleType: "stamina", tags: [], desc: "뾰족한 축 끝 주변에서 받쳐주는 매끄러운 부품으로 지구력을 유지하며 균형이 무너지지 않고 계속 회전하는 스태미나타입의 드라이버." },
  { id: "DRIVER-TRICK", series: "burst", type: "driver", name: "Tr", en: "Trick", sub: "트릭", battleType: "balance", tags: [], desc: "슈팅할 때 또는 공격할 때마다 주변의 커다란 가드 부품이 회전하면서 축 끝의 형태가 변화하고 계속해서 움직임이 바뀌는 밸런스타입의 드라이버." },
  { id: "DRIVER-BULLET", series: "burst", type: "driver", name: "Bl", en: "Bullet", sub: "불릿", battleType: "balance", tags: [], desc: "배틀 중에 축 끝으로부터 불릿이 분리되어 상대를 공격하고 본체는 스태디움 중앙부근에서 기다렸다가 역공을 노리는 밸런스타입의 드라이버." },
  { id: "DRIVER-LOW", series: "burst", type: "driver", name: "Lw", en: "Low", sub: "로우", battleType: "stamina", tags: [], desc: "높이가 낮고 축 주위의 프리 회전 가드가 메탈 소재로 초저중심으로 안정된 스태미나타입의 드라이버." },
  { id: "DRIVER-ORBIT-METAL", series: "burst", type: "driver", name: "Om", en: "Orbit Metal", sub: "오르빗 메탈", battleType: "defense", tags: [], desc: "축 끝 부분에 달린 소형 볼이 회전하면서, 어느 방향에서도 상대의 공격을 받아 넘기는 디펜스타입의 드라이버." },
  { id: "DRIVER-XTEND-PLUS", series: "burst", type: "driver", name: "Xt+", en: "Xtend+", sub: "익스텐드 플러스", battleType: "balance", tags: [], desc: "상대방에 맞추어 축 끝을 공격·방어·지구력의 3가지 타입으로 변경이 가능한 밸런스타입의 드라이버." },
  { id: "DRIVER-GENERATE", series: "burst", type: "driver", name: "Gn", en: "Generate", sub: "제네레이트", battleType: "balance", tags: [], desc: "슛을 한 뒤 원심력에 의해 변형될 때 배틀 전반에는 잠금이 단단하게 되어 스태디움에서 초 공격모드로 폭주한다. 배틀 후반에는 튀어나온 축 끝부분과 내부 중심으로 방어력이 업되는 밸런스타입의 드라이버." },
  { id: "DRIVER-YARD-METAL", series: "burst", type: "driver", name: "Ym", en: "Yard Metal", sub: "야드 메탈", battleType: "defense", tags: [], desc: "바깥을 감싸는 대형 링 부품으로 쉽게 쓰러지지 않고 원심력을 강화시킨다. 축 끝에는 소형 메탈 볼이 장착되어 있어 공격을 잘 받아 넘기는 디펜스타입의 드라이버." },
  { id: "DRIVER-XCEED", series: "burst", type: "driver", name: "Xc", en: "Xceed", sub: "익시드", battleType: "attack", tags: [], desc: "러버 축 끝으로 스태디움을 종횡무진 달리면서도 가장자리의 자유회전 가드 파츠로 자세를 유지하는 어택타입의 드라이버." },
  { id: "DRIVER-ZONE", series: "burst", type: "driver", name: "Zn", en: "Zone", sub: "존", battleType: "balance", tags: [], desc: "돌출된 축 끝으로 스태디움과의 마찰을 극한으로 줄이고, 자유회전 가드 파츠로 속도를 빠르게 올릴 수 있는 밸런스타입의 드라이버." },
  { id: "DRIVER-UNIVERSE", series: "burst", type: "driver", name: "Un", en: "Universe", sub: "유니버스", battleType: "defense", tags: [], desc: "대형 반구와 바깥쪽 고리가 각각 자유회전해, 상대의 공격을 받아흘리면서도 쉽게 쓰러지지 않는 디펜스타입 드라이버." },
  { id: "DRIVER-MOBIUS", series: "burst", type: "driver", name: "Mb", en: "Mobius", sub: "뫼비우스", battleType: "defense", tags: [], desc: "마찰이 적은 소재 POM의 축 끝이 자유회전을 하면서 쉽게 쓰러지지 않아 자세를 유지하고 공격을 잘 받아넘기는 디펜스타입의 드라이버." },
  { id: "DRIVER-CHARGE-METAL", series: "burst", type: "driver", name: "Cm", en: "Charge Metal", sub: "차지 메탈", battleType: "attack", tags: [], desc: "테두리의 무게추부터 축 끝까지 모두 메탈로 만든 평평한 축으로 공격력과 기동력이 높은 초중량급 어택타입 드라이버." },
  { id: "DRIVER-WAVE", series: "burst", type: "driver", name: "Wv", en: "Wave", sub: "웨이브", battleType: "balance", tags: [], desc: "중심부에서 물결치듯 이어지는 고리 형상이 지구·가속·지지에 각각 효과를 발휘하는, 높이가 높은 밸런스타입 드라이버." },
  { id: "DRIVER-DRIFT", series: "burst", type: "driver", name: "Dr", en: "Drift", sub: "드리프트", battleType: "defense", tags: [], desc: "원심력을 살린 대형 가드 파츠로 둘러싸인 자유회전 축과 전체 높이가 낮아져 한층 안정된 중심 밸런스로 방어력을 높인 디펜스타입 드라이버." },
  { id: "DRIVER-JUST", series: "burst", type: "driver", name: "Js", en: "Just", sub: "저스트", battleType: "defense", tags: [], desc: "뾰족하고 가는 축 끝으로 재빠르게 스태디움의 센터를 선점하며 배틀 후반에는 바깥쪽의 링이 자유회전하여 끝까지 버티는 디펜스타입의 드라이버." },
  { id: "DRIVER-QUICK", series: "burst", type: "driver", name: "Q", en: "Quick", sub: "퀵", battleType: "attack", tags: [], desc: "조금 가늘게 설계된 평평한 러버 축으로 스태디움 전체를 고속으로 질주하는 기동력 높은 어택타입 드라이버." },
  { id: "DRIVER-VENTURE", series: "burst", type: "driver", name: "Vn", en: "Venture", sub: "벤처", battleType: "attack", tags: [], desc: "평평한 축 끝과 거친 돌기로 폭주하다가 축 끝 주위의 러버가 스태디움의 릿지에 닿으면 초가속하는 드라이버." },
  { id: "DRIVER-NEVER", series: "burst", type: "driver", name: "Nv", en: "Never", sub: "네버", battleType: "stamina", tags: [], desc: "자유회전하는 뾰족한 축 끝과 특수소재 POM으로 된 주변부에 의해 매끄러운 움직임을 만들어 마찰을 낮춘 강력한 회전으로 끝까지 버텨내는 스태미나타입의 드라이버." },
  { id: "DRIVER-KICK", series: "burst", type: "driver", name: "Kc", en: "Kick", sub: "킥", battleType: "stamina", tags: [], desc: "스프링이 내장되어 있어 축 끝 주위의 파츠들이 상하로 움직이며 무너진 자세를 바로 잡아주는 스태미나타입의 드라이버." },
  { id: "DRIVER-MOMENT", series: "burst", type: "driver", name: "Mm", en: "Moment", sub: "모멘트", battleType: "defense", tags: [], desc: "반구형의 축과 기울기에 따라 각도가 변하며 자유회전하는 가이드 링에 의해 그립력이 더해진 디펜스타입의 드라이버." },
  { id: "DRIVER-SHOT", series: "burst", type: "driver", name: "Sh", en: "Shot", sub: "샷", battleType: "attack", tags: [], desc: "강력한 슛을 했을 경우, 배틀 후반에 한번 점프 변형해 상하 방향으로 공격이 가능하다. 변형 후에는 속도가 빨라지며 공격력이 올라가는 어택타입 디스크일체형 드라이버. DB레이어의 로우모드에서도 조합 가능." },
  { id: "DRIVER-QUATTRO", series: "burst", type: "driver", name: "Qt", en: "Quattro", sub: "콰트로", battleType: "balance", tags: [], desc: "메탈 소재의 축 끝 2종(스태미나타입, 디펜스타입)과 러버 소재의 축 끝 2종(어택타입, 밸런스타입), 총 4종을 전술에 맞춰 변경할 수 있는 초밸런스타입 드라이버." },
  { id: "DRIVER-ALMIGHT", series: "burst", type: "driver", name: "Al", en: "Almight", sub: "올마이트", battleType: "attack", tags: [], desc: "자유회전하는 평평한 축 끝과 바운드 성능을 가진 디스크 부분으로 강렬한 공격력에 지구력·방어력까지 추가. 강력 슈팅 시 축 끝이 고정되고 두껍게 변형되어 기동력이 극도로 높아지는 어택타입 디스크일체형 드라이버. 디스크 부분은 로우모드로만 조합 가능한 DB디스크." },
  { id: "DRIVER-ADVENTURE", series: "burst", type: "driver", name: "Ad", en: "Adventure", sub: "어드벤처", battleType: "attack", tags: [], desc: "평평한 축 끝으로 폭주하며 축 끝 주위의 발톱형 러버가 상하로 움직이면서 스타디움 안에서의 그립력을 높이는 어택타입의 드라이버." },
  { id: "DRIVER-BOUNCE", series: "burst", type: "driver", name: "Bn", en: "Bounce", sub: "바운스", battleType: "stamina", tags: [], desc: "뾰족한 축 끝이 스프링으로 상하로 움직여 착지와 배틀 중 충격을 완화한다. 대형 가드 파츠의 원심력과 지지력으로 끈질기게 버티는 스태미나타입 드라이버." },
  { id: "DRIVER-XPLOSION", series: "burst", type: "driver", name: "Xp", en: "Xplosion", sub: "익스플로전", battleType: "attack", tags: [], desc: "L선형의 평평한 돌기 러버 축 끝으로 스태디움을 재빠르게 앞지르고 자유회전 가드 파츠로 자세를 유지하며 폭주할 수 있는 어택타입의 드라이버." },
  { id: "DRIVER-ZEAL", series: "burst", type: "driver", name: "Zl", en: "Zeal", sub: "질", battleType: "balance", tags: [], desc: "가늘고 뾰족한 형태의 러버 축으로 지구력을 유지하고 쉽게 날아가지 않으며 자유회전 가드 파츠로 베어링 균형을 잘 유지하는 밸런스타입의 드라이버." },
  { id: "DRIVER-BEARING-DRIFT", series: "burst", type: "driver", name: "BDr", en: "Bearing Drift", sub: "베어링 드리프트", battleType: "defense", tags: [], desc: "원심력을 만들어내는 대형 가드 파츠와 자유회전 축. 낮은 높이로 안정성이 높고 내부에 베어링이 내장되어 있어 지구력도 높은 디펜스타입의 드라이버." },
  { id: "DRIVER-BEARING-MOBIUS", series: "burst", type: "driver", name: "BMb", en: "Bearing Mobius", sub: "베어링 뫼비우스", battleType: "defense", tags: [], desc: "자유회전하는 POM 소재의 축 끝이 자세를 유지하며 공격을 잘 받아넘긴다. 내부에 베어링이 탑재되어 있어 지구력까지 높은 디펜스타입의 드라이버." },
  { id: "DRIVER-XTREME-DASH", series: "burst", type: "driver", name: "X'", en: "Xtreme'", sub: "익스트림 대시", battleType: "attack", tags: [], desc: "축 끝의 러버가 강하게 그립하여 스태디움을 매우 격렬하게 움직인다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택계열 드라이버." },
  { id: "DRIVER-ZEPHYR-DASH", series: "burst", type: "driver", name: "Z'", en: "Zephyr'", sub: "제퍼 대시", battleType: "balance", tags: [], desc: "축 끝부분에 구멍이 있어서 지면과의 마찰을 줄여준다. 강화 스프링이 내장되어 있어서 공격력이 더욱 상승한 밸런스계열의 드라이버." },
  { id: "DRIVER-HUNTER-DASH", series: "burst", type: "driver", name: "Hn'", en: "Hunter'", sub: "헌터 대시", battleType: "attack", tags: [], desc: "가느다란 러버 축 끝으로 높은 그립력과 기동력을 겸비했다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택계열 드라이버." },
  { id: "DRIVER-DESTROY-DASH", series: "burst", type: "driver", name: "Ds'", en: "Destroy'", sub: "디스트로이 대시", battleType: "attack", tags: [], desc: "들쭉날쭉한 축 끝이 스태디움에 맞물려 주위의 가드 파츠에 의해 자세가 흐트러지지 않도록 활약한다. 강화 스프링이 내장되어 있어 공격력이 상승된 어택타입의 드라이버." },
  { id: "DRIVER-ZETA-DASH", series: "burst", type: "driver", name: "Zt'", en: "Zeta'", sub: "제타 대시", battleType: "balance", tags: [], desc: "축 끝을 변형해서 어택모드, 디펜스모드, 스태미나모드 3가지를 고를 수 있다. 강화 스프링이 내장되어 있어서 공격력이 더욱 상승한 밸런스계열의 드라이버." },
  { id: "DRIVER-HOLD-DASH", series: "burst", type: "driver", name: "H'", en: "Hold'", sub: "홀드 대시", battleType: "attack", tags: [], desc: "원반 모양의 축 끝으로 배틀 후반에도 가속해 회전한다. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 어택타입 드라이버." },
  { id: "DRIVER-QUICK-DASH", series: "burst", type: "driver", name: "Qc'", en: "Quick'", sub: "퀵 대시", battleType: "attack", tags: [], desc: "매우 가는 고무 축으로 스태디움 전체를 고속으로 날뛴다. 강화 스프링이 내장되어서, 공격 성능이 상승한 어택타입 드라이버." },
  { id: "DRIVER-REBOOT-DASH", series: "burst", type: "driver", name: "Rb'", en: "Reboot'", sub: "리부트 대시", battleType: "attack", tags: [], desc: "원심력으로 축 끝이 전환되어 배틀 후반에 재가속하는 기믹을 탑재. 강화스프링이 내장되어 공격력이 더욱 높아진 어택계열 드라이버." },
  { id: "DRIVER-VOLCANIC-DASH", series: "burst", type: "driver", name: "Vl'", en: "Volcanic'", sub: "볼카닉 대시", battleType: "attack", tags: [], desc: "높이가 높고, 평평한 축 끝으로 격렬하고 불규칙적으로 날뛸 수 있다. 강화 스프링이 내장되어 있어서 공격력이 더욱 상승한 어택계열 드라이버." },
  { id: "DRIVER-FUSION-DASH", series: "burst", type: "driver", name: "F'", en: "Fusion'", sub: "퓨전 대시", battleType: "balance", tags: [], desc: "평평한 축 끝의 뾰족한 부분에 돌기가 있는 형태로 공격적인 움직임에서 지구력 있는 움직임으로 변화한다. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 밸런스타입의 드라이버." },
  { id: "DRIVER-BLOW-DASH", series: "burst", type: "driver", name: "B'", en: "Blow'", sub: "블로 대시", battleType: "attack", tags: [], desc: "스태디움을 작은 원형 궤도로 움직이며 중앙의 상대에게 강력한 공격을 가한다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택계열 드라이버." },
  { id: "DRIVER-ACCEL-DASH", series: "burst", type: "driver", name: "A'", en: "Accel'", sub: "액셀 대시", battleType: "attack", tags: [], desc: "평평한 축 끝으로 원형 고속 회전을 하며 상대에게 강력한 공격을 가한다. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 어택타입의 드라이버." },
  { id: "DRIVER-MERGE-DASH", series: "burst", type: "driver", name: "Mr'", en: "Merge'", sub: "머지 대시", battleType: "balance", tags: [], desc: "울퉁불퉁한 러버로 덮인 뾰족한 축 끝 덕분에, 슈트하는 위치나 각도에 따라 격렬하고 공격적인 움직임과 조용하고 지구력 중심의 움직임을 나눠 쓸 수 있다. 강화 스프링이 내장되어 공격력이 더욱 높아진 밸런스타입 드라이버." },
  { id: "DRIVER-SPIRAL-DASH", series: "burst", type: "driver", name: "Sp'", en: "Spiral'", sub: "스파이럴 대시", battleType: "attack", tags: [], desc: "소용돌이 형상을 한 축 끝이 스태디움에 달라붙어 돌면서 격하게 날뛴다. 강화 스프링이 내장되어 공격력이 더욱 상승한 어택타입의 드라이버." },
  { id: "DRIVER-DIMENSION-DASH", series: "burst", type: "driver", name: "Dm'", en: "Dimension'", sub: "디멘션 대시", battleType: "balance", tags: [], desc: "축 끝을 비틀어 높이와 공격적인 움직임과 방어적인 움직임을 바꿀 수 있다. 강화 스프링이 내장되어 있어 공격력이 향상된 밸런스타입의 드라이버." },
  { id: "DRIVER-JOLT-DASH", series: "burst", type: "driver", name: "Jl'", en: "Jolt'", sub: "졸트 대시", battleType: "attack", tags: [], desc: "좌회전 시 스태디움에 파고드는 방향으로 꼬인 러버 축과 낮은 높이로 상대를 들어 올리듯 폭주한다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택타입 드라이버." },
  ...
  { id: "DRIVER-VARIABLE-DASH", series: "burst", type: "driver", name: "V'", en: "Variable'", sub: "배리어블 대시", battleType: "attack", tags: [], desc: "사용할수록 성장하는 러버 축 탑재. 강화 스프링이 내장되어 있어 공격력이 더욱 강해진 어택타입 드라이버." },
  { id: "DRIVER-TRANS-DASH", series: "burst", type: "driver", name: "T'", en: "Trans'", sub: "트랜스 대시", battleType: "balance", tags: [], desc: "축 끝을 바꿔 어택모드와 스태미나모드를 전환할 수 있는 밸런스 변형 드라이버. 강화스프링이 내장되어 공격력이 더욱 높아진 밸런스타입 드라이버." },
  { id: "DRIVER-KEEP-DASH", series: "burst", type: "driver", name: "Kp'", en: "Keep'", sub: "킵 대시", battleType: "defense", tags: [], desc: "반구형 러버 축 끝이 쉽게 쓰러지거나 튕겨나가는 것을 막고, 자유회전 축으로 방어를 이어간다. 강화스프링이 내장되어 공격력이 더욱 높아진 디펜스타입 드라이버." },
  { id: "DRIVER-UNITE-DASH", series: "burst", type: "driver", name: "U'", en: "Unite'", sub: "유나이트 대시", battleType: "balance", tags: [], desc: "고무가 뾰족한 축 주위를 둘러싸고 있어 격렬한 공격력과 끈질긴 지구력을 모두 가지고 있다. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 밸런스타입의 드라이버." },
  { id: "DRIVER-ULTIMATE-REBOOT-DASH", series: "burst", type: "driver", name: "Ul'", en: "Ultimate Reboot'", sub: "얼티메이트 리부트 대시", battleType: "attack", tags: [], desc: "원심력에 의해 축 끝부분이 변형되고 배틀 후반에는 고무로 이곳저곳 날뛴다. 강화 스프링이 내장되어 있는 것으로 공격력을 상승시킨 어택타입의 드라이버." },
  { id: "DRIVER-ASSAULT-DASH", series: "burst", type: "driver", name: "α'", en: "Assault'", sub: "어썰트 대시", battleType: "attack", tags: [], desc: "스태디움을 원형으로 초고속 이동하며 상대에게 돌격하는 공격에 특화. 강화스프링이 내장되어 공격력이 더욱 높아진 어택타입 드라이버." },
  { id: "DRIVER-LINER-DASH", series: "burst", type: "driver", name: "L'", en: "Liner'", sub: "라이너 대시", battleType: "balance", tags: [], desc: "축 끝에 내장된 바퀴 모양 파츠가 회전하여 공격을 받는 각도에 따라 움직임을 바꾼다. 강화스프링이 내장되어 공격력이 더욱 높아진 밸런스타입 드라이버." },
  { id: "DRIVER-JAGGY-DASH", series: "burst", type: "driver", name: "J'", en: "Jaggy'", sub: "재기 대시", battleType: "attack", tags: [], desc: "톱니 모양의 스파이크 축 끝이 지면을 차며 기동력을 만들어낸다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택타입 드라이버." },
  { id: "DRIVER-OPERATE-DASH", series: "burst", type: "driver", name: "Op'", en: "Operate'", sub: "오퍼레이트 대시", battleType: "balance", tags: [], desc: "볼 축의 디펜스모드에서 축을 바깥쪽으로 옮겨 불규칙한 어택모드로 변형할 수 있다. 강화스프링이 내장되어 공격력이 더욱 높아진 밸런스타입 드라이버." },
  { id: "DRIVER-EVOLUTION-DASH", series: "burst", type: "driver", name: "Ev'", en: "Evolution'", sub: "에볼루션 대시", battleType: "attack", tags: [], desc: "전체 높이가 높고 사용 방법에 따라 드라이버의 축이 깎이며 움직임이 변화한다. 강화 스프링이 내장되어 있어 공격력이 더욱 올라간 어택타입의 드라이버." },
  { id: "DRIVER-CHARGE-DASH", series: "burst", type: "driver", name: "Ch'", en: "Charge'", sub: "차지 대시", battleType: "attack", tags: [], desc: "평평한 축 끝으로 고속 이동하며 메탈의 무게로 상대에게 강한 충격을 준다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택타입 드라이버." },
  ...
  { id: "DRIVER-ZONE-DASH", series: "burst", type: "driver", name: "Zn'", en: "Zone'", sub: "존 대시", battleType: "balance", tags: [], desc: "돌출된 축 끝으로 스태디움과 마찰을 극한까지 줄이고, 자유회전 가드 파츠로 속도를 빠르게 올릴 수도 있다. 강화 스프링이 내장되어 공격력이 더욱 높아진 밸런스타입의 드라이버." },
  { id: "DRIVER-WAVE-DASH", series: "burst", type: "driver", name: "Wv'", en: "Wave'", sub: "웨이브 대시", battleType: "balance", tags: [], desc: "지구·가속·버티기 효과를 자랑하는 키가 큰 드라이버. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 밸런스타입 드라이버." },
  { id: "DRIVER-BEARING-DASH", series: "burst", type: "driver", name: "Br'", en: "Bearing'", sub: "베어링 대시", battleType: "stamina", tags: [], desc: "정밀 베어링과 미끄러운 축 끝으로 회전력을 유지한다. 강화스프링이 내장되어 공격력이 더욱 높아진 스태미나타입 드라이버." },
  { id: "DRIVER-ATOMIC-DASH", series: "burst", type: "driver", name: "At'", en: "Atomic'", sub: "아토믹 대시", battleType: "defense", tags: [], desc: "대형 볼 모양 축과 주위의 링으로 자유 회전 시 쉽게 쓰러지지 않아 방어력이 높다. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 디펜스타입의 드라이버." },
  { id: "DRIVER-YARD-DASH", series: "burst", type: "driver", name: "Yr'", en: "Yard'", sub: "야드 대시", battleType: "defense", tags: [], desc: "원심력을 만드는 대형 링 파츠로 감싼 구형 축 끝과 낮은 높이로 안정적인 방어를 굳힌다. 강화스프링이 내장되어 공격력이 더욱 높아진 디펜스타입 드라이버." },
  { id: "DRIVER-WEDGE-DASH", series: "burst", type: "driver", name: "Wd'", en: "Wedge'", sub: "웻지 대시", battleType: "stamina", tags: [], desc: "뾰족한 메탈 축 끝이 흔들림이 적은 중심축을 만들어낸다. 강화스프링이 내장되어 공격력이 더욱 높아진 스태미나타입 드라이버." },
  { id: "DRIVER-CHARGE-METAL-DASH", series: "burst", type: "driver", name: "Cm'", en: "Charge Metal'", sub: "차지 메탈 대시", battleType: "attack", tags: [], desc: "테두리부터 축 끝까지 모두 메탈로 만들어 높은 공격력 & 기동력을 자랑하는 드라이버. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 어택타입의 드라이버." },
  { id: "DRIVER-SWORD-DASH", series: "burst", type: "driver", name: "Sw'", en: "Sword'", sub: "소드 대시", battleType: "attack", tags: [], desc: "메탈 소드 축의 중량과 그립력, 높이로 인해 위에서 공격도 가능한 드라이버. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 어택타입의 드라이버." },
  { id: "DRIVER-JUST-DASH", series: "burst", type: "driver", name: "Js'", en: "Just'", sub: "저스트 대시", battleType: "defense", tags: [], desc: "뾰족하고 가는 축 끝으로 재빠르게 스태디움의 센터를 선점하며, 배틀 후반에는 바깥쪽 링이 자유회전하여 끝까지 버틴다. 강화스프링이 내장되어 공격력이 더욱 높아진 디펜스타입 드라이버." },
  { id: "DRIVER-REVOLVE-DASH", series: "burst", type: "driver", name: "R'", en: "Revolve'", sub: "리볼브 대시", battleType: "stamina", tags: [], desc: "뾰족한 축 끝 주위의 자유회전 가드 파츠로 회전력이 쉽게 떨어지지 않는다. 강화스프링이 내장되어 공격력이 더욱 높아진 스태미나타입 드라이버." },
  { id: "DRIVER-QUATTRO-DASH", series: "burst", type: "driver", name: "Qt'", en: "Quattro'", sub: "콰트로 대시", battleType: "balance", tags: [], desc: "메탈 축 끝 2종과 러버 축 끝 2종 총 4가지 타입으로 변경이 가능한 드라이버. 강화 스프링이 내장되어 있어 공격력이 더욱 높아진 초밸런스타입 드라이버." },
  { id: "DRIVER-MOMENT-DASH", series: "burst", type: "driver", name: "Mm'", en: "Moment'", sub: "모멘트 대시", battleType: "defense", tags: [], desc: "반구형 축과 기울기에 맞춰 움직이는 자유회전 가이드로 그립력을 높인다. 강화스프링이 내장되어 공격력이 더욱 높아진 디펜스타입 드라이버." },
  { id: "DRIVER-PLANET-DASH", series: "burst", type: "driver", name: "Pl'", en: "Planet'", sub: "플래닛 대시", battleType: "stamina", tags: [], desc: "외주와 축 끝의 메탈 볼이 원심력을 강화하고 마찰을 줄인다. 강화스프링이 내장되어 공격력이 더욱 높아진 스태미나타입 드라이버." },
  { id: "DRIVER-XPLOSION-DASH", series: "burst", type: "driver", name: "Xp'", en: "Xplosion'", sub: "익스플로전 대시", battleType: "attack", tags: [], desc: "소용돌이형 톱니 러버 축과 자유회전 가드 파츠로 고속 폭주를 이어간다. 강화스프링이 내장되어 공격력이 더욱 높아진 어택타입 드라이버." },
  { id: "DRIVER-HYBRID", series: "burst", type: "driver", name: "Hy", en: "Hybrid", sub: "하이브리드", battleType: "defense", tags: [], desc: "슛의 파워에 반응하여 내장된 모터가 작동하고 회전방향에 가속하여 오랜 시간 동안 회전할 수 있는 디펜스타입의 전동 드라이버." },
  { id: "DRIVER-IGNITION-DASH", series: "burst", type: "driver", name: "Ig'", en: "Ignition'", sub: "이그니션 대시", battleType: "attack", tags: [], desc: "슛 파워에 따라서 내장의 모터가 가동하여 스태디움을 종횡무진 무섭게 회전한다. 강화 스프링이 내장되어 있어 공격력이 더욱 올라간 어택타입의 전동 드라이버." },
  { id: "DRIVER-HIGH-SURVIVE", series: "burst", type: "driver", name: "HS", en: "High Survive", sub: "하이 서바이브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝으로 스태디움과의 마찰을 줄여 지구력이 높다. 높이가 높아져 공격력이 더욱 올라간 스태미나타입 드라이버." },
  { id: "DRIVER-HIGH-DEFENSE", series: "burst", type: "driver", name: "HD", en: "High Defense", sub: "하이 디펜스", battleType: "defense", tags: [], desc: "둥근 축 끝으로 접지 면적이 넓고 큰 링으로 중량이 높다. 높이가 높아져 공격력이 더욱 올라간 디펜스타입 드라이버." },
  { id: "DRIVER-HIGH-ZEPHYR", series: "burst", type: "driver", name: "HZ", en: "High Zephyr", sub: "하이 제퍼", battleType: "balance", tags: [], desc: "축 끝의 구멍으로 접지면과의 마찰을 줄여 기동력과 지구력을 겸비한다. 높이가 높아져 공격력이 더욱 올라간 밸런스타입 드라이버." },
  ...
  { id: "DRIVER-HIGH-ETERNAL", series: "burst", type: "driver", name: "HEt", en: "High Eternal", sub: "하이 이터널", battleType: "stamina", tags: [], desc: "뾰족한 축 끝과 미끄러지기 쉬운 POM 소재 가드 파츠로 배틀 후반까지 끈질기게 버틴다. 높이가 높아져 공격력이 더욱 올라간 스태미나타입 드라이버." },
  { id: "DRIVER-HIGH-BLOW-DASH", series: "burst", type: "driver", name: "HB'", en: "High Blow'", sub: "하이 블로 대시", battleType: "attack", tags: [], desc: "스태디움을 작은 원형 궤도로 움직이며 중앙의 상대에게 강력한 공격을 가한다. 강화스프링이 내장되고 높이가 높아져 공격력이 더욱 올라간 어택타입 드라이버." },
  { id: "DRIVER-HIGH-JAGGY-DASH", series: "burst", type: "driver", name: "HJ'", en: "High Jaggy'", sub: "하이 재기 대시", battleType: "attack", tags: [], desc: "톱니 모양의 스파이크 축 끝이 지면을 차며 기동력을 만들어낸다. 강화스프링이 내장되고 높이가 높아져 공격력이 더욱 올라간 어택타입 드라이버." },
  { id: "DRIVER-HIGH-ACCEL-DASH", series: "burst", type: "driver", name: "HA'", en: "High Accel'", sub: "하이 엑셀 대시", battleType: "attack", tags: [], desc: "평평한 축 끝으로 원형 고속 이동하며 상대에게 강력한 공격을 가한다. 강화스프링이 내장되고 높이가 높아져 공격력이 더욱 올라간 어택타입 드라이버." },
  { id: "DRIVER-HIGH-HOLD-DASH", series: "burst", type: "driver", name: "HH'", en: "High Hold'", sub: "하이 홀드 대시", battleType: "attack", tags: [], desc: "자유회전하는 큰 원반형 축 끝으로 배틀 후반에도 가속하며 스태디움 안을 날뛴다. 강화스프링이 내장되고 높이가 높아져 공격력이 더욱 올라간 어택타입 드라이버." },
  { id: "DRIVER-HIGH-XTEND-PLUS-DASH", series: "burst", type: "driver", name: "HXt+'", en: "High Xtend+'", sub: "하이 익스텐드 플러스 대시", battleType: "balance", tags: [], desc: "상대를 맞추어 축 끝을 어택·디펜스·스태미나의 3타입으로 변형 가능하다. 강화 스프링과 높은 키로 공격력이 더욱 강해진 밸런스타입 드라이버." },
  { id: "DRIVER-HIGH-CHARGE-DASH", series: "burst", type: "driver", name: "HCh'", en: "High Charge'", sub: "하이 차지 대시", battleType: "attack", tags: [], desc: "평평한 축 끝의 고속 이동과 메탈의 무게로 강한 충격을 준다. 강화스프링이 내장되고 높이가 높아져 공격력이 더욱 올라간 어택타입 드라이버." },
  { id: "DRIVER-HIGH-WAVE-DASH", series: "burst", type: "driver", name: "HWv'", en: "High Wave'", sub: "하이 웨이브 대시", battleType: "balance", tags: [], desc: "지구·가속·지지에 효과를 발휘하며 높이가 높다. 강화스프링이 내장되어 있고, 높이가 높아진 만큼 공격력이 한층 더 올라간 밸런스타입 드라이버." },
  { id: "DRIVER-METAL-FUSION", series: "burst", type: "driver", name: "MF", en: "Metal Fusion", sub: "메탈 퓨전", battleType: "balance", tags: [], desc: "평평한 축 끝의 뾰족한 부분에 돌기가 있는 형태로 공격적인 움직임에서 지구력 있는 움직임으로 변화한다. 강화 스프링 & 메탈 잠금 파츠 탑재로 성능이 향상된 밸런스타입의 드라이버." },
  { id: "DRIVER-METAL-ACCEL", series: "burst", type: "driver", name: "MA", en: "Metal Accel", sub: "메탈 액셀", battleType: "attack", tags: [], desc: "축 끝이 평평해 기동력이 있으며, 고속으로 움직이며 회전한다. 강화스프링과 메탈 잠금 파츠 탑재로 성능이 향상된 어택타입 드라이버." },
  { id: "DRIVER-METAL-DEFENSE", series: "burst", type: "driver", name: "MD", en: "Metal Defense", sub: "메탈 디펜스", battleType: "defense", tags: [], desc: "둥근 축 끝으로 접지 면적이 넓어 방어력이 높다. 강화스프링과 메탈 잠금 파츠 탑재로 성능이 향상된 디펜스타입 드라이버." },
  { id: "DRIVER-METAL-SURVIVE", series: "burst", type: "driver", name: "MS", en: "Metal Survive", sub: "메탈 서바이브", battleType: "stamina", tags: [], desc: "뾰족한 축 끝이 스타디움과의 마찰을 줄여준다. 탑재된 강화 스프링과 메탈 잠금 파츠가 성능을 한층 더 높이는 스태미나타입 드라이버." },
  { id: "DRIVER-METAL-XTREME", series: "burst", type: "driver", name: "MX", en: "Metal Xtreme", sub: "메탈 익스트림", battleType: "attack", tags: [], desc: "러버의 강력한 그립에 의한 격렬한 움직임. 탑재된 강화 스프링과 메탈 잠금 파츠가 성능을 한층 더 높이는 어택타입 드라이버." },
  { id: "DRIVER-METAL-DESTROY", series: "burst", type: "driver", name: "MDs", en: "Metal Destroy", sub: "메탈 디스트로이", battleType: "attack", tags: [], desc: "들쭉날쭉한 축 끝과 가드 파츠에 의해 장시간 폭주가 가능. 강화 스프링 & 메탈 잠금 파츠 탑재로 성능이 높아진 어택타입 드라이버." },
  { id: "DRIVER-METAL-UNIVERSE", series: "burst", type: "driver", name: "MUn", en: "Metal Universe", sub: "메탈 유니버스", battleType: "defense", tags: [], desc: "반구형 대형 축과 다수개의 작은 자유회전 볼들에 의해 쓰러지지 않는다. 강화 스프링 & 메탈 잠금 파츠 탑재로 성능이 높아진 디펜스타입 드라이버." },
  { id: "DRIVER-METAL-DRIFT", series: "burst", type: "driver", name: "MDr", en: "Metal Drift", sub: "메탈 드리프트", battleType: "defense", tags: [], desc: "전체 높이가 낮고 자유회전하는 대형 가드 파츠로 원심력과 안정성이 높다. 강화스프링과 메탈 잠금 파츠 탑재로 성능이 향상된 디펜스타입 드라이버." },
  { id: "DRIVER-METAL-DIMENSION", series: "burst", type: "driver", name: "MDm", en: "Metal Dimension", sub: "메탈 디멘션", battleType: "balance", tags: [], desc: "축 끝을 비틀어 높이와 공격·방어 움직임을 전환할 수 있다. 강화스프링과 메탈 잠금 파츠 탑재로 성능이 향상된 밸런스타입 드라이버." },
  { id: "DRIVER-METAL-BEARING-DRIFT", series: "burst", type: "driver", name: "MBD", en: "Metal Bearing Drift", sub: "메탈 베어링 드리프트", battleType: "defense", tags: [], desc: "원심력을 만들어내는 대형 가드 파츠와 자유회전 축으로 안정성이 높고, 내부 베어링으로 지구력도 높다. 강화스프링과 메탈 잠금 파츠 탑재로 성능이 향상된 디펜스타입 드라이버." },
  { id: "DRIVER-METAL-NEVER", series: "burst", type: "driver", name: "MNv", en: "Metal Never", sub: "메탈 네버", battleType: "stamina", tags: [], desc: "자유회전하는 축 끝과 특수소재 POM의 지지 파츠로 끝까지 끈질기게 버틴다. 강화스프링과 메탈 잠금 파츠 탑재로 성능이 향상된 스태미나타입 드라이버." },
