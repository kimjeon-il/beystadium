...
const burstRandomBoosterParts = [
  { id: "PART-BURST-LAYER-DRAGOON-STORM", series: "burst", type: "layer", name: "드래곤 스톰", jpName: "드라군 스톰", en: "Dragoon Storm", battleType: "attack", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRANZER-SPIRAL", series: "burst", type: "layer", name: "드랜져 스파이럴", jpName: "드랜저 스파이럴", en: "Dranzer Spiral", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRIGER-SLASH", series: "burst", type: "layer", name: "드래이거 슬래시", jpName: "드라이거 슬래시", en: "Driger Slash", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRACIEL-SHIELD", series: "burst", type: "layer", name: "드래셀 실드", jpName: "드라시엘 실드", en: "Draciel Shield", battleType: "defense", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRAGOON-PHANTOM", series: "burst", type: "layer", name: "드래곤 팬텀", jpName: "드라군 팬텀", en: "Dragoon Phantom", battleType: "attack", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRANZER-FLAME", series: "burst", type: "layer", name: "윙 팔콘", jpName: "드랜저 플레임", en: "Dranzer Flame", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-GAIA-DRAGOON", series: "burst", type: "layer", name: "나이프 리저드", jpName: "가이아 드라군", en: "Gaia Dragoon", battleType: "attack", desc: "거대한 자유 회전 윙이 확실하게 상대의 레이어를 잡아내는 어택계열의 레이어.", stats: [4,1,0,2,3,1] },
  { id: "PART-BURST-LAYER-DRACIEL-FORTRESS", series: "burst", type: "layer", name: "드래셀 포트리스", jpName: "드라시엘 포트리스", en: "Draciel Fortress", battleType: "defense", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRAGOON-VICTORY", series: "burst", type: "layer", name: "파이어 리저드", jpName: "드라군 빅토리", en: "Dragoon Victory", battleType: "attack", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-ROCK-LEONE", series: "burst", type: "layer", name: "로크 레온", jpName: "록 레오네", en: "Rock Leone", battleType: "defense", spin: "right", desc: "", stats: [2,4,0,3,1,1] },
  { id: "PART-BURST-LAYER-BURN-PHOENIX", series: "burst", type: "layer", name: "번 피닉스", jpName: "번 피닉스", en: "Burn Phoenix", battleType: "stamina", spin: "right", desc: "", stats: [1,1,5,2,2,0] },
  { id: "PART-BURST-LAYER-EARTH-AQUILA", series: "burst", type: "layer", name: "어스 아쿠이라", jpName: "어스 아쿠이라", en: "Earth Aquila", battleType: "defense", spin: "right", desc: "", stats: [2,2,0,2,3,2] },
  { id: "PART-BURST-LAYER-FLAME-SAGITTARIO", series: "burst", type: "layer", name: "플레임 사지타리오", jpName: "플레임 사지타리오", en: "Flame Sagittario", battleType: "stamina", spin: "right", desc: "", stats: [1,1,4,2,1,2] },
  { id: "PART-BURST-LAYER-DRANZER-VOLCANO", series: "burst", type: "layer", name: "드랜져 볼케이노", jpName: "드랜저 볼케이노", en: "Dranzer Volcano", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRIGER-VULCAN", series: "burst", type: "layer", name: "팽 타이거", jpName: "드라이거 발칸", en: "Driger Vulcan", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRACIEL-VIPER", series: "burst", type: "layer", name: "프로텍션 터틀", jpName: "드라시엘 바이퍼", en: "Draciel Viper", battleType: "defense", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-GAIA-DRAGOON-BURST", series: "burst", type: "layer", name: "가이아 드래곤 버스트", jpName: "가이아 드라군 버스트", en: "Gaia Dragoon Burst", battleType: "attack", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRAGOON-V2", series: "burst", type: "layer", name: "마그마 리저드", jpName: "드라군 V2", en: "Dragoon V2", battleType: "attack", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRANZER-V2", series: "burst", type: "layer", name: "스카이 팔콘", jpName: "드랜저 V2", en: "Dranzer V2", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRIGER-V2", series: "burst", type: "layer", name: "스톰 타이거", jpName: "드라이거 V2", en: "Driger V2", battleType: "balance", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-DRACIEL-V2", series: "burst", type: "layer", name: "드래셀 V2", jpName: "드라시엘 V2", en: "Draciel V2", battleType: "defense", desc: "", stats: [] },
  { id: "PART-BURST-LAYER-GALAXY-PEGASIS", series: "burst", type: "layer", name: "스파크 슬레이프닐", jpName: "갤럭시 페가시스", en: "Galaxy Pegasis", battleType: "attack", spin: "right", desc: "", stats: [5,0,0,2,3,2] },
  { id: "PART-BURST-LAYER-RAY-UNICORNO", series: "burst", type: "layer", name: "레이 유니콘", jpName: "레이 유니코르노", en: "Ray Unicorno", battleType: "attack", spin: "right", desc: "", stats: [4,1,1,2,2,2] },
  { id: "PART-BURST-LAYER-GRAVITY-PERSEUS", series: "burst", type: "layer", name: "그라비티 페르세우스", jpName: "그라비티 페르세우스", en: "Gravity Perseus", battleType: "defense", spin: "dual", desc: "", stats: [2,5,0,3,1,1] },
  { id: "PART-BURST-LAYER-METEO-L-DRAGO", series: "burst", type: "layer", name: "메테오 엘드라고", jpName: "메테오 엘드라고", en: "Meteo L-Drago", battleType: "attack", spin: "left", desc: "", stats: [5,0,0,2,2,3] },
  { id: "PART-BURST-LAYER-HELL-KERBECS", series: "burst", type: "layer", name: "다크 케르베로스", jpName: "헬 케르벡스", en: "Hell Kerbecs", battleType: "stamina", spin: "right", desc: "", stats: [2,1,5,3,0,1] }
];
