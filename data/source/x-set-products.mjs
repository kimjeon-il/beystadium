...
const xSetPartItems = [
  { id: "PART-X-BLADE-IRON-MAN", series: "x", type: "blade", name: "아이언맨", en: "Iron Man", battleType: "stamina", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-THANOS", series: "x", type: "blade", name: "타노스", en: "Thanos", battleType: "balance", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-SPIDER-MAN", series: "x", type: "blade", name: "스파이더맨", en: "Spider-Man", battleType: "attack", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-VENOM", series: "x", type: "blade", name: "베놈", en: "Venom", battleType: "defense", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-LUKE-SKYWALKER", series: "x", type: "blade", name: "루크 스카이워커", en: "Luke Skywalker", battleType: "stamina", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-DARTH-VADER", series: "x", type: "blade", name: "다스 베이더", en: "Darth Vader", battleType: "balance", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-THE-MANDALORIAN", series: "x", type: "blade", name: "만달로리안", en: "The Mandalorian", battleType: "attack", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-MOFF-GIDEON", series: "x", type: "blade", name: "모프 기디언", en: "Moff Gideon", battleType: "defense", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-OPTIMUS-PRIME", series: "x", type: "blade", name: "옵티머스 프라임", en: "Optimus Prime", battleType: "balance", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-MEGATRON", series: "x", type: "blade", name: "메가트론", en: "Megatron", battleType: "stamina", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-OPTIMUS-PRIMAL", series: "x", type: "blade", name: "옵티머스 프라이멀", en: "Optimus Primal", battleType: "attack", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-STARSCREAM", series: "x", type: "blade", name: "스타스크림", en: "Starscream", battleType: "defense", spin: "right", desc: "", stats: [] },
  { id: "PART-X-BLADE-T-REX", series: "x", type: "blade", name: "티렉스", en: "T. Rex", battleType: "stamina", spin: "right", desc: "", stats: [] },
...
const xSetBeyItems = [
  { id: "BEY-X-UX-10-KNIGHT-MAIL-3-85BS", series: "x", type: "bey", name: "나이트메일 3-85BS", en: "Knight Mail 3-85BS", productNo: "UX-10", battleType: "defense", spin: "right", desc: "", parts: ["PART-X-BLADE-KNIGHT-MAIL", "PART-X-RATCHET-3-85", "PART-X-BIT-BS"] },
  { id: "BEY-X-BX-00-DRAN-SWORD-3-60F", series: "x", type: "bey", name: "드랜소드 3-60F", jpName: "드란소드 3-60F", en: "Dran Sword 3-60F", productNo: "BX-00", battleType: "attack", spin: "right", desc: "", parts: ["PART-X-BLADE-DRAN-SWORD", "PART-X-RATCHET-3-60", "PART-X-BIT-F"] },
  { id: "BEY-X-BX-00-VICTORY-VALKYRIE-2-60RA", series: "x", type: "bey", name: "빅토리 발키리 2-60RA", jpName: "빅토리발키리 2-60RA", en: "Victory Valkyrie 2-60RA", productNo: "BX-00", battleType: "attack", spin: "right", desc: "", parts: ["PART-X-BLADE-VICTORY-VALKYRIE", "PART-X-RATCHET-2-60", "PART-X-BIT-RA"] },
  { id: "BEY-X-BX-00-IRON-MAN-4-80B", series: "x", type: "bey", name: "아이언맨 4-80B", en: "Iron Man 4-80B", productNo: "BX-00", battleType: "stamina", spin: "right", desc: "", parts: ["PART-X-BLADE-IRON-MAN", "PART-X-RATCHET-4-80", "PART-X-BIT-B"] },
  { id: "BEY-X-BX-00-THANOS-4-60P", series: "x", type: "bey", name: "타노스 4-60P", en: "Thanos 4-60P", productNo: "BX-00", battleType: "balance", spin: "right", desc: "", parts: ["PART-X-BLADE-THANOS", "PART-X-RATCHET-4-60", "PART-X-BIT-P"] },
  { id: "BEY-X-BX-00-SPIDER-MAN-3-60F", series: "x", type: "bey", name: "스파이더맨 3-60F", en: "Spider-Man 3-60F", productNo: "BX-00", battleType: "attack", spin: "right", desc: "", parts: ["PART-X-BLADE-SPIDER-MAN", "PART-X-RATCHET-3-60", "PART-X-BIT-F"] },
  { id: "BEY-X-BX-00-VENOM-3-80N", series: "x", type: "bey", name: "베놈 3-80N", en: "Venom 3-80N", productNo: "BX-00", battleType: "defense", spin: "right", desc: "", parts: ["PART-X-BLADE-VENOM", "PART-X-RATCHET-3-80", "PART-X-BIT-N"] },
  { id: "BEY-X-BX-00-LUKE-SKYWALKER-4-80B", series: "x", type: "bey", name: "루크 스카이워커 4-80B", en: "Luke Skywalker 4-80B", productNo: "BX-00", battleType: "stamina", spin: "right", desc: "", parts: ["PART-X-BLADE-LUKE-SKYWALKER", "PART-X-RATCHET-4-80", "PART-X-BIT-B"] },
  { id: "BEY-X-BX-00-DARTH-VADER-4-60P", series: "x", type: "bey", name: "다스 베이더 4-60P", en: "Darth Vader 4-60P", productNo: "BX-00", battleType: "balance", spin: "right", desc: "", parts: ["PART-X-BLADE-DARTH-VADER", "PART-X-RATCHET-4-60", "PART-X-BIT-P"] },
  { id: "BEY-X-BX-00-THE-MANDALORIAN-3-60F", series: "x", type: "bey", name: "만달로리안 3-60F", en: "The Mandalorian 3-60F", productNo: "BX-00", battleType: "attack", spin: "right", desc: "", parts: ["PART-X-BLADE-THE-MANDALORIAN", "PART-X-RATCHET-3-60", "PART-X-BIT-F"] },
  { id: "BEY-X-BX-00-MOFF-GIDEON-3-80N", series: "x", type: "bey", name: "모프 기디언 3-80N", en: "Moff Gideon 3-80N", productNo: "BX-00", battleType: "defense", spin: "right", desc: "", parts: ["PART-X-BLADE-MOFF-GIDEON", "PART-X-RATCHET-3-80", "PART-X-BIT-N"] },
  { id: "BEY-X-BX-00-OPTIMUS-PRIME-4-60P", series: "x", type: "bey", name: "옵티머스 프라임 4-60P", en: "Optimus Prime 4-60P", productNo: "BX-00", battleType: "balance", spin: "right", desc: "", parts: ["PART-X-BLADE-OPTIMUS-PRIME", "PART-X-RATCHET-4-60", "PART-X-BIT-P"] },
  { id: "BEY-X-BX-00-MEGATRON-4-80B", series: "x", type: "bey", name: "메가트론 4-80B", en: "Megatron 4-80B", productNo: "BX-00", battleType: "stamina", spin: "right", desc: "", parts: ["PART-X-BLADE-MEGATRON", "PART-X-RATCHET-4-80", "PART-X-BIT-B"] },
  { id: "BEY-X-BX-00-OPTIMUS-PRIMAL-3-60F", series: "x", type: "bey", name: "옵티머스 프라이멀 3-60F", en: "Optimus Primal 3-60F", productNo: "BX-00", battleType: "attack", spin: "right", desc: "", parts: ["PART-X-BLADE-OPTIMUS-PRIMAL", "PART-X-RATCHET-3-60", "PART-X-BIT-F"] },
  { id: "BEY-X-BX-00-STARSCREAM-3-80N", series: "x", type: "bey", name: "스타스크림 3-80N", en: "Starscream 3-80N", productNo: "BX-00", battleType: "defense", spin: "right", desc: "", parts: ["PART-X-BLADE-STARSCREAM", "PART-X-RATCHET-3-80", "PART-X-BIT-N"] },
  { id: "BEY-X-BX-00-T-REX-1-80GB", series: "x", type: "bey", name: "티렉스 1-80GB", en: "T. Rex 1-80GB", productNo: "BX-00", battleType: "stamina", spin: "right", desc: "", parts: ["PART-X-BLADE-T-REX", "PART-X-RATCHET-1-80", "PART-X-BIT-GB"] },
  { id: "BEY-X-BX-00-MOSASAURUS-9-60U", series: "x", type: "bey", name: "모사사우루스 9-60U", en: "Mosasaurus 9-60U", productNo: "BX-00", battleType: "balance", spin: "right", desc: "", parts: ["PART-X-BLADE-MOSASAURUS", "PART-X-RATCHET-9-60", "PART-X-BIT-U"] },
  { id: "BEY-X-BX-00-SPINOSAURUS-3-85A", series: "x", type: "bey", name: "스피노사우루스 3-85A", en: "Spinosaurus 3-85A", productNo: "BX-00", battleType: "attack", spin: "right", desc: "", parts: ["PART-X-BLADE-SPINOSAURUS", "PART-X-RATCHET-3-85", "PART-X-BIT-A"] },
  { id: "BEY-X-BX-00-QUETZALCOATLUS-4-55D", series: "x", type: "bey", name: "케찰코아틀루스 4-55D", en: "Quetzalcoatlus 4-55D", productNo: "BX-00", battleType: "defense", spin: "right", desc: "", parts: ["PART-X-BLADE-QUETZALCOATLUS", "PART-X-RATCHET-4-55", "PART-X-BIT-D"] },
