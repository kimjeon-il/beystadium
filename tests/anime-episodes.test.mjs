...
const expectedSuperkingEpisodes = [
  ...
  ["폭풍 같은 레이지 롱기누스!", "2020-10-07"],
  ["칠흑 같은 태양! 베어리언트 루시퍼!", "2020-10-14"],
  ...
  ["", "2021-05-19"],
  ["합체할 수 없잖아!", "2021-05-26"],
  ["이게 우리의 배틀이야!", "2021-06-02"],
  ["신중하게? 무조건 공격이야!", "2021-06-09"],
  ["레전드의 벽을 뛰어 넘어!", "2021-06-16"],
  ["마지막 결전! 혁명이야!", "2021-06-23"],
...
test("슈퍼킹 방영목록 52건은 한국 제목·방영일 순서와 46화 빈 제목을 유지한다", () => {
  ...
  assert.equal(episodes[45].titles.kr, "");
